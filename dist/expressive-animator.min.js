...
/**
     ...
     */}const r="undefined"!=typeof window&&null!=window.customElements&&void 0!==window.customElements.polyfillWrapFlushCallback,o=(t,e,r=null)=>{for(;e!==r;){const r=e.nextSibling;t.removeChild(e),e=r}},i=`{{lit-${String(Math.random()).slice(2)}}}`,s=`\x3c!--${i}--\x3e`,a=new RegExp(`${i}|${s}`),n="$lit$";class c{constructor(t,e){this.parts=[],this.element=e;const r=[],o=[],s=document.createTreeWalker(e.content,133,null,!1);let c=0,u=-1,m=0;const{strings:h,values:{length:b}}=t;for(;m<b;){const t=s.nextNode();if(null!==t){if(u++,1===t.nodeType){if(t.hasAttributes()){const e=t.attributes,{length:r}=e;let o=0;for(let t=0;t<r;t++)l(e[t].name,n)&&o++;for(;o-- >0;){const e=h[m],r=p.exec(e)[2],o=r.toLowerCase()+n,i=t.getAttribute(o);t.removeAttribute(o);const s=i.split(a);this.parts.push({type:"attribute",index:u,name:r,strings:s}),m+=s.length-1}}"TEMPLATE"===t.tagName&&(o.push(t),s.currentNode=t.content)}else if(3===t.nodeType){const e=t.data;if(e.indexOf(i)>=0){const o=t.parentNode,i=e.split(a),s=i.length-1;for(let e=0;e<s;e++){let r,s=i[e];if(""===s)r=d();else{const t=p.exec(s);null!==t&&l(t[2],n)&&(s=s.slice(0,t.index)+t[1]+t[2].slice(0,-n.length)+t[3]),r=document.createTextNode(s)}o.insertBefore(r,t),this.parts.push({type:"node",index:++u})}""===i[s]?(o.insertBefore(d(),t),r.push(t)):t.data=i[s],m+=s}}else if(8===t.nodeType)if(t.data===i){const e=t.parentNode;null!==t.previousSibling&&u!==c||(u++,e.insertBefore(d(),t)),c=u,this.parts.push({type:"node",index:u}),null===t.nextSibling?t.data="":(r.push(t),u--),m++}else{let e=-1;for(;-1!==(e=t.data.indexOf(i,e+1));)this.parts.push({type:"node",index:-1}),m++}}else s.currentNode=o.pop()}for(const t of r)t.parentNode.removeChild(t)}}const l=(t,e)=>{const r=t.length-e.length;return r>=0&&t.slice(r)===e},u=t=>-1!==t.index,d=()=>document.createComment(""),p=/([ \x09\x0a\x0c\x0d])([^\0-\x1F\x7F-\x9F "'>=/]+)([ \x09\x0a\x0c\x0d]*=[ \x09\x0a\x0c\x0d]*(?:[^ \x09\x0a\x0c\x0d"'`<>=]*|"[^"]*|'[^']*))$/;function m(t,e){const{element:{content:r},parts:o}=t,i=document.createTreeWalker(r,133,null,!1);let s=b(o),a=o[s],n=-1,c=0;const l=[];let u=null;for(;i.nextNode();){n++;const t=i.currentNode;for(t.previousSibling===u&&(u=null),e.has(t)&&(l.push(t),null===u&&(u=t)),null!==u&&c++;void 0!==a&&a.index===n;)a.index=null!==u?-1:a.index-c,s=b(o,s),a=o[s]}l.forEach((t=>t.parentNode.removeChild(t)))}const h=t=>{let e=11===t.nodeType?0:1;const r=document.createTreeWalker(t,133,null,!1);for(;r.nextNode();)e++;return e},b=(t,e=-1)=>{for(let r=e+1;r<t.length;r++){const e=t[r];if(u(e))return r}return-1};
/**
     * @license
     * Copyright (c) 2017 The Polymer Project Authors. All rights reserved.
     * This code may only be used under the BSD style license found at
     ...
     * http://polymer.github.io/PATENTS.txt
     */
const v=new WeakMap,g=t=>(...e)=>{const r=t(...e);return v.set(r,!0),r},f=t=>"function"==typeof t&&v.has(t),y={},x={};
/**
     * @license
     * Copyright (c) 2017 The Polymer Project Authors. All rights reserved.
     * This code may only be used under the BSD style license found at
     ...
     * http://polymer.github.io/PATENTS.txt
     */
class k{constructor(t,e,r){this.__parts=[],this.template=t,this.processor=e,this.options=r}update(t){let e=0;for(const r of this.__parts)void 0!==r&&r.setValue(t[e]),e++;for(const t of this.__parts)void 0!==t&&t.commit()}_clone(){const t=r?this.template.element.content.cloneNode(!0):document.importNode(this.template.element.content,!0),e=[],o=this.template.parts,i=document.createTreeWalker(t,133,null,!1);let s,a=0,n=0,c=i.nextNode();for(;a<o.length;)if(s=o[a],u(s)){for(;n<s.index;)n++,"TEMPLATE"===c.nodeName&&(e.push(c),i.currentNode=c.content),null===(c=i.nextNode())&&(i.currentNode=e.pop(),c=i.nextNode());if("node"===s.type){const t=this.processor.handleTextExpression(this.options);t.insertAfterNode(c.previousSibling),this.__parts.push(t)}else this.__parts.push(...this.processor.handleAttributeExpressions(c,s.name,s.strings,this.options));a++}else this.__parts.push(void 0),a++;return r&&(document.adoptNode(t),customElements.upgrade(t)),t}}
/**
     * @license
     * Copyright (c) 2017 The Polymer Project Authors. All rights reserved.
     * This code may only be used under the BSD style license found at
     ...
     * subject to an additional IP rights grant found at
     * http://polymer.github.io/PATENTS.txt
     */const w=window.trustedTypes&&trustedTypes.createPolicy("lit-html",{createHTML:t=>t}),z=` ${i} `;class ${constructor(t,e,r,o){this.strings=t,this.values=e,this.type=r,this.processor=o}getHTML(){const t=this.strings.length-1;let e="",r=!1;for(let o=0;o<t;o++){const t=this.strings[o],a=t.lastIndexOf("\x3c!--");r=(a>-1||r)&&-1===t.indexOf("--\x3e",a+1);const c=p.exec(t);e+=null===c?t+(r?z:s):t.substr(0,c.index)+c[1]+c[2]+n+c[3]+i}return e+=this.strings[t],e}getTemplateElement(){const t=document.createElement("template");let e=this.getHTML();return void 0!==w&&(e=w.createHTML(e)),t.innerHTML=e,t}}class M extends ${getHTML(){return`<svg>${super.getHTML()}</svg>`}getTemplateElement(){const t=super.getTemplateElement(),e=t.content,r=e.firstChild;return e.removeChild(r),((t,e,r=null,o=null)=>{for(;e!==r;){const r=e.nextSibling;t.insertBefore(e,o),e=r}})(e,r.firstChild),t}}
/**
     * @license
     * Copyright (c) 2017 The Polymer Project Authors. All rights reserved.
     * This code may only be used under the BSD style license found at
     ...
     * subject to an additional IP rights grant found at
     * http://polymer.github.io/PATENTS.txt
     */const q=t=>null===t||!("object"==typeof t||"function"==typeof t),A=t=>Array.isArray(t)||!(!t||!t[Symbol.iterator]);class C{constructor(t,e,r){this.dirty=!0,this.element=t,this.name=e,this.strings=r,this.parts=[];for(let t=0;t<r.length-1;t++)this.parts[t]=this._createPart()}_createPart(){return new S(this)}_getValue(){const t=this.strings,e=t.length-1,r=this.parts;if(1===e&&""===t[0]&&""===t[1]){const t=r[0].value;if("symbol"==typeof t)return String(t);if("string"==typeof t||!A(t))return t}let o="";for(let i=0;i<e;i++){o+=t[i];const e=r[i];if(void 0!==e){const t=e.value;if(q(t)||!A(t))o+="string"==typeof t?t:String(t);else for(const e of t)o+="string"==typeof e?e:String(e)}}return o+=t[e],o}commit(){this.dirty&&(this.dirty=!1,this.element.setAttribute(this.name,this._getValue()))}}class S{constructor(t){this.value=void 0,this.committer=t}setValue(t){t===y||q(t)&&t===this.value||(this.value=t,f(t)||(this.committer.dirty=!0))}commit(){for(;f(this.value);){const t=this.value;this.value=y,t(this)}this.value!==y&&this.committer.commit()}}class E{constructor(t){this.value=void 0,this.__pendingValue=void 0,this.options=t}appendInto(t){this.startNode=t.appendChild(d()),this.endNode=t.appendChild(d())}insertAfterNode(t){this.startNode=t,this.endNode=t.nextSibling}appendIntoPart(t){t.__insert(this.startNode=d()),t.__insert(this.endNode=d())}insertAfterPart(t){t.__insert(this.startNode=d()),this.endNode=t.endNode,t.endNode=this.startNode}setValue(t){this.__pendingValue=t}commit(){if(null===this.startNode.parentNode)return;for(;f(this.__pendingValue);){const t=this.__pendingValue;this.__pendingValue=y,t(this)}const t=this.__pendingValue;t!==y&&(q(t)?t!==this.value&&this.__commitText(t):t instanceof $?this.__commitTemplateResult(t):t instanceof Node?this.__commitNode(t):A(t)?this.__commitIterable(t):t===x?(this.value=x,this.clear()):this.__commitText(t))}__insert(t){this.endNode.parentNode.insertBefore(t,this.endNode)}__commitNode(t){this.value!==t&&(this.clear(),this.__insert(t),this.value=t)}__commitText(t){const e=this.startNode.nextSibling,r="string"==typeof(t=null==t?"":t)?t:String(t);e===this.endNode.previousSibling&&3===e.nodeType?e.data=r:this.__commitNode(document.createTextNode(r)),this.value=t}__commitTemplateResult(t){const e=this.options.templateFactory(t);if(this.value instanceof k&&this.value.template===e)this.value.update(t.values);else{const r=new k(e,t.processor,this.options),o=r._clone();r.update(t.values),this.__commitNode(o),this.value=r}}__commitIterable(t){Array.isArray(this.value)||(this.value=[],this.clear());const e=this.value;let r,o=0;for(const i of t)r=e[o],void 0===r&&(r=new E(this.options),e.push(r),0===o?r.appendIntoPart(this):r.insertAfterPart(e[o-1])),r.setValue(i),r.commit(),o++;o<e.length&&(e.length=o,this.clear(r&&r.endNode))}clear(t=this.startNode){o(this.startNode.parentNode,t.nextSibling,this.endNode)}}class B{constructor(t,e,r){if(this.value=void 0,this.__pendingValue=void 0,2!==r.length||""!==r[0]||""!==r[1])throw new Error("Boolean attributes can only contain a single expression");this.element=t,this.name=e,this.strings=r}setValue(t){this.__pendingValue=t}commit(){for(;f(this.__pendingValue);){const t=this.__pendingValue;this.__pendingValue=y,t(this)}if(this.__pendingValue===y)return;const t=!!this.__pendingValue;this.value!==t&&(t?this.element.setAttribute(this.name,""):this.element.removeAttribute(this.name),this.value=t),this.__pendingValue=y}}class T extends C{constructor(t,e,r){super(t,e,r),this.single=2===r.length&&""===r[0]&&""===r[1]}_createPart(){return new P(this)}_getValue(){return this.single?this.parts[0].value:super._getValue()}commit(){this.dirty&&(this.dirty=!1,this.element[this.name]=this._getValue())}}class P extends S{}let I=!1;(()=>{try{const t={get capture(){return I=!0,!1}};window.addEventListener("test",t,t),window.removeEventListener("test",t,t)}catch(t){}})();class L{constructor(t,e,r){this.value=void 0,this.__pendingValue=void 0,this.element=t,this.eventName=e,this.eventContext=r,this.__boundHandleEvent=t=>this.handleEvent(t)}setValue(t){this.__pendingValue=t}commit(){for(;f(this.__pendingValue);){const t=this.__pendingValue;this.__pendingValue=y,t(this)}if(this.__pendingValue===y)return;const t=this.__pendingValue,e=this.value,r=null==t||null!=e&&(t.capture!==e.capture||t.once!==e.once||t.passive!==e.passive),o=null!=t&&(null==e||r);r&&this.element.removeEventListener(this.eventName,this.__boundHandleEvent,this.__options),o&&(this.__options=_(t),this.element.addEventListener(this.eventName,this.__boundHandleEvent,this.__options)),this.value=t,this.__pendingValue=y}handleEvent(t){"function"==typeof this.value?this.value.call(this.eventContext||this.element,t):this.value.handleEvent(t)}}const _=t=>t&&(I?{capture:t.capture,passive:t.passive,once:t.once}:t.capture)
/**
     * @license
     * Copyright (c) 2017 The Polymer Project Authors. All rights reserved.
     * This code may only be used under the BSD style license found at
     ...
     * subject to an additional IP rights grant found at
     * http://polymer.github.io/PATENTS.txt
     */;function O(t){let e=H.get(t.type);void 0===e&&(e={stringsArray:new WeakMap,keyString:new Map},H.set(t.type,e));let r=e.stringsArray.get(t.strings);if(void 0!==r)return r;const o=t.strings.join(i);return r=e.keyString.get(o),void 0===r&&(r=new c(t,t.getTemplateElement()),e.keyString.set(o,r)),e.stringsArray.set(t.strings,r),r}const H=new Map,R=new WeakMap;
/**
     * @license
     * Copyright (c) 2017 The Polymer Project Authors. All rights reserved.
     * This code may only be used under the BSD style license found at
...
/**
     ...
     * http://polymer.github.io/PATENTS.txt
     */
class{handleAttributeExpressions(t,e,r,o){const i=e[0];if("."===i){return new T(t,e.slice(1),r).parts}if("@"===i)return[new L(t,e.slice(1),o.eventContext)];if("?"===i)return[new B(t,e.slice(1),r)];return new C(t,e,r).parts}handleTextExpression(t){return new E(t)}};
/**
     * @license
     * Copyright (c) 2017 The Polymer Project Authors. All rights reserved.
     * This code may only be used under the BSD style license found at
     ...
     * subject to an additional IP rights grant found at
     * http://polymer.github.io/PATENTS.txt
     */"undefined"!=typeof window&&(window.litHtmlVersions||(window.litHtmlVersions=[])).push("1.4.1");const D=(t,...e)=>new $(t,e,"html",F),N=(t,e)=>`${t}--${e}`;let U=!0;void 0===window.ShadyCSS?U=!1:void 0===window.ShadyCSS.prepareTemplateDom&&(console.warn("Incompatible ShadyCSS version detected. Please update to at least @webcomponents/webcomponentsjs@2.0.2 and @webcomponents/shadycss@1.3.1."),U=!1);const V=t=>e=>{const r=N(e.type,t);let o=H.get(r);void 0===o&&(o={stringsArray:new WeakMap,keyString:new Map},H.set(r,o));let s=o.stringsArray.get(e.strings);if(void 0!==s)return s;const a=e.strings.join(i);if(s=o.keyString.get(a),void 0===s){const r=e.getTemplateElement();U&&window.ShadyCSS.prepareTemplateDom(r,t),s=new c(e,r),o.keyString.set(a,s)}return o.stringsArray.set(e.strings,s),s},j=["html","svg"],G=new Set,K=(t,e,r)=>{G.add(t);const o=r?r.element:document.createElement("template"),i=e.querySelectorAll("style"),{length:s}=i;if(0===s)return void window.ShadyCSS.prepareTemplateStyles(o,t);const a=document.createElement("style");for(let t=0;t<s;t++){const e=i[t];e.parentNode.removeChild(e),a.textContent+=e.textContent}(t=>{j.forEach((e=>{const r=H.get(N(e,t));void 0!==r&&r.keyString.forEach((t=>{const{element:{content:e}}=t,r=new Set;Array.from(e.querySelectorAll("style")).forEach((t=>{r.add(t)})),m(t,r)}))}))})(t);const n=o.content;r?function(t,e,r=null){const{element:{content:o},parts:i}=t;if(null==r)return void o.appendChild(e);const s=document.createTreeWalker(o,133,null,!1);let a=b(i),n=0,c=-1;for(;s.nextNode();)for(c++,s.currentNode===r&&(n=h(e),r.parentNode.insertBefore(e,r));-1!==a&&i[a].index===c;){if(n>0){for(;-1!==a;)i[a].index+=n,a=b(i,a);return}a=b(i,a)}}(r,a,n.firstChild):n.insertBefore(a,n.firstChild),window.ShadyCSS.prepareTemplateStyles(o,t);const c=n.querySelector("style");if(window.ShadyCSS.nativeShadow&&null!==c)e.insertBefore(c.cloneNode(!0),e.firstChild);else if(r){n.insertBefore(a,n.firstChild);const t=new Set;t.add(a),m(r,t)}};window.JSCompiler_renameProperty=(t,e)=>t;const Z={toAttribute(t,e){switch(e){case Boolean:return t?"":null;case Object:case Array:return null==t?t:JSON.stringify(t)}return t},fromAttribute(t,e){switch(e){case Boolean:return null!==t;case Number:return null===t?null:Number(t);case Object:case Array:return JSON.parse(t)}return t}},W=(t,e)=>e!==t&&(e==e||t==t),X={attribute:!0,type:String,converter:Z,reflect:!1,hasChanged:W},Y="finalized";class J extends HTMLElement{constructor(){super(),this.initialize()}static get observedAttributes(){this.finalize();const t=[];return this._classProperties.forEach(((e,r)=>{const o=this._attributeNameForProperty(r,e);void 0!==o&&(this._attributeToPropertyMap.set(o,r),t.push(o))})),t}static _ensureClassProperties(){if(!this.hasOwnProperty(JSCompiler_renameProperty("_classProperties",this))){this._classProperties=new Map;const t=Object.getPrototypeOf(this)._classProperties;void 0!==t&&t.forEach(((t,e)=>this._classProperties.set(e,t)))}}static createProperty(t,e=X){if(this._ensureClassProperties(),this._classProperties.set(t,e),e.noAccessor||this.prototype.hasOwnProperty(t))return;const r="symbol"==typeof t?Symbol():`__${t}`,o=this.getPropertyDescriptor(t,r,e);void 0!==o&&Object.defineProperty(this.prototype,t,o)}static getPropertyDescriptor(t,e,r){return{get(){return this[e]},set(o){const i=this[t];this[e]=o,this.requestUpdateInternal(t,i,r)},configurable:!0,enumerable:!0}}static getPropertyOptions(t){return this._classProperties&&this._classProperties.get(t)||X}static finalize(){const t=Object.getPrototypeOf(this);if(t.hasOwnProperty(Y)||t.finalize(),this.finalized=!0,this._ensureClassProperties(),this._attributeToPropertyMap=new Map,this.hasOwnProperty(JSCompiler_renameProperty("properties",this))){const t=this.properties,e=[...Object.getOwnPropertyNames(t),..."function"==typeof Object.getOwnPropertySymbols?Object.getOwnPropertySymbols(t):[]];for(const r of e)this.createProperty(r,t[r])}}static _attributeNameForProperty(t,e){const r=e.attribute;return!1===r?void 0:"string"==typeof r?r:"string"==typeof t?t.toLowerCase():void 0}static _valueHasChanged(t,e,r=W){return r(t,e)}static _propertyValueFromAttribute(t,e){const r=e.type,o=e.converter||Z,i="function"==typeof o?o:o.fromAttribute;return i?i(t,r):t}static _propertyValueToAttribute(t,e){if(void 0===e.reflect)return;const r=e.type,o=e.converter;return(o&&o.toAttribute||Z.toAttribute)(t,r)}initialize(){this._updateState=0,this._updatePromise=new Promise((t=>this._enableUpdatingResolver=t)),this._changedProperties=new Map,this._saveInstanceProperties(),this.requestUpdateInternal()}_saveInstanceProperties(){this.constructor._classProperties.forEach(((t,e)=>{if(this.hasOwnProperty(e)){const t=this[e];delete this[e],this._instanceProperties||(this._instanceProperties=new Map),this._instanceProperties.set(e,t)}}))}_applyInstanceProperties(){this._instanceProperties.forEach(((t,e)=>this[e]=t)),this._instanceProperties=void 0}connectedCallback(){this.enableUpdating()}enableUpdating(){void 0!==this._enableUpdatingResolver&&(this._enableUpdatingResolver(),this._enableUpdatingResolver=void 0)}disconnectedCallback(){}attributeChangedCallback(t,e,r){e!==r&&this._attributeToProperty(t,r)}_propertyToAttribute(t,e,r=X){const o=this.constructor,i=o._attributeNameForProperty(t,r);if(void 0!==i){const t=o._propertyValueToAttribute(e,r);if(void 0===t)return;this._updateState=8|this._updateState,null==t?this.removeAttribute(i):this.setAttribute(i,t),this._updateState=-9&this._updateState}}_attributeToProperty(t,e){if(8&this._updateState)return;const r=this.constructor,o=r._attributeToPropertyMap.get(t);if(void 0!==o){const t=r.getPropertyOptions(o);this._updateState=16|this._updateState,this[o]=r._propertyValueFromAttribute(e,t),this._updateState=-17&this._updateState}}requestUpdateInternal(t,e,r){let o=!0;if(void 0!==t){const i=this.constructor;r=r||i.getPropertyOptions(t),i._valueHasChanged(this[t],e,r.hasChanged)?(this._changedProperties.has(t)||this._changedProperties.set(t,e),!0!==r.reflect||16&this._updateState||(void 0===this._reflectingProperties&&(this._reflectingProperties=new Map),this._reflectingProperties.set(t,r))):o=!1}!this._hasRequestedUpdate&&o&&(this._updatePromise=this._enqueueUpdate())}requestUpdate(t,e){return this.requestUpdateInternal(t,e),this.updateComplete}async _enqueueUpdate(){this._updateState=4|this._updateState;try{await this._updatePromise}catch(t){}const t=this.performUpdate();return null!=t&&await t,!this._hasRequestedUpdate}get _hasRequestedUpdate(){return 4&this._updateState}get hasUpdated(){return 1&this._updateState}performUpdate(){if(!this._hasRequestedUpdate)return;this._instanceProperties&&this._applyInstanceProperties();let t=!1;const e=this._changedProperties;try{t=this.shouldUpdate(e),t?this.update(e):this._markUpdated()}catch(e){throw t=!1,this._markUpdated(),e}t&&(1&this._updateState||(this._updateState=1|this._updateState,this.firstUpdated(e)),this.updated(e))}_markUpdated(){this._changedProperties=new Map,this._updateState=-5&this._updateState}get updateComplete(){return this._getUpdateComplete()}_getUpdateComplete(){return this.getUpdateComplete()}getUpdateComplete(){return this._updatePromise}shouldUpdate(t){return!0}update(t){void 0!==this._reflectingProperties&&this._reflectingProperties.size>0&&(this._reflectingProperties.forEach(((t,e)=>this._propertyToAttribute(e,this[e],t))),this._reflectingProperties=void 0),this._markUpdated()}updated(t){}firstUpdated(t){}}J.finalized=!0;
/**
     * @license
     * Copyright (c) 2017 The Polymer Project Authors. All rights reserved.
     * This code may only be used under the BSD style license found at
     ...
     * http://polymer.github.io/PATENTS.txt
     */
const Q=(t,e)=>"method"===e.kind&&e.descriptor&&!("value"in e.descriptor)?Object.assign(Object.assign({},e),{finisher(r){r.createProperty(e.key,t)}}):{kind:"field",key:Symbol(),placement:"own",descriptor:{},initializer(){"function"==typeof e.initializer&&(this[e.key]=e.initializer.call(this))},finisher(r){r.createProperty(e.key,t)}};function tt(t){return(e,r)=>void 0!==r?((t,e,r)=>{e.constructor.createProperty(r,t)})(t,e,r):Q(t,e)}function et(t,e){return(r,o)=>{const i={get(){return this.renderRoot.querySelector(t)},enumerable:!0,configurable:!0};if(e){const e=void 0!==o?o:r.key,s="symbol"==typeof e?Symbol():`__${e}`;i.get=function(){return void 0===this[s]&&(this[s]=this.renderRoot.querySelector(t)),this[s]}}return void 0!==o?rt(i,r,o):ot(i,r)}}const rt=(t,e,r)=>{Object.defineProperty(e,r,t)},ot=(t,e)=>({kind:"method",placement:"prototype",key:e.key,descriptor:t}),it=Element.prototype,st=it.msMatchesSelector||it.webkitMatchesSelector;function at(t="",e=!1,r=""){return(o,i)=>{const s={get(){const o="slot"+(t?`[name=${t}]`:":not([name])"),i=this.renderRoot.querySelector(o);let s=i&&i.assignedNodes({flatten:e});return s&&r&&(s=s.filter((t=>t.nodeType===Node.ELEMENT_NODE&&(t.matches?t.matches(r):st.call(t,r))))),s},enumerable:!0,configurable:!0};return void 0!==i?rt(s,o,i):ot(s,o)}}
/**
    @license
...
/**
     ...
     * http://polymer.github.io/PATENTS.txt
     */
(window.litElementVersions||(window.litElementVersions=[])).push("2.5.1");const dt={};class pt extends J{static getStyles(){return this.styles}static _getUniqueStyles(){if(this.hasOwnProperty(JSCompiler_renameProperty("_styles",this)))return;const t=this.getStyles();if(Array.isArray(t)){const e=(t,r)=>t.reduceRight(((t,r)=>Array.isArray(r)?e(r,t):(t.add(r),t)),r),r=e(t,new Set),o=[];r.forEach((t=>o.unshift(t))),this._styles=o}else this._styles=void 0===t?[]:[t];this._styles=this._styles.map((t=>{if(t instanceof CSSStyleSheet&&!nt){const e=Array.prototype.slice.call(t.cssRules).reduce(((t,e)=>t+e.cssText),"");return new lt(String(e),ct)}return t}))}initialize(){super.initialize(),this.constructor._getUniqueStyles(),this.renderRoot=this.createRenderRoot(),window.ShadowRoot&&this.renderRoot instanceof window.ShadowRoot&&this.adoptStyles()}createRenderRoot(){return this.attachShadow(this.constructor.shadowRootOptions)}adoptStyles(){const t=this.constructor._styles;0!==t.length&&(void 0===window.ShadyCSS||window.ShadyCSS.nativeShadow?nt?this.renderRoot.adoptedStyleSheets=t.map((t=>t instanceof CSSStyleSheet?t:t.styleSheet)):this._needsShimAdoptedStyleSheets=!0:window.ShadyCSS.ScopingShim.prepareAdoptedCssText(t.map((t=>t.cssText)),this.localName))}connectedCallback(){super.connectedCallback(),this.hasUpdated&&void 0!==window.ShadyCSS&&window.ShadyCSS.styleElement(this)}update(t){const e=this.render();super.update(t),e!==dt&&this.constructor.render(e,this.renderRoot,{scopeName:this.localName,eventContext:this}),this._needsShimAdoptedStyleSheets&&(this._needsShimAdoptedStyleSheets=!1,this.constructor._styles.forEach((t=>{const e=document.createElement("style");e.textContent=t.cssText,this.renderRoot.appendChild(e)})))}render(){return dt}}pt.finalized=!0,pt.render=(t,e,r)=>{if(!r||"object"!=typeof r||!r.scopeName)throw new Error("The `scopeName` option is required.");const i=r.scopeName,s=R.has(e),a=U&&11===e.nodeType&&!!e.host,n=a&&!G.has(i),c=n?document.createDocumentFragment():e;if(((t,e,r)=>{let i=R.get(e);void 0===i&&(o(e,e.firstChild),R.set(e,i=new E(Object.assign({templateFactory:O},r))),i.appendInto(e)),i.setValue(t),i.commit()})(t,c,Object.assign({templateFactory:V(i)},r)),n){const t=R.get(c);R.delete(c);const r=t.value instanceof k?t.value.template:void 0;K(i,c,r),o(e,e.firstChild),e.appendChild(c),R.set(e,t)}!s&&a&&window.ShadyCSS.styleElement(e.host)},pt.shadowRootOptions={mode:"open"};const mt=new Set;new MutationObserver((()=>{const t="rtl"===document.documentElement.dir?document.documentElement.dir:"ltr";mt.forEach((e=>{e.setAttribute("dir",t)}))})).observe(document.documentElement,{attributes:!0,attributeFilter:["dir"]});class ht extends(function(t){class r extends t{constructor(){super(...arguments),this.dir="ltr"}get isLTR(){return"ltr"===this.dir}connectedCallback(){if(!this.hasAttribute("dir")){let e=this.assignedSlot||this.parentNode;for(;e!==document.documentElement&&(void 0===(t=e).startManagingContentDirection&&"SP-THEME"!==t.tagName);)e=e.assignedSlot||e.parentNode||e.host;if(this.dir="rtl"===e.dir?e.dir:this.dir||"ltr",e===document.documentElement)mt.add(this);else{const{localName:t}=e;t.search("-")>-1&&!customElements.get(t)?customElements.whenDefined(t).then((()=>{e.startManagingContentDirection(this)})):e.startManagingContentDirection(this)}this._dirParent=e}var t;super.connectedCallback()}disconnectedCallback(){super.disconnectedCallback(),this._dirParent&&(this._dirParent===document.documentElement?mt.delete(this):this._dirParent.stopManagingContentDirection(this),this.removeAttribute("dir"))}}return e([tt({reflect:!0})],r.prototype,"dir",void 0),r}(pt)){}function bt(t,{validSizes:r=["s","m","l","xl"],noDefaultSize:o}={}){class i extends t{constructor(){super(...arguments),this._size="m"}get size(){return this._size||"m"}set size(t){const e=o?null:"m",i=t?t.toLocaleLowerCase():t,s=r.includes(i)?i:e;if(s&&this.setAttribute("size",s),this._size===s)return;const a=this._size;this._size=s,this.requestUpdate("size",a)}firstUpdated(t){super.firstUpdated(t),this.hasAttribute("size")||o||this.setAttribute("size",this.size)}}return e([tt({type:String,reflect:!0})],i.prototype,"size",null),i}
/**
     * @license
     ...
     * subject to an additional IP rights grant found at
     * http://polymer.github.io/PATENTS.txt
     */const vt=new WeakMap,gt=g((t=>e=>{const r=vt.get(e);if(void 0===t&&e instanceof S){if(void 0!==r||!vt.has(e)){const t=e.committer.name;e.committer.element.removeAttribute(t)}}else t!==r&&e.setValue(t);vt.set(e,t)}));
/**
     * @license
     * Copyright (c) 2018 The Polymer Project Authors. All rights reserved.
     * This code may only be used under the BSD style license found at
     ...
     * http://polymer.github.io/PATENTS.txt
     */
class ft{constructor(t){this.classes=new Set,this.changed=!1,this.element=t;const e=(t.getAttribute("class")||"").split(/\s+/);for(const t of e)this.classes.add(t)}add(t){this.classes.add(t),this.changed=!0}remove(t){this.classes.delete(t),this.changed=!0}commit(){if(this.changed){let t="";this.classes.forEach((e=>t+=e+" ")),this.element.setAttribute("class",t)}}}const yt=new WeakMap,xt=g((t=>e=>{if(!(e instanceof S)||e instanceof P||"class"!==e.committer.name||e.committer.parts.length>1)throw new Error("The `classMap` directive must be used in the `class` attribute and must be the only part in the attribute.");const{committer:r}=e,{element:o}=r;let i=yt.get(e);void 0===i&&(o.setAttribute("class",r.strings.join(" ")),yt.set(e,i=new Set));const s=o.classList||new ft(o);i.forEach((e=>{e in t||(s.remove(e),i.delete(e))}));for(const e in t){const r=t[e];r!=i.has(e)&&(r?(s.add(e),i.add(e)):(s.remove(e),i.delete(e)))}"function"==typeof s.commit&&s.commit()})),kt=new WeakMap,wt=g((t=>e=>{if(!(e instanceof S)||e instanceof P||"style"!==e.committer.name||e.committer.parts.length>1)throw new Error("The `styleMap` directive must be used in the style attribute and must be the only part in the attribute.");const{committer:r}=e,{style:o}=r.element;let i=kt.get(e);void 0===i&&(o.cssText=r.strings.join(" "),kt.set(e,i=new Set)),i.forEach((e=>{e in t||(i.delete(e),-1===e.indexOf("-")?o[e]=null:o.removeProperty(e))}));for(const e in t)i.add(e),-1===e.indexOf("-")?o[e]=t[e]:o.setProperty(e,t[e])})),zt=g((t=>e=>{let r;if(e instanceof L||e instanceof E)throw new Error("The `live` directive is not allowed on text or event bindings");if(e instanceof B)$t(e.strings),r=e.element.hasAttribute(e.name),e.value=r;else{const{element:o,name:i,strings:s}=e.committer;if($t(s),e instanceof P){if(r=o[i],r===t)return}else e instanceof S&&(r=o.getAttribute(i));if(r===String(t))return}e.setValue(t)})),$t=t=>{if(2!==t.length||""!==t[0]||""!==t[1])throw new Error("`live` bindings can only contain a single expression")};function Mt(t){class r extends t{renderAnchor({id:t,className:e,ariaHidden:r,anchorContent:o=D`<slot></slot>`}){return D`<a
                    id=${t}
                    class=${gt(e)}
                    href=${gt(this.href)}
                    download=${gt(this.download)}
                    target=${gt(this.target)}
                    aria-label=${gt(this.label)}
                    aria-hidden=${gt(r?"true":void 0)}
                    rel=${gt(this.rel)}
                >${o}</a>`}}return e([tt({reflect:!0})],r.prototype,"download",void 0),e([tt()],r.prototype,"label",void 0),e([tt({reflect:!0})],r.prototype,"href",void 0),e([tt({reflect:!0})],r.prototype,"target",void 0),e([tt({reflect:!0})],r.prototype,"rel",void 0),r}"undefined"!=typeof globalThis?globalThis:"undefined"!=typeof window?window:"undefined"!=typeof global?global:"undefined"!=typeof self&&self;!function(){function t(t){var e=!0,r=!1,o=null,i={text:!0,search:!0,url:!0,tel:!0,email:!0,password:!0,number:!0,date:!0,month:!0,week:!0,time:!0,datetime:!0,"datetime-local":!0};function s(t){return!!(t&&t!==document&&"HTML"!==t.nodeName&&"BODY"!==t.nodeName&&"classList"in t&&"contains"in t.classList)}function a(t){var e=t.type,r=t.tagName;return!("INPUT"!==r||!i[e]||t.readOnly)||"TEXTAREA"===r&&!t.readOnly||!!t.isContentEditable}function n(t){t.classList.contains("focus-visible")||(t.classList.add("focus-visible"),t.setAttribute("data-focus-visible-added",""))}function c(t){t.hasAttribute("data-focus-visible-added")&&(t.classList.remove("focus-visible"),t.removeAttribute("data-focus-visible-added"))}function l(r){r.metaKey||r.altKey||r.ctrlKey||(s(t.activeElement)&&n(t.activeElement),e=!0)}function u(t){e=!1}function d(t){s(t.target)&&(e||a(t.target))&&n(t.target)}function p(t){s(t.target)&&(t.target.classList.contains("focus-visible")||t.target.hasAttribute("data-focus-visible-added"))&&(r=!0,window.clearTimeout(o),o=window.setTimeout((function(){r=!1}),100),c(t.target))}function m(t){"hidden"===document.visibilityState&&(r&&(e=!0),h())}function h(){document.addEventListener("mousemove",v),document.addEventListener("mousedown",v),document.addEventListener("mouseup",v),document.addEventListener("pointermove",v),document.addEventListener("pointerdown",v),document.addEventListener("pointerup",v),document.addEventListener("touchmove",v),document.addEventListener("touchstart",v),document.addEventListener("touchend",v)}function b(){document.removeEventListener("mousemove",v),document.removeEventListener("mousedown",v),document.removeEventListener("mouseup",v),document.removeEventListener("pointermove",v),document.removeEventListener("pointerdown",v),document.removeEventListener("pointerup",v),document.removeEventListener("touchmove",v),document.removeEventListener("touchstart",v),document.removeEventListener("touchend",v)}function v(t){t.target.nodeName&&"html"===t.target.nodeName.toLowerCase()||(e=!1,b())}document.addEventListener("keydown",l,!0),document.addEventListener("mousedown",u,!0),document.addEventListener("pointerdown",u,!0),document.addEventListener("touchstart",u,!0),document.addEventListener("visibilitychange",m,!0),h(),t.addEventListener("focus",d,!0),t.addEventListener("blur",p,!0),t.nodeType===Node.DOCUMENT_FRAGMENT_NODE&&t.host?t.host.setAttribute("data-js-focus-visible",""):t.nodeType===Node.DOCUMENT_NODE&&(document.documentElement.classList.add("js-focus-visible"),document.documentElement.setAttribute("data-js-focus-visible",""))}if("undefined"!=typeof window&&"undefined"!=typeof document){var e;window.applyFocusVisiblePolyfill=t;try{e=new CustomEvent("focus-visible-polyfill-ready")}catch(t){(e=document.createEvent("CustomEvent")).initCustomEvent("focus-visible-polyfill-ready",!1,!1,{})}window.dispatchEvent(e)}"undefined"!=typeof document&&t(document)}();let qt=!0;try{document.body.querySelector(":focus-visible")}catch(t){qt=!1}const At=t=>{var e;const r=Symbol("endPolyfillCoordination");return e=r,class extends t{constructor(){super(...arguments),this[e]=null}connectedCallback(){super.connectedCallback&&super.connectedCallback(),qt||requestAnimationFrame((()=>{null==this[r]&&(this[r]=(t=>{if(null==t.shadowRoot||t.hasAttribute("data-js-focus-visible"))return()=>{};if(!self.applyFocusVisiblePolyfill){const e=()=>{self.applyFocusVisiblePolyfill&&t.shadowRoot&&self.applyFocusVisiblePolyfill(t.shadowRoot),t.manageAutoFocus&&t.manageAutoFocus()};return self.addEventListener("focus-visible-polyfill-ready",e,{once:!0}),()=>{self.removeEventListener("focus-visible-polyfill-ready",e)}}return self.applyFocusVisiblePolyfill(t.shadowRoot),t.manageAutoFocus&&t.manageAutoFocus(),()=>{}})(this))}))}disconnectedCallback(){super.disconnectedCallback&&super.disconnectedCallback(),qt||requestAnimationFrame((()=>{null!=this[r]&&(this[r](),this[r]=null)}))}}};class Ct extends(At(ht)){constructor(){super(...arguments),this.disabled=!1,this.autofocus=!1,this._tabIndex=0,this.manipulatingTabindex=!1}get tabIndex(){if(this.focusElement===this){const t=this.hasAttribute("tabindex")?Number(this.getAttribute("tabindex")):NaN;return isNaN(t)?-1:t}const t=parseFloat(this.hasAttribute("tabindex")&&this.getAttribute("tabindex")||"0");return this.disabled||t<0?-1:this.focusElement?this.focusElement.tabIndex:t}set tabIndex(t){if(this.manipulatingTabindex)this.manipulatingTabindex=!1;else if(this.focusElement!==this){if(-1===t?this.addEventListener("pointerdown",this.onPointerdownManagementOfTabIndex):(this.manipulatingTabindex=!0,this.removeEventListener("pointerdown",this.onPointerdownManagementOfTabIndex)),-1===t||this.disabled)return this.setAttribute("tabindex","-1"),this.removeAttribute("focusable"),void(-1!==t&&this.manageFocusElementTabindex(t));this.setAttribute("focusable",""),this.hasAttribute("tabindex")?this.removeAttribute("tabindex"):this.manipulatingTabindex=!1,this.manageFocusElementTabindex(t)}else if(t!==this.tabIndex){this._tabIndex=t;const e=this.disabled?"-1":""+t;this.setAttribute("tabindex",e)}}onPointerdownManagementOfTabIndex(){-1===this.tabIndex&&(this.tabIndex=0,this.focus({preventScroll:!0}))}async manageFocusElementTabindex(t){this.focusElement||await this.updateComplete,null===t?this.focusElement.removeAttribute("tabindex"):this.focusElement.tabIndex=t}get focusElement(){throw new Error("Must implement focusElement getter!")}focus(t){!this.disabled&&this.focusElement&&(this.focusElement!==this?this.focusElement.focus(t):HTMLElement.prototype.focus.apply(this,[t]))}blur(){this.focusElement!==this?this.focusElement.blur():HTMLElement.prototype.blur.apply(this)}click(){this.disabled||(this.focusElement!==this?this.focusElement.click():HTMLElement.prototype.click.apply(this))}manageAutoFocus(){this.autofocus&&(this.dispatchEvent(new KeyboardEvent("keydown",{code:"Tab"})),this.focusElement.focus())}firstUpdated(t){super.firstUpdated(t),this.manageAutoFocus(),this.hasAttribute("tabindex")&&"-1"===this.getAttribute("tabindex")||this.setAttribute("focusable","")}update(t){t.has("disabled")&&this.handleDisabledChanged(this.disabled,t.get("disabled")),super.update(t)}updated(t){super.updated(t),t.has("disabled")&&this.disabled&&this.blur()}async handleDisabledChanged(t,e){const r=()=>this.focusElement!==this&&void 0!==this.focusElement.disabled;t?(this.manipulatingTabindex=!0,this.setAttribute("tabindex","-1"),await this.updateComplete,r()?this.focusElement.disabled=!0:this.setAttribute("aria-disabled","true")):e&&(this.manipulatingTabindex=!0,this.focusElement===this?this.setAttribute("tabindex",""+this._tabIndex):this.removeAttribute("tabindex"),await this.updateComplete,r()?this.focusElement.disabled=!1:this.removeAttribute("aria-disabled"))}}e([tt({type:Boolean,reflect:!0})],Ct.prototype,"disabled",void 0),e([tt({type:Boolean})],Ct.prototype,"autofocus",void 0),e([tt({type:Number})],Ct.prototype,"tabIndex",null);const St=Symbol("slotElementObserver"),Et=Symbol("startObserving"),Bt=Symbol("slotContentIsPresent");function Tt(t,e){var r;const o=Array.isArray(e)?e:[e];class i extends t{constructor(){super(...arguments),this[r]=new Map,this.managePresenceObservedSlot=()=>{o.forEach((t=>{this[Bt].set(t,!!this.querySelector(t))})),this.requestUpdate()}}get slotContentIsPresent(){if(1===o.length)return this[Bt].get(o[0])||!1;throw new Error("Multiple selectors provided to `ObserveSlotPresence` use `getSlotContentPresence(selector: string)` instead.")}getSlotContentPresence(t){if(this[Bt].has(t))return this[Bt].get(t)||!1;throw new Error("The provided selector `` is not being observed.")}[(r=Bt,Et)](){this[St]||(this[St]=new MutationObserver(this.managePresenceObservedSlot)),this[St].observe(this,{childList:!0,subtree:!0}),this.managePresenceObservedSlot()}connectedCallback(){super.connectedCallback(),this[Et]()}disconnectedCallback(){this[St].disconnect(),super.disconnectedCallback()}}return i}const Pt=Symbol("slotElementObserver"),It=Symbol("assignedNodes"),Lt=Symbol("startObserving");function _t(t,r){var o;class i extends t{constructor(){super(...arguments),this.slotHasContent=!1}manageTextObservedSlot(){if(!this[It])return;const t=[...this[It]].filter((t=>!!t.tagName||!!t.textContent&&t.textContent.trim()));this.slotHasContent=t.length>0}firstUpdated(t){super.firstUpdated(t),this.manageTextObservedSlot()}[(o=It,Lt)](){if(!this[Pt]){const t=t=>{for(const e of t)"characterData"===e.type&&this.manageTextObservedSlot()};this[Pt]=new MutationObserver(t)}this[Pt].observe(this,{characterData:!0,subtree:!0})}connectedCallback(){super.connectedCallback(),this[Lt]()}disconnectedCallback(){this[Pt]&&this[Pt].disconnect(),super.disconnectedCallback()}}return e([tt({type:Boolean,attribute:!1})],i.prototype,"slotHasContent",void 0),e([at(r,!0)],i.prototype,o,void 0),i}const Ot=(t,e,r)=>{const o=[],i=[];for(let s=0;s<t.length;++s){const a=t[s];r&&i.push(r(a)||(()=>{}));const n=document.createComment("placeholder for reparented element");o.push(n);const c=a.parentElement||a.getRootNode();c&&c!==a&&c.replaceChild(n,a),e.append(a)}return function(){return function(t,e,r=[]){for(let o=0;o<e.length;++o){const i=e[o],s=t[o],a=s.parentElement||s.getRootNode();r[o]&&r[o](i),a&&a!==s&&a.replaceChild(i,s),delete t[o]}return e}(o,t,i)}};class Ht extends(Mt(_t(Tt(Ct,'[slot="icon"]')))){constructor(){super(),this.active=!1,this.type="button",this.proxyFocus=this.proxyFocus.bind(this),this.addEventListener("click",this.handleClickCapture,{capture:!0})}get hasIcon(){return this.slotContentIsPresent}get hasLabel(){return this.slotHasContent}get focusElement(){return this}get buttonContent(){const t=[D`
            ...
            `];return this.hasIcon&&t.unshift(D`
        ...
        `}renderButton(){return D`
            ${this.buttonContent}
        `}render(){return this.href&&this.href.length>0?this.renderAnchor():this.renderButton()}handleKeydown(t){const{code:e}=t;switch(e){case"Space":t.preventDefault(),void 0===this.href&&(this.addEventListener("keyup",this.handleKeyup),this.active=!0)}}handleKeypress(t){const{code:e}=t;switch(e){case"Enter":this.click()}}handleKeyup(t){const{code:e}=t;switch(e){case"Space":this.removeEventListener("keyup",this.handleKeyup),this.active=!1,this.click()}}handleRemoveActive(){this.active=!1}handlePointerdown(){this.active=!0}manageAnchor(){this.href&&this.href.length>0?("button"===this.getAttribute("role")&&this.setAttribute("role","link"),this.removeEventListener("click",this.shouldProxyClick)):(this.hasAttribute("role")&&"link"!==this.getAttribute("role")||this.setAttribute("role","button"),this.addEventListener("click",this.shouldProxyClick))}firstUpdated(t){super.firstUpdated(t),this.hasAttribute("tabindex")||(this.tabIndex=0),this.manageAnchor(),this.addEventListener("keydown",this.handleKeydown),this.addEventListener("keypress",this.handleKeypress),this.addEventListener("pointerdown",this.handlePointerdown)}updated(t){super.updated(t),t.has("href")&&this.manageAnchor(),t.has("label")&&this.setAttribute("aria-label",this.label||""),t.has("active")&&(this.active?(this.addEventListener("focusout",this.handleRemoveActive),this.addEventListener("pointerup",this.handleRemoveActive),this.addEventListener("pointerleave",this.handleRemoveActive)):(this.removeEventListener("focusout",this.handleRemoveActive),this.removeEventListener("pointerup",this.handleRemoveActive),this.removeEventListener("pointerleave",this.handleRemoveActive))),this.anchorElement&&(this.anchorElement.addEventListener("focus",this.proxyFocus),this.anchorElement.tabIndex=-1)}}e([tt({type:Boolean,reflect:!0})],Ht.prototype,"active",void 0),e([tt({type:String})],Ht.prototype,"type",void 0),e([et(".anchor")],Ht.prototype,"anchorElement",void 0);const Rt=ut`
...
`;class Ft extends Ht{static get styles(){return[Rt]}}const Dt=ut`
...
`;class Nt extends(bt(Ft)){constructor(){super(...arguments),this.variant="cta",this.warning=!1,this.quiet=!1}static get styles(){return[...super.styles,Dt]}}e([tt({reflect:!0})],Nt.prototype,"variant",void 0),e([tt({type:Boolean,reflect:!0})],Nt.prototype,"warning",void 0),e([tt({type:Boolean,reflect:!0})],Nt.prototype,"quiet",void 0);const Ut=ut`
...
`;class jt extends ht{static get styles(){return[Vt]}render(){return D`
            <slot></slot>
        `}}e([tt()],jt.prototype,"label",void 0),e([tt({reflect:!0})],jt.prototype,"size",void 0);class Gt{constructor(){this.iconsetMap=new Map}static getInstance(){return Gt.instance||(Gt.instance=new Gt),Gt.instance}addIconset(t,e){this.iconsetMap.set(t,e);const r=new CustomEvent("sp-iconset-added",{bubbles:!0,composed:!0,detail:{name:t,iconset:e}});setTimeout((()=>window.dispatchEvent(r)),0)}removeIconset(t){this.iconsetMap.delete(t);const e=new CustomEvent("sp-iconset-removed",{bubbles:!0,composed:!0,detail:{name:t}});setTimeout((()=>window.dispatchEvent(e)),0)}getIconset(t){return this.iconsetMap.get(t)}}class Kt extends jt{constructor(){super(...arguments),this.iconsetListener=t=>{if(!this.name)return;const e=this.parseIcon(this.name);t.detail.name===e.iconset&&(this.updateIconPromise=this.updateIcon())}}connectedCallback(){super.connectedCallback(),window.addEventListener("sp-iconset-added",this.iconsetListener)}disconnectedCallback(){super.disconnectedCallback(),window.removeEventListener("sp-iconset-added",this.iconsetListener)}firstUpdated(){this.updateIconPromise=this.updateIcon()}attributeChangedCallback(t,e,r){super.attributeChangedCallback(t,e,r),this.updateIconPromise=this.updateIcon()}render(){return this.name?D`
                <div id="container"></div>
            `:this.src?D`
                <img src="${this.src}" alt=${gt(this.label)} />
            `:super.render()}async updateIcon(){if(!this.name)return Promise.resolve();const t=this.parseIcon(this.name),e=Gt.getInstance().getIconset(t.iconset);return e&&this.iconContainer?(this.iconContainer.innerHTML="",e.applyIconToElement(this.iconContainer,t.icon,this.size||"",this.label?this.label:"")):Promise.resolve()}parseIcon(t){const e=t.split(":");let r="default",o=t;return e.length>1&&(r=e[0],o=e[1]),{iconset:r,icon:o}}async _getUpdateComplete(){await super._getUpdateComplete(),await this.updateIconPromise}}let Zt;e([tt()],Kt.prototype,"src",void 0),e([tt()],Kt.prototype,"name",void 0),e([et("#container")],Kt.prototype,"iconContainer",void 0);const Wt=function(t,...e){return Zt?Zt(t,...e):e.reduce(((e,r,o)=>e+r+t[o+1]),t[0])},Xt=t=>{Zt=t};customElements.define("sp-icon-cross75",class extends jt{render(){return Xt(D),Wt`<svg
...
`;customElements.define("sp-icon-corner-triangle300",class extends jt{render(){return Xt(D),Wt`<svg
    xmlns="http://www.w3.org/2000/svg"
    viewBox="0 0 7 7"
    aria-hidden="true"
    fill="currentColor"
  >
    ...
    />
  </svg>`}});const ee={s:"spectrum-UIIcon-CornerTriangle75",m:"spectrum-UIIcon-CornerTriangle100",l:"spectrum-UIIcon-CornerTriangle200",xl:"spectrum-UIIcon-CornerTriangle300"};let re;class oe extends(bt(Ht)){constructor(){super(),this.emphasized=!1,this.holdAffordance=!1,this.quiet=!1,this.selected=!1,this.toggles=!1,this._value="",this.onClick=()=>{if(!this.toggles)return;this.selected=!this.selected;this.dispatchEvent(new Event("change",{cancelable:!0}))||(this.selected=!this.selected)},this.addEventListener("click",this.onClick),this.addEventListener("pointerdown",this.onPointerdown)}static get styles(){return[Qt,te]}get value(){return this._value||this.itemText}set value(t){t!==this._value&&(this._value=t||"",this._value?this.setAttribute("value",this._value):this.removeAttribute("value"))}get itemText(){return(this.textContent||"").trim()}onPointerdown(){this.addEventListener("pointerup",this.onPointerup),this.addEventListener("pointercancel",this.onPointerup),re=setTimeout((()=>{this.dispatchEvent(new CustomEvent("longpress",{bubbles:!0,composed:!0,detail:{source:"pointer"}}))}),300)}onPointerup(){clearTimeout(re),this.removeEventListener("pointerup",this.onPointerup),this.removeEventListener("pointercancel",this.onPointerup)}handleKeydown(t){if(!this.holdAffordance)return super.handleKeydown(t);const{code:e,altKey:r}=t;("Space"===e||r&&"ArrowDown"===e)&&(t.preventDefault(),"ArrowDown"===e&&(t.stopPropagation(),t.stopImmediatePropagation()),this.addEventListener("keyup",this.handleKeyup),this.active=!0)}handleKeyup(t){if(!this.holdAffordance)return super.handleKeyup(t);const{code:e,altKey:r}=t;("Space"===e||r&&"ArrowDown"===e)&&(t.stopPropagation(),this.dispatchEvent(new CustomEvent("longpress",{bubbles:!0,composed:!0,detail:{source:"keyboard"}})),this.active=!1)}get buttonContent(){const t=super.buttonContent;return this.holdAffordance&&t.unshift(D`
                <sp-icon-corner-triangle300
                    id="hold-affordance"
                    class="${ee[this.size]}"
                ></sp-icon-corner-triangle300>
            `),t}updated(t){super.updated(t),this.toggles&&t.has("selected")&&this.focusElement.setAttribute("aria-pressed",this.selected?"true":"false")}}e([tt({type:Boolean,reflect:!0})],oe.prototype,"emphasized",void 0),e([tt({type:Boolean,reflect:!0,attribute:"hold-affordance"})],oe.prototype,"holdAffordance",void 0),e([tt({type:Boolean,reflect:!0})],oe.prototype,"quiet",void 0),e([tt({type:Boolean,reflect:!0})],oe.prototype,"selected",void 0),e([tt({type:Boolean,reflect:!0})],oe.prototype,"toggles",void 0),e([tt({type:String})],oe.prototype,"value",null),customElements.define("sp-action-button",oe);const ie=ut`
...
`,se=[];class ae extends ht{constructor(){super(...arguments),this.buttons=[],this._buttonSelector="sp-action-button",this.compact=!1,this.emphasized=!1,this.justified=!1,this.label="",this.quiet=!1,this.vertical=!1,this._selected=se,this.handleFocusin=()=>{this.addEventListener("focusout",this.handleFocusout),this.addEventListener("keydown",this.handleKeydown)},this.handleKeydown=t=>{const{code:e}=t;if(!["ArrowUp","ArrowLeft","ArrowRight","ArrowDown","End","Home","PageUp","PageDown"].includes(e))return;const r=this.getRootNode().activeElement;if(!r)return;let o=this.buttons.indexOf(r);if(-1===o)return;const i=(t,e)=>t[(t.length+e)%t.length],s=t=>{for(o+=t;i(this.buttons,o).disabled;)o+=t};switch(e){case"ArrowUp":s(-1);break;case"ArrowLeft":s(this.isLTR?-1:1);break;case"ArrowRight":s(this.isLTR?1:-1);break;case"ArrowDown":s(1);break;case"End":o=this.buttons.length,s(-1);break;case"Home":o=-1,s(1);break;case"PageUp":case"PageDown":default:const r=[...this.getRootNode().querySelectorAll("sp-action-group")];if(r.length<2)return;t.preventDefault();const a="PageUp"===e?-1:1;let n=r.indexOf(this)+a,c=i(r,n);for(;!c.buttons.length;)n+=a,c=i(r,n);return void c.focus()}t.preventDefault();const a=i(this.buttons,o);r.tabIndex=-1,a.tabIndex=0,a.focus()},this.handleFocusout=t=>{const{relatedTarget:e}=t;if(!e||!this.contains(e)){const t=this.buttons.find((t=>this.selected.length?t.selected:!t.disabled));t&&(t.tabIndex=0)}this.removeEventListener("keydown",this.handleKeydown),this.removeEventListener("focusout",this.handleFocusout)}}static get styles(){return[ie]}get selected(){return this._selected}set selected(t){if(t===this.selected)return;const e=this.selected;this._selected=t;this.dispatchEvent(new Event("change",{bubbles:!0,composed:!0,cancelable:!0}))||(this._selected=e,this.buttons.map((t=>{t.selected=this.selected.includes(t.value)})))}handleClick(t){const e=t.target;if(void 0!==e.value)switch(this.selects){case"single":[...this.querySelectorAll("[selected]")].forEach((t=>{t.selected=!1,t.tabIndex=-1,t.setAttribute("aria-checked","false")})),e.selected=!0,e.tabIndex=0,e.setAttribute("aria-checked","true"),this.selected=[e.value],e.focus();break;case"multiple":{const t=[...this.selected];e.selected=!e.selected,e.setAttribute("aria-checked",e.selected?"true":"false"),e.selected?t.push(e.value):t.splice(this.selected.indexOf(e.value),1),this.selected=t;break}default:this.selected=se}}async manageSelects(){if(this.buttons.length)switch(this.selects){case"single":{let t,e;this.setAttribute("role","radiogroup");const r=this.buttons.map((async r=>{await r.updateComplete,r.setAttribute("role","radio"),r.setAttribute("aria-checked",r.selected?"true":"false"),r.tabIndex=r.selected?0:-1,r.selected&&(t=r),e||r.disabled||(e=r)}));await Promise.all(r),(t||e)&&((t||e).tabIndex=0),this.selected=t?[t.value]:se;break}case"multiple":{this.setAttribute("role","group");const t=[],e=this.buttons.map((async e=>{await e.updateComplete,e.setAttribute("role","checkbox"),e.setAttribute("aria-checked",e.selected?"true":"false"),e.tabIndex=0,e.selected&&t.push(e.value)}));await Promise.all(e),this.selected=t.length?t:se;break}default:this.buttons.forEach((t=>{t.setAttribute("role","button"),t.tabIndex=0})),this.removeAttribute("role"),this.selected=se}}render(){return D`
            <slot role="presentation"></slot>
        `}firstUpdated(t){super.firstUpdated(t),this.addEventListener("click",this.handleClick),this.addEventListener("focusin",this.handleFocusin)}updated(t){super.updated(t),t.has("selects")&&this.manageSelects(),(t.has("quiet")&&this.quiet||t.has("emphasized")&&this.emphasized)&&this.manageChildren(),t.has("label")&&(this.label||void 0!==t.get("label"))&&(this.label.length?this.setAttribute("aria-label",this.label):this.removeAttribute("aria-label"))}manageChildren(){this.buttons.forEach((t=>{t.quiet=this.quiet,t.emphasized=this.emphasized}))}connectedCallback(){if(super.connectedCallback(),!this.observer){const t=()=>{const t=[...this.querySelectorAll(this._buttonSelector)];t.filter((t=>{const e=t.parentElement;return!(null==e?void 0:e.closest(this._buttonSelector))})),this.buttons=t,this.manageChildren(),this.manageSelects()};this.observer=new MutationObserver(t),t()}this.observer.observe(this,{childList:!0,subtree:!0})}disconnectedCallback(){this.observer.disconnect(),super.disconnectedCallback()}}e([tt({type:Boolean,reflect:!0})],ae.prototype,"compact",void 0),e([tt({type:Boolean,reflect:!0})],ae.prototype,"emphasized",void 0),e([tt({type:Boolean,reflect:!0})],ae.prototype,"justified",void 0),e([tt({type:String})],ae.prototype,"label",void 0),e([tt({type:Boolean,reflect:!0})],ae.prototype,"quiet",void 0),e([tt({type:String})],ae.prototype,"selects",void 0),e([tt({type:Boolean,reflect:!0})],ae.prototype,"vertical",void 0),e([tt({type:Array})],ae.prototype,"selected",null),customElements.define("sp-action-group",ae);const ne=ut`
...
`;let le;customElements.define("sp-icon-chevron100",class extends jt{render(){return Xt(D),Wt`<svg
    xmlns="http://www.w3.org/2000/svg"
    viewBox="0 0 10 10"
    aria-hidden="true"
    fill="currentColor"
  >
    ...
    />
  </svg>`}});const ue=function(t,...e){return le?le(t,...e):e.reduce(((e,r,o)=>e+r+t[o+1]),t[0])},de=t=>{le=t};customElements.define("sp-icon-alert",class extends jt{render(){return de(D),(({width:t=24,height:e=24,hidden:r=!1,title:o="Alert"}={})=>ue`<svg
    xmlns="http://www.w3.org/2000/svg"
    height="${e}"
    viewBox="0 0 36 36"
    width="${t}"
  ...
  >
    ...
    />
  </svg>`)({hidden:!this.label,title:this.label})}});const pe=ut`
...
`;class me extends ht{constructor(){super(),this.selectable=!1,this.menuItems=[],this.focusedItemIndex=0,this.focusInItemIndex=0,this.prepItems=()=>{if(this.menuItems=[...this.querySelectorAll(`[role="${this.childRole}"]`)],!this.menuItems||0===this.menuItems.length)return;this.updateSelectedItemIndex();const t=this.menuItems[this.focusInItemIndex];this.getRootNode().activeElement===this&&this.forwardFocusVisibleToitem(t)},this.handleKeydown=this.handleKeydown.bind(this),this.startListeningToKeyboard=this.startListeningToKeyboard.bind(this),this.stopListeningToKeyboard=this.stopListeningToKeyboard.bind(this),this.onClick=this.onClick.bind(this),this.addEventListener("click",this.onClick),this.addEventListener("focusin",this.startListeningToKeyboard),this.addEventListener("focus",(()=>this.focus({preventScroll:!0})))}static get styles(){return[pe]}get childRole(){return"menu"===this.getAttribute("role")?"menuitem":"option"}focus({preventScroll:t}={}){if(!this.menuItems.length||this.menuItems.every((t=>t.disabled)))return;this.focusMenuItemByOffset(0),super.focus({preventScroll:t});const e=this.querySelector("[selected]");e&&!t&&e.scrollIntoView({block:"nearest"})}onClick(t){t.composedPath().find((t=>t instanceof Element&&t.getAttribute("role")===this.childRole))&&this.prepareToCleanUp()}startListeningToKeyboard(){const t=this.getRootNode().activeElement;if(t!==this&&(this.focus({preventScroll:!0}),t&&0===this.focusedItemIndex)){const e=this.menuItems.indexOf(t);e>0&&this.focusMenuItemByOffset(e)}this.addEventListener("keydown",this.handleKeydown),this.addEventListener("focusout",this.handleFocusout)}handleFocusout(){this.stopListeningToKeyboard();const t=this.menuItems[this.focusedItemIndex];t&&(t.focused=!1)}stopListeningToKeyboard(){this.removeEventListener("keydown",this.handleKeydown)}handleKeydown(t){const{code:e}=t;if("Tab"===e)return void this.prepareToCleanUp();if("Space"===e||"Enter"===e)return void this.menuItems[this.focusedItemIndex].click();if("ArrowDown"!==e&&"ArrowUp"!==e)return;const r=this.menuItems[this.focusedItemIndex],o="ArrowDown"===e?1:-1,i=this.focusMenuItemByOffset(o);i!==r&&(t.preventDefault(),i.scrollIntoView({block:"nearest"}))}focusMenuItemByOffset(t){const e=t||1;this.menuItems[this.focusedItemIndex].focused=!1,this.focusedItemIndex=(this.menuItems.length+this.focusedItemIndex+t)%this.menuItems.length;let r=this.menuItems[this.focusedItemIndex],o=this.menuItems.length;for(;r.disabled&&o;)o-=1,this.focusedItemIndex=(this.menuItems.length+this.focusedItemIndex+e)%this.menuItems.length,r=this.menuItems[this.focusedItemIndex];return r.disabled||(this.forwardFocusVisibleToitem(r),this.setAttribute("aria-activedescendant",r.id)),r}prepareToCleanUp(){document.addEventListener("focusout",(()=>{requestAnimationFrame((()=>{if(0===this.menuItems.length)return;this.menuItems[this.focusedItemIndex].focused=!1,this.updateSelectedItemIndex()}))}),{once:!0})}updateSelectedItemIndex(){let t=this.menuItems.length-1,e=this.menuItems[t];for(;t&&e&&!e.selected;)t-=1,e=this.menuItems[t];t=Math.max(t,0),this.menuItems.forEach(((e,r)=>{r!==t&&(e.focused=!1)})),this.focusedItemIndex=t,this.focusInItemIndex=t}forwardFocusVisibleToitem(t){let e=!1;try{e=this.matches(":focus-visible")||this.matches(".focus-visible")}catch(t){e=this.matches(".focus-visible")}t.focused=e}render(){return D`
            <slot></slot>
        `}firstUpdated(t){super.firstUpdated(t),"presentation"!==this.getAttribute("role")&&(this.tabIndex=0)}connectedCallback(){if(super.connectedCallback(),!this.hasAttribute("role")){const t=new CustomEvent("sp-menu-query-role",{bubbles:!0,composed:!0,detail:{role:""}});this.dispatchEvent(t),this.setAttribute("role",t.detail.role||"menu")}this.observer||(this.observer=new MutationObserver(this.prepItems)),this.observer.observe(this,{childList:!0,subtree:!0}),this.updateComplete.then((()=>this.prepItems()))}disconnectedCallback(){this.observer.disconnect(),super.disconnectedCallback()}}e([tt({type:Boolean,reflect:!0})],me.prototype,"selectable",void 0),customElements.define("sp-menu",me);const he=ut`
:host{--spectrum-overlay-animation-distance:var(--spectrum-picker-m-popover-offset-y,var(--spectrum-global-dimension-size-75));visibility:hidden;opacity:0;transition:transform var(--spectrum-global-animation-duration-100,.13s) ease-in-out,opacity var(--spectrum-global-animation-duration-100,.13s) ease-in-out,visibility 0ms linear var(--spectrum-global-animation-duration-100,.13s);pointer-events:none}:host([open]){visibility:visible;opacity:1;transition-delay:0ms;pointer-events:auto}:host([placement*=bottom][open]){transform:translateY(var(--spectrum-overlay-animation-distance))}:host([placement*=top][open]){transform:translateY(calc(-1*var(--spectrum-overlay-animation-distance)))}:host([placement*=right][open]){transform:translateX(var(--spectrum-overlay-animation-distance))}:host([placement*=left][open]){transform:translateX(calc(-1*var(--spectrum-overlay-animation-distance)))}:host{--spectrum-popover-target-offset:13px;--spectrum-popover-dialog-padding:30px 29px;--spectrum-popover-dialog-min-width:270px;--spectrum-popover-min-width:var(--spectrum-global-dimension-size-400);--spectrum-popover-min-height:var(--spectrum-global-dimension-size-400);display:inline-flex;flex-direction:column;min-width:var(--spectrum-popover-min-width,var(--spectrum-global-dimension-size-400));min-height:var(--spectrum-popover-min-height,var(--spectrum-global-dimension-size-400));border-style:solid;border-width:var(--spectrum-popover-border-size,var(--spectrum-alias-border-size-thin));border-radius:var(--spectrum-popover-border-radius,var(--spectrum-alias-border-radius-regular));outline:none;box-sizing:border-box}#tip,:host{position:absolute}#tip{-webkit-transform:translate(0)}#tip .triangle{stroke-linecap:square;stroke-linejoin:miter;stroke-width:var(--spectrum-popover-border-size,var(--spectrum-alias-border-size-thin))}:host([dialog]){min-width:var(--spectrum-popover-dialog-min-width);padding:var(--spectrum-popover-dialog-padding)}:host([placement*=left][tip]){margin-right:var(--spectrum-popover-target-offset)}:host([placement*=left]) #tip{left:100%}:host([placement*=right][tip]){margin-left:var(--spectrum-popover-target-offset)}:host([placement*=right]) #tip{right:100%;transform:scaleX(-1)}:host([placement*=left]) #tip,:host([placement*=right]) #tip{top:50%;margin-top:calc(var(--spectrum-global-dimension-size-150)*-1)}:host([placement*=bottom][tip]){margin-top:var(--spectrum-popover-target-offset)}:host([placement*=bottom]) #tip{bottom:100%;transform:scaleY(-1)}:host([placement*=top][tip]){margin-bottom:var(--spectrum-popover-target-offset)}:host([placement*=top]) #tip{top:100%}:host([placement*=bottom]) #tip,:host([placement*=top]) #tip{left:50%;margin-left:calc(var(--spectrum-global-dimension-size-150)*-1)}:host{background-color:var(--spectrum-popover-background-color,var(--spectrum-global-color-gray-50));border-color:var(--spectrum-popover-border-color,var(--spectrum-alias-border-color-dark));filter:drop-shadow(0 1px 4px var(--spectrum-popover-shadow-color,var(--spectrum-alias-dropshadow-color)));-webkit-filter:drop-shadow(0 1px 4px var(--spectrum-popover-shadow-color,var(--spectrum-alias-dropshadow-color)));will-change:filter;-webkit-clip-path:inset(-30px -30px);clip-path:inset(-30px -30px)}#tip .triangle{fill:var(--spectrum-popover-background-color,var(--spectrum-global-color-gray-50));stroke:var(--spectrum-popover-border-color,var(--spectrum-alias-border-color-dark))}:host{--sp-popover-tip-size:24px}:host([placement*=bottom]),:host([placement*=top]){max-height:calc(100% - var(--spectrum-overlay-animation-distance))}:host([placement*=left]),:host([placement*=right]){max-width:calc(100% - var(--spectrum-overlay-animation-distance))}::slotted(*){overscroll-behavior:contain}.tip{width:var(--sp-popover-tip-size);height:calc(var(--sp-popover-tip-size)/2);position:absolute;left:0}:host([placement*=right]) #tip{transform:none}:host([placement*=bottom]) #tip{transform:none}:host([placement*=top]) .tip{top:100%}:host([placement*=bottom]) .tip{bottom:100%;transform:scaleY(-1)}:host([placement*=left]) .tip{transform-origin:100% 0;transform:rotate(-90deg) translateY(-200%)}:host([placement*=right]) .tip{transform-origin:0 0;transform:rotate(90deg)}
`;class be extends ht{constructor(){super(...arguments),this.open=!1,this.placement="none",this.tip=!1}static get styles(){return[he]}renderTip(){return D`
            <div id="tip">
                <svg
        ...
        `}connectedCallback(){super.connectedCallback(),this.addEventListener("sp-overlay-query",this.onOverlayQuery)}disconnectedCallback(){super.disconnectedCallback(),this.removeEventListener("sp-overlay-query",this.onOverlayQuery)}onOverlayQuery(t){if(!t.target)return;if(t.target!==this)return;const e=this.shadowRoot.querySelector("#tip");e&&(t.detail.overlayContentTipElement=e)}render(){return D`
            <slot></slot>
            ${this.tip?this.renderTip():x}
        `}}e([tt({type:Boolean,reflect:!0})],be.prototype,"open",void 0),e([tt({reflect:!0})],be.prototype,"placement",void 0),e([tt({type:Boolean,reflect:!0})],be.prototype,"tip",void 0),customElements.define("sp-popover",be);const ve=ut`
...
`;var ge="top",fe="bottom",ye="right",xe="left",ke="auto",we=[ge,fe,ye,xe],ze="start",$e="end",Me="viewport",qe="popper",Ae=we.reduce((function(t,e){return t.concat([e+"-"+ze,e+"-"+$e])}),[]),Ce=[].concat(we,[ke]).reduce((function(t,e){return t.concat([e,e+"-"+ze,e+"-"+$e])}),[]),Se=["beforeRead","read","afterRead","beforeMain","main","afterMain","beforeWrite","write","afterWrite"];function Ee(t){return t.split("-")[0]}function Be(t){var e=t.getBoundingClientRect();return{width:e.width,height:e.height,top:e.top,right:e.right,bottom:e.bottom,left:e.left,x:e.left,y:e.top}}function Te(t){var e=Be(t),r=t.offsetWidth,o=t.offsetHeight;return Math.abs(e.width-r)<=1&&(r=e.width),Math.abs(e.height-o)<=1&&(o=e.height),{x:t.offsetLeft,y:t.offsetTop,width:r,height:o}}function Pe(t){if(null==t)return window;if("[object Window]"!==t.toString()){var e=t.ownerDocument;return e&&e.defaultView||window}return t}function Ie(t){return t instanceof Pe(t).Element||t instanceof Element}function Le(t){return t instanceof Pe(t).HTMLElement||t instanceof HTMLElement}function _e(t){return"undefined"!=typeof ShadowRoot&&(t instanceof Pe(t).ShadowRoot||t instanceof ShadowRoot)}function Oe(t,e){var r=e.getRootNode&&e.getRootNode();if(t.contains(e))return!0;if(r&&_e(r)){var o=e;do{if(o&&t.isSameNode(o))return!0;o=o.parentNode||o.host}while(o)}return!1}function He(t){return t?(t.nodeName||"").toLowerCase():null}function Re(t){return Pe(t).getComputedStyle(t)}function Fe(t){return["table","td","th"].indexOf(He(t))>=0}function De(t){return((Ie(t)?t.ownerDocument:t.document)||window.document).documentElement}function Ne(t){return"html"===He(t)?t:t.assignedSlot||t.parentNode||(_e(t)?t.host:null)||De(t)}function Ue(t){return Le(t)&&"fixed"!==Re(t).position?t.offsetParent:null}function Ve(t){for(var e=Pe(t),r=Ue(t);r&&Fe(r)&&"static"===Re(r).position;)r=Ue(r);return r&&("html"===He(r)||"body"===He(r)&&"static"===Re(r).position)?e:r||function(t){var e=-1!==navigator.userAgent.toLowerCase().indexOf("firefox");if(-1!==navigator.userAgent.indexOf("Trident")&&Le(t)&&"fixed"===Re(t).position)return null;for(var r=Ne(t);Le(r)&&["html","body"].indexOf(He(r))<0;){var o=Re(r);if("none"!==o.transform||"none"!==o.perspective||"paint"===o.contain||-1!==["transform","perspective"].indexOf(o.willChange)||e&&"filter"===o.willChange||e&&o.filter&&"none"!==o.filter)return r;r=r.parentNode}return null}(t)||e}function je(t){return["top","bottom"].indexOf(t)>=0?"x":"y"}var Ge=Math.max,Ke=Math.min,Ze=Math.round;function We(t,e,r){return Ge(t,Ke(e,r))}function Xe(t){return Object.assign({},{top:0,right:0,bottom:0,left:0},t)}function Ye(t,e){return e.reduce((function(e,r){return e[r]=t,e}),{})}var Je={name:"arrow",enabled:!0,phase:"main",fn:function(t){var e,r=t.state,o=t.name,i=t.options,s=r.elements.arrow,a=r.modifiersData.popperOffsets,n=Ee(r.placement),c=je(n),l=[xe,ye].indexOf(n)>=0?"height":"width";if(s&&a){var u=function(t,e){return Xe("number"!=typeof(t="function"==typeof t?t(Object.assign({},e.rects,{placement:e.placement})):t)?t:Ye(t,we))}(i.padding,r),d=Te(s),p="y"===c?ge:xe,m="y"===c?fe:ye,h=r.rects.reference[l]+r.rects.reference[c]-a[c]-r.rects.popper[l],b=a[c]-r.rects.reference[c],v=Ve(s),g=v?"y"===c?v.clientHeight||0:v.clientWidth||0:0,f=h/2-b/2,y=u[p],x=g-d[l]-u[m],k=g/2-d[l]/2+f,w=We(y,k,x),z=c;r.modifiersData[o]=((e={})[z]=w,e.centerOffset=w-k,e)}},effect:function(t){var e=t.state,r=t.options.element,o=void 0===r?"[data-popper-arrow]":r;null!=o&&("string"!=typeof o||(o=e.elements.popper.querySelector(o)))&&Oe(e.elements.popper,o)&&(e.elements.arrow=o)},requires:["popperOffsets"],requiresIfExists:["preventOverflow"]},Qe={left:"right",right:"left",bottom:"top",top:"bottom"};function tr(t){return t.replace(/left|right|bottom|top/g,(function(t){return Qe[t]}))}var er={start:"end",end:"start"};function rr(t){return t.replace(/start|end/g,(function(t){return er[t]}))}function or(t){var e=Pe(t);return{scrollLeft:e.pageXOffset,scrollTop:e.pageYOffset}}function ir(t){return Be(De(t)).left+or(t).scrollLeft}function sr(t){var e=Re(t),r=e.overflow,o=e.overflowX,i=e.overflowY;return/auto|scroll|overlay|hidden/.test(r+i+o)}function ar(t){return["html","body","#document"].indexOf(He(t))>=0?t.ownerDocument.body:Le(t)&&sr(t)?t:ar(Ne(t))}function nr(t,e){var r;void 0===e&&(e=[]);var o=ar(t),i=o===(null==(r=t.ownerDocument)?void 0:r.body),s=Pe(o),a=i?[s].concat(s.visualViewport||[],sr(o)?o:[]):o,n=e.concat(a);return i?n:n.concat(nr(Ne(a)))}function cr(t){return Object.assign({},t,{left:t.x,top:t.y,right:t.x+t.width,bottom:t.y+t.height})}function lr(t,e){return e===Me?cr(function(t){var e=Pe(t),r=De(t),o=e.visualViewport,i=r.clientWidth,s=r.clientHeight,a=0,n=0;return o&&(i=o.width,s=o.height,/^((?!chrome|android).)*safari/i.test(navigator.userAgent)||(a=o.offsetLeft,n=o.offsetTop)),{width:i,height:s,x:a+ir(t),y:n}}(t)):Le(e)?function(t){var e=Be(t);return e.top=e.top+t.clientTop,e.left=e.left+t.clientLeft,e.bottom=e.top+t.clientHeight,e.right=e.left+t.clientWidth,e.width=t.clientWidth,e.height=t.clientHeight,e.x=e.left,e.y=e.top,e}(e):cr(function(t){var e,r=De(t),o=or(t),i=null==(e=t.ownerDocument)?void 0:e.body,s=Ge(r.scrollWidth,r.clientWidth,i?i.scrollWidth:0,i?i.clientWidth:0),a=Ge(r.scrollHeight,r.clientHeight,i?i.scrollHeight:0,i?i.clientHeight:0),n=-o.scrollLeft+ir(t),c=-o.scrollTop;return"rtl"===Re(i||r).direction&&(n+=Ge(r.clientWidth,i?i.clientWidth:0)-s),{width:s,height:a,x:n,y:c}}(De(t)))}function ur(t,e,r){var o="clippingParents"===e?function(t){var e=nr(Ne(t)),r=["absolute","fixed"].indexOf(Re(t).position)>=0&&Le(t)?Ve(t):t;return Ie(r)?e.filter((function(t){return Ie(t)&&Oe(t,r)&&"body"!==He(t)})):[]}(t):[].concat(e),i=[].concat(o,[r]),s=i[0],a=i.reduce((function(e,r){var o=lr(t,r);return e.top=Ge(o.top,e.top),e.right=Ke(o.right,e.right),e.bottom=Ke(o.bottom,e.bottom),e.left=Ge(o.left,e.left),e}),lr(t,s));return a.width=a.right-a.left,a.height=a.bottom-a.top,a.x=a.left,a.y=a.top,a}function dr(t){return t.split("-")[1]}function pr(t){var e,r=t.reference,o=t.element,i=t.placement,s=i?Ee(i):null,a=i?dr(i):null,n=r.x+r.width/2-o.width/2,c=r.y+r.height/2-o.height/2;switch(s){case ge:e={x:n,y:r.y-o.height};break;case fe:e={x:n,y:r.y+r.height};break;case ye:e={x:r.x+r.width,y:c};break;case xe:e={x:r.x-o.width,y:c};break;default:e={x:r.x,y:r.y}}var l=s?je(s):null;if(null!=l){var u="y"===l?"height":"width";switch(a){case ze:e[l]=e[l]-(r[u]/2-o[u]/2);break;case $e:e[l]=e[l]+(r[u]/2-o[u]/2)}}return e}function mr(t,e){void 0===e&&(e={});var r=e,o=r.placement,i=void 0===o?t.placement:o,s=r.boundary,a=void 0===s?"clippingParents":s,n=r.rootBoundary,c=void 0===n?Me:n,l=r.elementContext,u=void 0===l?qe:l,d=r.altBoundary,p=void 0!==d&&d,m=r.padding,h=void 0===m?0:m,b=Xe("number"!=typeof h?h:Ye(h,we)),v=u===qe?"reference":qe,g=t.elements.reference,f=t.rects.popper,y=t.elements[p?v:u],x=ur(Ie(y)?y:y.contextElement||De(t.elements.popper),a,c),k=Be(g),w=pr({reference:k,element:f,strategy:"absolute",placement:i}),z=cr(Object.assign({},f,w)),$=u===qe?z:k,M={top:x.top-$.top+b.top,bottom:$.bottom-x.bottom+b.bottom,left:x.left-$.left+b.left,right:$.right-x.right+b.right},q=t.modifiersData.offset;if(u===qe&&q){var A=q[i];Object.keys(M).forEach((function(t){var e=[ye,fe].indexOf(t)>=0?1:-1,r=[ge,fe].indexOf(t)>=0?"y":"x";M[t]+=A[r]*e}))}return M}function hr(t,e){void 0===e&&(e={});var r=e,o=r.placement,i=r.boundary,s=r.rootBoundary,a=r.padding,n=r.flipVariations,c=r.allowedAutoPlacements,l=void 0===c?Ce:c,u=dr(o),d=u?n?Ae:Ae.filter((function(t){return dr(t)===u})):we,p=d.filter((function(t){return l.indexOf(t)>=0}));0===p.length&&(p=d);var m=p.reduce((function(e,r){return e[r]=mr(t,{placement:r,boundary:i,rootBoundary:s,padding:a})[Ee(r)],e}),{});return Object.keys(m).sort((function(t,e){return m[t]-m[e]}))}var br={name:"flip",enabled:!0,phase:"main",fn:function(t){var e=t.state,r=t.options,o=t.name;if(!e.modifiersData[o]._skip){for(var i=r.mainAxis,s=void 0===i||i,a=r.altAxis,n=void 0===a||a,c=r.fallbackPlacements,l=r.padding,u=r.boundary,d=r.rootBoundary,p=r.altBoundary,m=r.flipVariations,h=void 0===m||m,b=r.allowedAutoPlacements,v=e.options.placement,g=Ee(v),f=c||(g===v||!h?[tr(v)]:function(t){if(Ee(t)===ke)return[];var e=tr(t);return[rr(t),e,rr(e)]}(v)),y=[v].concat(f).reduce((function(t,r){return t.concat(Ee(r)===ke?hr(e,{placement:r,boundary:u,rootBoundary:d,padding:l,flipVariations:h,allowedAutoPlacements:b}):r)}),[]),x=e.rects.reference,k=e.rects.popper,w=new Map,z=!0,$=y[0],M=0;M<y.length;M++){var q=y[M],A=Ee(q),C=dr(q)===ze,S=[ge,fe].indexOf(A)>=0,E=S?"width":"height",B=mr(e,{placement:q,boundary:u,rootBoundary:d,altBoundary:p,padding:l}),T=S?C?ye:xe:C?fe:ge;x[E]>k[E]&&(T=tr(T));var P=tr(T),I=[];if(s&&I.push(B[A]<=0),n&&I.push(B[T]<=0,B[P]<=0),I.every((function(t){return t}))){$=q,z=!1;break}w.set(q,I)}if(z)for(var L=function(t){var e=y.find((function(e){var r=w.get(e);if(r)return r.slice(0,t).every((function(t){return t}))}));if(e)return $=e,"break"},_=h?3:1;_>0;_--){if("break"===L(_))break}e.placement!==$&&(e.modifiersData[o]._skip=!0,e.placement=$,e.reset=!0)}},requiresIfExists:["offset"],data:{_skip:!1}};var vr={name:"offset",enabled:!0,phase:"main",requires:["popperOffsets"],fn:function(t){var e=t.state,r=t.options,o=t.name,i=r.offset,s=void 0===i?[0,0]:i,a=Ce.reduce((function(t,r){return t[r]=function(t,e,r){var o=Ee(t),i=[xe,ge].indexOf(o)>=0?-1:1,s="function"==typeof r?r(Object.assign({},e,{placement:t})):r,a=s[0],n=s[1];return a=a||0,n=(n||0)*i,[xe,ye].indexOf(o)>=0?{x:n,y:a}:{x:a,y:n}}(r,e.rects,s),t}),{}),n=a[e.placement],c=n.x,l=n.y;null!=e.modifiersData.popperOffsets&&(e.modifiersData.popperOffsets.x+=c,e.modifiersData.popperOffsets.y+=l),e.modifiersData[o]=a}};var gr={name:"preventOverflow",enabled:!0,phase:"main",fn:function(t){var e=t.state,r=t.options,o=t.name,i=r.mainAxis,s=void 0===i||i,a=r.altAxis,n=void 0!==a&&a,c=r.boundary,l=r.rootBoundary,u=r.altBoundary,d=r.padding,p=r.tether,m=void 0===p||p,h=r.tetherOffset,b=void 0===h?0:h,v=mr(e,{boundary:c,rootBoundary:l,padding:d,altBoundary:u}),g=Ee(e.placement),f=dr(e.placement),y=!f,x=je(g),k="x"===x?"y":"x",w=e.modifiersData.popperOffsets,z=e.rects.reference,$=e.rects.popper,M="function"==typeof b?b(Object.assign({},e.rects,{placement:e.placement})):b,q={x:0,y:0};if(w){if(s||n){var A="y"===x?ge:xe,C="y"===x?fe:ye,S="y"===x?"height":"width",E=w[x],B=w[x]+v[A],T=w[x]-v[C],P=m?-$[S]/2:0,I=f===ze?z[S]:$[S],L=f===ze?-$[S]:-z[S],_=e.elements.arrow,O=m&&_?Te(_):{width:0,height:0},H=e.modifiersData["arrow#persistent"]?e.modifiersData["arrow#persistent"].padding:{top:0,right:0,bottom:0,left:0},R=H[A],F=H[C],D=We(0,z[S],O[S]),N=y?z[S]/2-P-D-R-M:I-D-R-M,U=y?-z[S]/2+P+D+F+M:L+D+F+M,V=e.elements.arrow&&Ve(e.elements.arrow),j=V?"y"===x?V.clientTop||0:V.clientLeft||0:0,G=e.modifiersData.offset?e.modifiersData.offset[e.placement][x]:0,K=w[x]+N-G-j,Z=w[x]+U-G;if(s){var W=We(m?Ke(B,K):B,E,m?Ge(T,Z):T);w[x]=W,q[x]=W-E}if(n){var X="x"===x?ge:xe,Y="x"===x?fe:ye,J=w[k],Q=J+v[X],tt=J-v[Y],et=We(m?Ke(Q,K):Q,J,m?Ge(tt,Z):tt);w[k]=et,q[k]=et-J}}e.modifiersData[o]=q}},requiresIfExists:["offset"]};function fr(t,e,r){void 0===r&&(r=!1);var o,i=De(e),s=Be(t),a=Le(e),n={scrollLeft:0,scrollTop:0},c={x:0,y:0};return(a||!a&&!r)&&(("body"!==He(e)||sr(i))&&(n=(o=e)!==Pe(o)&&Le(o)?function(t){return{scrollLeft:t.scrollLeft,scrollTop:t.scrollTop}}(o):or(o)),Le(e)?((c=Be(e)).x+=e.clientLeft,c.y+=e.clientTop):i&&(c.x=ir(i))),{x:s.left+n.scrollLeft-c.x,y:s.top+n.scrollTop-c.y,width:s.width,height:s.height}}function yr(t){var e=new Map,r=new Set,o=[];function i(t){r.add(t.name),[].concat(t.requires||[],t.requiresIfExists||[]).forEach((function(t){if(!r.has(t)){var o=e.get(t);o&&i(o)}})),o.push(t)}return t.forEach((function(t){e.set(t.name,t)})),t.forEach((function(t){r.has(t.name)||i(t)})),o}var xr={placement:"bottom",modifiers:[],strategy:"absolute"};function kr(){for(var t=arguments.length,e=new Array(t),r=0;r<t;r++)e[r]=arguments[r];return!e.some((function(t){return!(t&&"function"==typeof t.getBoundingClientRect)}))}var wr={passive:!0};var zr={top:"auto",right:"auto",bottom:"auto",left:"auto"};function $r(t){var e,r=t.popper,o=t.popperRect,i=t.placement,s=t.offsets,a=t.position,n=t.gpuAcceleration,c=t.adaptive,l=t.roundOffsets,u=!0===l?function(t){var e=t.x,r=t.y,o=window.devicePixelRatio||1;return{x:Ze(Ze(e*o)/o)||0,y:Ze(Ze(r*o)/o)||0}}(s):"function"==typeof l?l(s):s,d=u.x,p=void 0===d?0:d,m=u.y,h=void 0===m?0:m,b=s.hasOwnProperty("x"),v=s.hasOwnProperty("y"),g=xe,f=ge,y=window;if(c){var x=Ve(r),k="clientHeight",w="clientWidth";x===Pe(r)&&"static"!==Re(x=De(r)).position&&(k="scrollHeight",w="scrollWidth"),x=x,i===ge&&(f=fe,h-=x[k]-o.height,h*=n?1:-1),i===xe&&(g=ye,p-=x[w]-o.width,p*=n?1:-1)}var z,$=Object.assign({position:a},c&&zr);return n?Object.assign({},$,((z={})[f]=v?"0":"",z[g]=b?"0":"",z.transform=(y.devicePixelRatio||1)<2?"translate("+p+"px, "+h+"px)":"translate3d("+p+"px, "+h+"px, 0)",z)):Object.assign({},$,((e={})[f]=v?h+"px":"",e[g]=b?p+"px":"",e.transform="",e))}var Mr=[{name:"eventListeners",enabled:!0,phase:"write",fn:function(){},effect:function(t){var e=t.state,r=t.instance,o=t.options,i=o.scroll,s=void 0===i||i,a=o.resize,n=void 0===a||a,c=Pe(e.elements.popper),l=[].concat(e.scrollParents.reference,e.scrollParents.popper);return s&&l.forEach((function(t){t.addEventListener("scroll",r.update,wr)})),n&&c.addEventListener("resize",r.update,wr),function(){s&&l.forEach((function(t){t.removeEventListener("scroll",r.update,wr)})),n&&c.removeEventListener("resize",r.update,wr)}},data:{}},{name:"popperOffsets",enabled:!0,phase:"read",fn:function(t){var e=t.state,r=t.name;e.modifiersData[r]=pr({reference:e.rects.reference,element:e.rects.popper,strategy:"absolute",placement:e.placement})},data:{}},{name:"computeStyles",enabled:!0,phase:"beforeWrite",fn:function(t){var e=t.state,r=t.options,o=r.gpuAcceleration,i=void 0===o||o,s=r.adaptive,a=void 0===s||s,n=r.roundOffsets,c=void 0===n||n,l={placement:Ee(e.placement),popper:e.elements.popper,popperRect:e.rects.popper,gpuAcceleration:i};null!=e.modifiersData.popperOffsets&&(e.styles.popper=Object.assign({},e.styles.popper,$r(Object.assign({},l,{offsets:e.modifiersData.popperOffsets,position:e.options.strategy,adaptive:a,roundOffsets:c})))),null!=e.modifiersData.arrow&&(e.styles.arrow=Object.assign({},e.styles.arrow,$r(Object.assign({},l,{offsets:e.modifiersData.arrow,position:"absolute",adaptive:!1,roundOffsets:c})))),e.attributes.popper=Object.assign({},e.attributes.popper,{"data-popper-placement":e.placement})},data:{}},{name:"applyStyles",enabled:!0,phase:"write",fn:function(t){var e=t.state;Object.keys(e.elements).forEach((function(t){var r=e.styles[t]||{},o=e.attributes[t]||{},i=e.elements[t];Le(i)&&He(i)&&(Object.assign(i.style,r),Object.keys(o).forEach((function(t){var e=o[t];!1===e?i.removeAttribute(t):i.setAttribute(t,!0===e?"":e)})))}))},effect:function(t){var e=t.state,r={popper:{position:e.options.strategy,left:"0",top:"0",margin:"0"},arrow:{position:"absolute"},reference:{}};return Object.assign(e.elements.popper.style,r.popper),e.styles=r,e.elements.arrow&&Object.assign(e.elements.arrow.style,r.arrow),function(){Object.keys(e.elements).forEach((function(t){var o=e.elements[t],i=e.attributes[t]||{},s=Object.keys(e.styles.hasOwnProperty(t)?e.styles[t]:r[t]).reduce((function(t,e){return t[e]="",t}),{});Le(o)&&He(o)&&(Object.assign(o.style,s),Object.keys(i).forEach((function(t){o.removeAttribute(t)})))}))}},requires:["computeStyles"]}],qr="top",Ar="bottom",Cr="right",Sr="left",Er=[qr,Ar,Cr,Sr],Br="viewport",Tr="popper";function Pr(t){return t?(t.nodeName||"").toLowerCase():null}function Ir(t){if(null==t)return window;if("[object Window]"!==t.toString()){var e=t.ownerDocument;return e&&e.defaultView||window}return t}function Lr(t){return t instanceof Ir(t).Element||t instanceof Element}function _r(t){return t instanceof Ir(t).HTMLElement||t instanceof HTMLElement}function Or(t){return"undefined"!=typeof ShadowRoot&&(t instanceof Ir(t).ShadowRoot||t instanceof ShadowRoot)}function Hr(t){var e=t.getBoundingClientRect();return{width:e.width,height:e.height,top:e.top,right:e.right,bottom:e.bottom,left:e.left,x:e.left,y:e.top}}function Rr(t){return Ir(t).getComputedStyle(t)}function Fr(t){return["table","td","th"].indexOf(Pr(t))>=0}function Dr(t){return((Lr(t)?t.ownerDocument:t.document)||window.document).documentElement}function Nr(t){return"html"===Pr(t)?t:t.assignedSlot||t.parentNode||(Or(t)?t.host:null)||Dr(t)}function Ur(t){return _r(t)&&"fixed"!==Rr(t).position?t.offsetParent:null}function Vr(t){for(var e=Ir(t),r=Ur(t);r&&Fr(r)&&"static"===Rr(r).position;)r=Ur(r);return r&&("html"===Pr(r)||"body"===Pr(r)&&"static"===Rr(r).position)?e:r||function(t){var e=-1!==navigator.userAgent.toLowerCase().indexOf("firefox");if(-1!==navigator.userAgent.indexOf("Trident")&&_r(t)&&"fixed"===Rr(t).position)return null;for(var r=Nr(t);_r(r)&&["html","body"].indexOf(Pr(r))<0;){var o=Rr(r);if("none"!==o.transform||"none"!==o.perspective||"paint"===o.contain||-1!==["transform","perspective"].indexOf(o.willChange)||e&&"filter"===o.willChange||e&&o.filter&&"none"!==o.filter)return r;r=r.parentNode}return null}(t)||e}var jr=Math.max,Gr=Math.min;function Kr(t){var e=Ir(t);return{scrollLeft:e.pageXOffset,scrollTop:e.pageYOffset}}function Zr(t){return Hr(Dr(t)).left+Kr(t).scrollLeft}function Wr(t){var e=Rr(t),r=e.overflow,o=e.overflowX,i=e.overflowY;return/auto|scroll|overlay|hidden/.test(r+i+o)}function Xr(t){return["html","body","#document"].indexOf(Pr(t))>=0?t.ownerDocument.body:_r(t)&&Wr(t)?t:Xr(Nr(t))}function Yr(t,e){var r;void 0===e&&(e=[]);var o=Xr(t),i=o===(null==(r=t.ownerDocument)?void 0:r.body),s=Ir(o),a=i?[s].concat(s.visualViewport||[],Wr(o)?o:[]):o,n=e.concat(a);return i?n:n.concat(Yr(Nr(a)))}function Jr(t){return Object.assign({},t,{left:t.x,top:t.y,right:t.x+t.width,bottom:t.y+t.height})}function Qr(t,e){return e===Br?Jr(function(t){var e=Ir(t),r=Dr(t),o=e.visualViewport,i=r.clientWidth,s=r.clientHeight,a=0,n=0;return o&&(i=o.width,s=o.height,/^((?!chrome|android).)*safari/i.test(navigator.userAgent)||(a=o.offsetLeft,n=o.offsetTop)),{width:i,height:s,x:a+Zr(t),y:n}}(t)):_r(e)?function(t){var e=Hr(t);return e.top=e.top+t.clientTop,e.left=e.left+t.clientLeft,e.bottom=e.top+t.clientHeight,e.right=e.left+t.clientWidth,e.width=t.clientWidth,e.height=t.clientHeight,e.x=e.left,e.y=e.top,e}(e):Jr(function(t){var e,r=Dr(t),o=Kr(t),i=null==(e=t.ownerDocument)?void 0:e.body,s=jr(r.scrollWidth,r.clientWidth,i?i.scrollWidth:0,i?i.clientWidth:0),a=jr(r.scrollHeight,r.clientHeight,i?i.scrollHeight:0,i?i.clientHeight:0),n=-o.scrollLeft+Zr(t),c=-o.scrollTop;return"rtl"===Rr(i||r).direction&&(n+=jr(r.clientWidth,i?i.clientWidth:0)-s),{width:s,height:a,x:n,y:c}}(Dr(t)))}function to(t){var e=Yr(Nr(t)),r=["absolute","fixed"].indexOf(Rr(t).position)>=0&&_r(t)?Vr(t):t;return Lr(r)?e.filter((function(t){return Lr(t)&&function(t,e){var r=e.getRootNode&&e.getRootNode();if(t.contains(e))return!0;if(r&&Or(r)){var o=e;do{if(o&&t.isSameNode(o))return!0;o=o.parentNode||o.host}while(o)}return!1}(t,r)&&"body"!==Pr(t)})):[]}function eo(t,e){void 0===e&&(e={});var r,o=e,i=o.placement,s=void 0===i?t.placement:i,a=o.boundary,n=void 0===a?"clippingParents":a,c=o.rootBoundary,l=void 0===c?Br:c,u=o.elementContext,d=void 0===u?Tr:u,p=o.altBoundary,m=void 0!==p&&p,h=o.padding,b=void 0===h?0:h,v=function(t){return Object.assign({},{top:0,right:0,bottom:0,left:0},t)}("number"!=typeof b?b:(r=b,Er.reduce((function(t,e){return t[e]=r,t}),{}))),g=d===Tr?"reference":Tr,f=t.elements.reference,y=t.rects.popper,x=t.elements[m?g:d],k=function(t,e,r){var o="clippingParents"===e?to(t):[].concat(e),i=[].concat(o,[r]),s=i[0],a=i.reduce((function(e,r){var o=Qr(t,r);return e.top=jr(o.top,e.top),e.right=Gr(o.right,e.right),e.bottom=Gr(o.bottom,e.bottom),e.left=jr(o.left,e.left),e}),Qr(t,s));return a.width=a.right-a.left,a.height=a.bottom-a.top,a.x=a.left,a.y=a.top,a}(Lr(x)?x:x.contextElement||Dr(t.elements.popper),n,l),w=Hr(f),z=function(t){var e,r=t.reference,o=t.element,i=t.placement,s=i?function(t){return t.split("-")[0]}(i):null,a=i?function(t){return t.split("-")[1]}(i):null,n=r.x+r.width/2-o.width/2,c=r.y+r.height/2-o.height/2;switch(s){case qr:e={x:n,y:r.y-o.height};break;case Ar:e={x:n,y:r.y+r.height};break;case Cr:e={x:r.x+r.width,y:c};break;case Sr:e={x:r.x-o.width,y:c};break;default:e={x:r.x,y:r.y}}var l=s?function(t){return["top","bottom"].indexOf(t)>=0?"x":"y"}(s):null;if(null!=l){var u="y"===l?"height":"width";switch(a){case"start":e[l]=e[l]-(r[u]/2-o[u]/2);break;case"end":e[l]=e[l]+(r[u]/2-o[u]/2)}}return e}({reference:w,element:y,strategy:"absolute",placement:s}),$=Jr(Object.assign({},y,z)),M=d===Tr?$:w,q={top:k.top-M.top+v.top,bottom:M.bottom-k.bottom+v.bottom,left:k.left-M.left+v.left,right:M.right-k.right+v.right},A=t.modifiersData.offset;if(d===Tr&&A){var C=A[s];Object.keys(q).forEach((function(t){var e=[Cr,Ar].indexOf(t)>=0?1:-1,r=[qr,Ar].indexOf(t)>=0?"y":"x";q[t]+=C[r]*e}))}return q}var ro={name:"maxSize",enabled:!0,phase:"main",requiresIfExists:["offset","preventOverflow","flip"],fn:function(t){var e=t.state,r=t.name,o=eo(e,t.options),i=e.modifiersData.preventOverflow||{x:0,y:0},s=i.x,a=i.y,n=e.rects.popper,c=n.width,l=n.height,u=e.placement.split("-")[0],d="left"===u?"left":"right",p="top"===u?"top":"bottom";e.modifiersData[r]={width:c-o[d]-s,height:l-o[p]-a}}};const oo=new WeakMap,io={name:"applyMaxSize",enabled:!0,phase:"beforeWrite",requires:["maxSize"],fn({state:t}){const{height:e}=t.modifiersData.maxSize;oo.has(t.elements.popper)||oo.set(t.elements.popper,t.rects.popper.height);const r=e<oo.get(t.elements.popper)?`${e}px`:"";t.styles.popper.maxHeight=r,t.styles.popper.height=r}},so=function(t){void 0===t&&(t={});var e=t,r=e.defaultModifiers,o=void 0===r?[]:r,i=e.defaultOptions,s=void 0===i?xr:i;return function(t,e,r){void 0===r&&(r=s);var i,a,n={placement:"bottom",orderedModifiers:[],options:Object.assign({},xr,s),modifiersData:{},elements:{reference:t,popper:e},attributes:{},styles:{}},c=[],l=!1,u={state:n,setOptions:function(r){d(),n.options=Object.assign({},s,n.options,r),n.scrollParents={reference:Ie(t)?nr(t):t.contextElement?nr(t.contextElement):[],popper:nr(e)};var i,a,l=function(t){var e=yr(t);return Se.reduce((function(t,r){return t.concat(e.filter((function(t){return t.phase===r})))}),[])}((i=[].concat(o,n.options.modifiers),a=i.reduce((function(t,e){var r=t[e.name];return t[e.name]=r?Object.assign({},r,e,{options:Object.assign({},r.options,e.options),data:Object.assign({},r.data,e.data)}):e,t}),{}),Object.keys(a).map((function(t){return a[t]}))));return n.orderedModifiers=l.filter((function(t){return t.enabled})),n.orderedModifiers.forEach((function(t){var e=t.name,r=t.options,o=void 0===r?{}:r,i=t.effect;if("function"==typeof i){var s=i({state:n,name:e,instance:u,options:o}),a=function(){};c.push(s||a)}})),u.update()},forceUpdate:function(){if(!l){var t=n.elements,e=t.reference,r=t.popper;if(kr(e,r)){n.rects={reference:fr(e,Ve(r),"fixed"===n.options.strategy),popper:Te(r)},n.reset=!1,n.placement=n.options.placement,n.orderedModifiers.forEach((function(t){return n.modifiersData[t.name]=Object.assign({},t.data)}));for(var o=0;o<n.orderedModifiers.length;o++)if(!0!==n.reset){var i=n.orderedModifiers[o],s=i.fn,a=i.options,c=void 0===a?{}:a,d=i.name;"function"==typeof s&&(n=s({state:n,options:c,name:d,instance:u})||n)}else n.reset=!1,o=-1}}},update:(i=function(){return new Promise((function(t){u.forceUpdate(),t(n)}))},function(){return a||(a=new Promise((function(t){Promise.resolve().then((function(){a=void 0,t(i())}))}))),a}),destroy:function(){d(),l=!0}};if(!kr(t,e))return u;function d(){c.forEach((function(t){return t()})),c=[]}return u.setOptions(r).then((function(t){!l&&r.onFirstUpdate&&r.onFirstUpdate(t)})),u}}({defaultModifiers:[...Mr,br,gr,Je,vr]}),ao={initial:"idle",states:{idle:{on:{active:"active"}},active:{on:{visible:"visible",hiding:"hiding",idle:"idle"}},visible:{on:{hiding:"hiding",idle:"idle"}},hiding:{on:{dispose:"dispose"}},dispose:{on:{disposed:"disposed"}},disposed:{on:{}}}},no=(t,e)=>t?e&&ao.states[t].on[e]||t:ao.initial;class co extends ht{constructor(){super(),this._state=no(),this.animating=!1,this.theme={},this.tabbingAway=!1,this.offset=6,this.interaction="hover",this.positionAnimationFrame=0,this.willNotifyClosed=!1,this.handleInlineTriggerKeydown=t=>{const{code:e,shiftKey:r}=t;if("Tab"===e){if(r)return this.tabbingAway=!0,void this.dispatchEvent(new Event("close"));t.stopPropagation(),t.preventDefault(),this.focus()}},this.stealOverlayContentPromise=Promise.resolve(),this.stealOverlayContentPromise=new Promise((t=>this.stealOverlayContentResolver=t))}get state(){return this._state}set state(t){const e=no(this.state,t);e!==this.state&&(this._state=e,"active"===this.state||"visible"===this.state||"hiding"===this.state?this.setAttribute("state",this.state):this.removeAttribute("state"))}focus(){const t=this.querySelector('button, [href], input, select, textarea, [tabindex]:not([tabindex="-1"]), [focusable]');t?t.focus():super.focus(),this.removeAttribute("tabindex")}get hasTheme(){return!!this.theme.color||!!this.theme.scale||!!this.theme.lang}static get styles(){return[ve]}get hasModalRoot(){return!!this._modalRoot}feature(){this.tabIndex=-1;const t=this.trigger.closest("active-overlay"),e=t&&"open"===t.slot;("modal"===this.interaction||e||this._modalRoot)&&(this.slot="open",this._modalRoot&&(null==t||t.feature()))}obscure(t){if(this.slot&&"modal"===t){if(this.removeAttribute("slot"),"modal"!==this.interaction){const e=this.trigger.closest("active-overlay");return this._modalRoot=null==e?void 0:e.obscure(t),this._modalRoot}return this}}firstUpdated(t){super.firstUpdated(t),this.overlayContent&&(this.stealOverlayContent(this.overlayContent),this.overlayContent&&this.trigger&&(this.placement&&"none"!==this.placement&&(this.popper=so(this.virtualTrigger||this.trigger,this,{placement:this.placement,modifiers:[ro,io,{name:"arrow",options:{element:this.overlayContentTip}},{name:"offset",options:{offset:[0,this.offset]}}]})),this.state="active",document.addEventListener("sp-update-overlays",(()=>{this.updateOverlayPosition(),this.state="visible"})),this.feature(),this.updateOverlayPosition().then((()=>this.applyContentAnimation("spOverlayFadeIn"))).then((()=>{this.receivesFocus&&this.focus(),this.trigger.dispatchEvent(new CustomEvent("sp-opened",{bubbles:!0,composed:!0,cancelable:!0,detail:{interaction:this.interaction}}))}))))}updateOverlayPopperPlacement(){this.overlayContent&&(this.dataPopperPlacement?this.overlayContent.setAttribute("placement",this.dataPopperPlacement):this.originalPlacement?this.overlayContent.setAttribute("placement",this.originalPlacement):this.overlayContent.removeAttribute("placement"))}updated(t){t.has("dataPopperPlacement")&&this.updateOverlayPopperPlacement()}open(t){this.extractDetail(t)}extractDetail(t){this.overlayContent=t.content,this.overlayContentTip=t.contentTip,this.trigger=t.trigger,this.virtualTrigger=t.virtualTrigger,this.placement=t.placement,this.offset=t.offset,this.interaction=t.interaction,this.theme=t.theme,this.receivesFocus=t.receivesFocus}dispose(){"dispose"===this.state&&(this.timeout&&(clearTimeout(this.timeout),delete this.timeout),this.popper&&(this.popper.destroy(),this.popper=void 0),this.trigger.removeEventListener("keydown",this.handleInlineTriggerKeydown),this.returnOverlayContent(),this.state="disposed",this.willNotifyClosed&&(this.overlayContent.dispatchEvent(new Event("sp-overlay-closed")),this.willNotifyClosed=!1))}stealOverlayContent(t){this.originalPlacement=t.getAttribute("placement"),this.restoreContent=Ot([t],this,(t=>{const e=t.slot;return t.removeAttribute("slot"),t=>{t.slot=e}})),this.stealOverlayContentResolver()}returnOverlayContent(){if(!this.restoreContent)return;const[t]=this.restoreContent();this.restoreContent=void 0,this.willNotifyClosed=!0,this.originalPlacement&&(t.setAttribute("placement",this.originalPlacement),delete this.originalPlacement)}async updateOverlayPosition(){await(document.fonts?document.fonts.ready:Promise.resolve()),this.popper&&await this.popper.update()}async hide(t=!0){this.state="hiding",t&&await this.applyContentAnimation("spOverlayFadeOut"),this.state="dispose"}schedulePositionUpdate(){cancelAnimationFrame(this.positionAnimationFrame),this.positionAnimationFrame=requestAnimationFrame((()=>this.updateOverlayPosition()))}onSlotChange(){this.schedulePositionUpdate()}connectedCallback(){super.connectedCallback(),this.schedulePositionUpdate()}applyContentAnimation(t){return new Promise((e=>{const r=this.shadowRoot.querySelector("#contents"),o=i=>{t===i.animationName&&(r.removeEventListener("animationend",o),r.removeEventListener("animationcancel",o),this.animating=!1,e("animationcancel"===i.type))};r.addEventListener("animationend",o),r.addEventListener("animationcancel",o),r.style.animationName=t,this.animating=!0}))}renderTheme(t){const{color:e,scale:r,lang:o}=this.theme;return D`
            <sp-theme
                color=${gt(e)}
                scale=${gt(r)}
                lang=${gt(o)}
        ...
        `;return this.hasTheme?this.renderTheme(t):t}static create(t){const e=new co;return t.content&&e.open(t),e}async _getUpdateComplete(){await super._getUpdateComplete(),await this.stealOverlayContentPromise}}e([tt()],co.prototype,"_state",void 0),e([tt({reflect:!0,type:Boolean})],co.prototype,"animating",void 0),e([tt({reflect:!0})],co.prototype,"placement",void 0),e([tt({attribute:!1})],co.prototype,"theme",void 0),e([tt({attribute:!1})],co.prototype,"receivesFocus",void 0),e([tt({attribute:"data-popper-placement"})],co.prototype,"dataPopperPlacement",void 0);class lo{constructor(t={}){this.warmUpDelay=1e3,this.coolDownDelay=1e3,this.isWarm=!1,this.timeout=0,Object.assign(this,t)}async openTimer(t){if(this.cancelCooldownTimer(),this.component&&t===this.component){if(this.promise)return this.promise;throw new Error("Inconsistent state")}return this.component&&(this.close(this.component),this.cancelCooldownTimer()),this.component=t,!this.isWarm&&(this.promise=new Promise((t=>{this.resolve=t,this.timeout=window.setTimeout((()=>{this.resolve&&(this.resolve(!1),this.isWarm=!0)}),this.warmUpDelay)})),this.promise)}close(t){this.component&&this.component===t&&(this.resetCooldownTimer(),this.timeout>0&&(clearTimeout(this.timeout),this.timeout=0),this.resolve&&(this.resolve(!0),delete this.resolve),delete this.promise,delete this.component)}resetCooldownTimer(){this.isWarm&&(this.cooldownTimeout&&window.clearTimeout(this.cooldownTimeout),this.cooldownTimeout=window.setTimeout((()=>{this.isWarm=!1,delete this.cooldownTimeout}),this.coolDownDelay))}cancelCooldownTimer(){this.cooldownTimeout&&window.clearTimeout(this.cooldownTimeout),delete this.cooldownTimeout}}customElements.define("active-overlay",co);class uo{constructor(t,e,r){this.isOpen=!1,this.owner=t,this.overlayElement=r,this.interaction=e}static async open(t,e,r,o){const i=new uo(t,e,r);return await i.open(o),()=>{i.close()}}static update(){const t=new CustomEvent("sp-update-overlays",{bubbles:!0,composed:!0,cancelable:!0});document.dispatchEvent(t)}async open({abortPromise:t,delayed:e,offset:r=0,placement:o="top",receivesFocus:i,notImmediatelyClosable:s,virtualTrigger:a}){if(this.isOpen)return!0;void 0===e&&(e=this.overlayElement.hasAttribute("delayed"));const n={color:void 0,scale:void 0,lang:void 0},c=new CustomEvent("sp-query-theme",{bubbles:!0,composed:!0,detail:n,cancelable:!0});this.owner.dispatchEvent(c);const l={},u=new CustomEvent("sp-overlay-query",{bubbles:!0,composed:!0,detail:l,cancelable:!0});return this.overlayElement.dispatchEvent(u),await uo.overlayStack.openOverlay(Object.assign({abortPromise:t,content:this.overlayElement,contentTip:l.overlayContentTipElement,delayed:e,offset:r,placement:o,trigger:this.owner,interaction:this.interaction,theme:n,receivesFocus:i,notImmediatelyClosable:s,virtualTrigger:a},l)),this.isOpen=!0,!0}close(){uo.overlayStack.closeOverlay(this.overlayElement)}}uo.overlayStack=new class{constructor(){this.overlays=[],this.preventMouseRootClose=!1,this.root=document.body,this.handlingResize=!1,this.overlayTimer=new lo,this.canTabTrap=!0,this.trappingInited=!1,this.handleMouseCapture=t=>{const e=this.topOverlay;if(t.target&&e&&e.overlayContent&&!function(t){return!!(t.metaKey||t.altKey||t.ctrlKey||t.shiftKey)}(t)&&function(t){return 0===t.button}(t)){if(t.target instanceof Node){if(t.composedPath().indexOf(e.overlayContent)>=0)return void(this.preventMouseRootClose=!0);this.preventMouseRootClose=!1}}else this.preventMouseRootClose=!0},this._doesNotCloseOnFirstClick=!1,this.handleMouse=t=>{this._doesNotCloseOnFirstClick?this._doesNotCloseOnFirstClick=!1:this.preventMouseRootClose||t.defaultPrevented||this.closeTopOverlay()},this.handleKeyUp=t=>{if("Escape"===t.code){const t=this.topOverlay;this.closeTopOverlay(),t&&t.trigger.focus()}},this.handleResize=()=>{this.handlingResize||(this.handlingResize=!0,requestAnimationFrame((async()=>{const t=this.overlays.map((t=>t.updateOverlayPosition()));await Promise.all(t),this.handlingResize=!1})))},this.addEventListeners()}initTabTrapping(){if(this.document.body.shadowRoot)return void(this.canTabTrap=!1);if(this.document.body.attachShadow({mode:"open"}),!this.document.body.shadowRoot)return;const t=this.document.body.shadowRoot;t.innerHTML='\n            <div id="actual"><slot></slot></div>\n            <style>\n            #actual {\n                position: relative;\n                height: calc(100% - var(--swc-body-margins-block, 0px));\n                z-index: 0;\n                min-height: calc(100vh - var(--swc-body-margins-block, 0px));\n            }\n            #holder {\n                display: flex;\n                align-items: center;\n                justify-content: center;\n                flex-flow: column;\n                height: 100%;\n                width: 100%;\n                top: 0;\n                left: 0;\n                position: fixed;\n            }\n            #holder[hidden] {\n                display: none !important;\n            }\n            #actual[tabindex="-1"] {\n                pointer-events: none;  /* just in case? */\n            }\n            </style>\n            <div id="holder" hidden><slot name="open"></slot></div>\n        ',this.tabTrapper=t.querySelector("#actual"),this.overlayHolder=t.querySelector("#holder"),this.tabTrapper.attachShadow({mode:"open"}),this.tabTrapper.shadowRoot&&(this.tabTrapper.shadowRoot.innerHTML="<slot></slot>")}startTabTrapping(){this.trappingInited||(this.initTabTrapping(),this.trappingInited=!0),this.canTabTrap&&(this.tabTrapper.tabIndex=-1,this.tabTrapper.setAttribute("aria-hidden","true"),this.overlayHolder.hidden=!1,requestAnimationFrame((()=>{const t=getComputedStyle(document.body);this.tabTrapper.style.setProperty("--swc-body-margins-inline",`calc(${t.marginLeft} + ${t.marginRight})`),this.tabTrapper.style.setProperty("--swc-body-margins-block",`calc(${t.marginTop} + ${t.marginBottom})`)})))}stopTabTrapping(){this.canTabTrap&&this.trappingInited&&(this.tabTrapper.removeAttribute("tabindex"),this.tabTrapper.removeAttribute("aria-hidden"),this.overlayHolder.hidden=!0)}get document(){return this.root.ownerDocument||document}get topOverlay(){return this.overlays.slice(-1)[0]}findOverlayForContent(t){for(const e of this.overlays)if(t===e.overlayContent)return e}addEventListeners(){this.document.addEventListener("click",this.handleMouseCapture,!0),this.document.addEventListener("click",this.handleMouse),this.document.addEventListener("keyup",this.handleKeyUp),window.addEventListener("resize",this.handleResize)}isClickOverlayActiveForTrigger(t){return this.overlays.some((e=>t===e.trigger&&"click"===e.interaction))}async openOverlay(t){if(this.findOverlayForContent(t.content))return!1;t.notImmediatelyClosable&&(this._doesNotCloseOnFirstClick=!0),"modal"===t.interaction&&this.startTabTrapping();const e=t.content;if(e.overlayWillOpenCallback){const{trigger:r}=t;e.overlayWillOpenCallback({trigger:r})}if(t.delayed){const r=[this.overlayTimer.openTimer(t.content)];t.abortPromise&&r.push(t.abortPromise);const o=await Promise.race(r);if(o){if(e.overlayOpenCancelledCallback){const{trigger:r}=t;e.overlayOpenCancelledCallback({trigger:r})}return o}}if("click"===t.interaction)this.closeAllHoverOverlays();else if("hover"===t.interaction&&this.isClickOverlayActiveForTrigger(t.trigger))return!0;const r=co.create(t);if(this.overlays.length){this.overlays[this.overlays.length-1].obscure(r.interaction)}return document.body.appendChild(r),new Promise((t=>requestAnimationFrame(t))).then((async()=>{if(this.overlays.push(r),await r.updateComplete,this.addOverlayEventListeners(r),void 0!==e.open&&(e.open=!0),e.overlayOpenCallback){const{trigger:t}=r;e.overlayOpenCallback({trigger:t})}return"auto"===t.receivesFocus&&r.focus(),!1}))}addOverlayEventListeners(t){switch(t.addEventListener("close",(()=>{this.hideAndCloseOverlay(t)})),t.interaction){case"replace":this.addReplaceOverlayEventListeners(t);break;case"inline":this.addInlineOverlayEventListeners(t)}}addReplaceOverlayEventListeners(t){t.addEventListener("keydown",(e=>{const{code:r}=e;"Tab"===r&&(e.stopPropagation(),this.closeOverlay(t.overlayContent),t.tabbingAway=!0,t.trigger.focus(),t.trigger.dispatchEvent(new KeyboardEvent("keydown",e)))}))}addInlineOverlayEventListeners(t){t.trigger.addEventListener("keydown",t.handleInlineTriggerKeydown),t.addEventListener("keydown",(e=>{const{code:r,shiftKey:o}=e;if("Tab"!==r)return;if(t.tabbingAway=!0,o){const e=document.createElement("span");return e.tabIndex=-1,t.trigger.hasAttribute("slot")&&(e.slot=t.trigger.slot),t.trigger.insertAdjacentElement("afterend",e),e.focus(),void e.remove()}e.stopPropagation();const i=t.trigger;void 0!==i.open&&(i.open=!1),this.closeOverlay(t.overlayContent),t.trigger.focus()}))}closeOverlay(t){this.overlayTimer.close(t),requestAnimationFrame((()=>{const e=this.findOverlayForContent(t);this.hideAndCloseOverlay(e)}))}closeAllHoverOverlays(){for(const t of this.overlays)"hover"===t.interaction&&this.hideAndCloseOverlay(t,!1)}async hideAndCloseOverlay(t,e){if(t){await t.hide(e);const r=t.overlayContent;if(void 0!==r.open&&(r.open=!1),r.overlayCloseCallback){const{trigger:e}=t;r.overlayCloseCallback({trigger:e})}if("dispose"!=t.state)return;const o=this.overlays.indexOf(t);if(o>=0&&this.overlays.splice(o,1),this.overlays.length){const t=this.overlays[this.overlays.length-1];t.feature(),"modal"===t.interaction||t.hasModalRoot?t.focus():this.stopTabTrapping()}else{if(this.stopTabTrapping(),"modal"===t.interaction||("replace"===t.interaction||"inline"===t.interaction)&&!t.tabbingAway){const e=t.overlayContent.getRootNode().activeElement,r=t.trigger.getRootNode(),o=r.activeElement;(t.overlayContent.contains(e)||t.trigger.getRootNode().contains(o)||r.host&&r.host===o)&&t.trigger.focus()}t.tabbingAway=!1}t.remove(),t.dispose(),t.trigger.dispatchEvent(new CustomEvent("sp-closed",{bubbles:!0,composed:!0,cancelable:!0,detail:{interaction:t.interaction}}))}}closeTopOverlay(){return this.hideAndCloseOverlay(this.topOverlay)}};var po=Object.freeze({__proto__:null,Overlay:uo});const mo=async(t,e,r,o)=>{const{Overlay:i}=await Promise.resolve().then((function(){return po}));return await i.open(t,e,r,o)},ho=ut`
#trigger{display:contents}:host([disabled]) #trigger{pointer-events:none}#overlay-content{display:none}
`;class bo extends pt{constructor(){super(...arguments),this.placement="bottom",this.offset=6,this.disabled=!1,this.hoverOverlayReady=Promise.resolve(),this.abortOverlay=()=>{}}static get styles(){return[ho]}handleClose(t){(null==t?void 0:t.detail.interaction)!==this.open&&(null==t?void 0:t.detail.interaction)!==this.type||this.removeAttribute("open")}render(){return D`
            <div
                id="trigger"
        ...
        `}updated(t){super.updated(t),this.disabled&&this.closeClickOverlay&&t.has("disabled")&&this.closeClickOverlay(),t.has("open")&&this.manageOpen(t.get("open"))}manageOpen(t){switch(this.open){case"click":this.closeClickOverlay||this.onTriggerClick();break;case"hover":this.closeHoverOverlay||this.onTriggerMouseEnter();break;case"longpress":this.closeLongpressOverlay||(this.onTriggerLongpress(),this.onTriggerMouseLeave());break;default:switch(t){case"click":this.closeClickOverlay&&(this.closeClickOverlay(),delete this.closeClickOverlay);break;case"longpress":this.closeLongpressOverlay&&(this.closeLongpressOverlay(),delete this.closeLongpressOverlay);break;case"hover":this.onTriggerMouseLeave()}}}get overlayOptions(){return{offset:this.offset,placement:this.placement,receivesFocus:this.type&&"inline"!==this.type?"auto":void 0}}onTrigger(t){if(!this.disabled)switch(t.type){case"mouseenter":case"focusin":return void(!this.open&&this.hoverContent&&(this.open="hover"));case"mouseleave":case"focusout":return void("hover"===this.open&&this.handleClose());case"click":return void(this.clickContent?this.open=t.type:this.closeHoverOverlay&&t.preventDefault());case"longpress":return void(this.longpressContent&&(this._longpressEvent=t,this.open=t.type))}}prepareToFocusOverlayContent(t){if("modal"!==this.type)return;t.querySelector('button, [href], input, select, textarea, [tabindex]:not([tabindex="-1"]), [focusable]')||(t.tabIndex=0)}async onTriggerClick(){if(!this.targetContent||!this.clickContent)return;const{targetContent:t,clickContent:e}=this;this.prepareToFocusOverlayContent(e),this.closeClickOverlay=await bo.openOverlay(t,this.type?this.type:"click",e,this.overlayOptions)}async onTriggerLongpress(){var t,e;if(!this.targetContent||!this.longpressContent)return;const{targetContent:r,longpressContent:o}=this;this.prepareToFocusOverlayContent(o);const i="keyboard"!==(null===(e=null===(t=this._longpressEvent)||void 0===t?void 0:t.detail)||void 0===e?void 0:e.source);this.closeLongpressOverlay=await bo.openOverlay(r,this.type?this.type:"longpress",o,Object.assign(Object.assign({},this.overlayOptions),{receivesFocus:"auto",notImmediatelyClosable:i})),this._longpressEvent=void 0}async onTriggerMouseEnter(){if(!this.targetContent||!this.hoverContent)return;let t=()=>{};this.hoverOverlayReady=new Promise((e=>{t=e}));const e=new Promise((t=>{this.abortOverlay=t})),{targetContent:r,hoverContent:o}=this;this.closeHoverOverlay=await bo.openOverlay(r,"hover",o,Object.assign({abortPromise:e},this.overlayOptions)),t()}async onTriggerMouseLeave(){this.abortOverlay&&this.abortOverlay(!0),await this.hoverOverlayReady,this.closeHoverOverlay&&(this.closeHoverOverlay(),delete this.closeHoverOverlay)}onClickSlotChange(t){this.clickContent=this.extractSlotContentFromEvent(t),this.manageOpen()}onLongpressSlotChange(t){this.longpressContent=this.extractSlotContentFromEvent(t),this.manageOpen()}onHoverSlotChange(t){this.hoverContent=this.extractSlotContentFromEvent(t),this.manageOpen()}onTargetSlotChange(t){this.targetContent=this.extractSlotContentFromEvent(t)}extractSlotContentFromEvent(t){return t.target.assignedNodes({flatten:!0}).find((t=>t instanceof HTMLElement))}disconnectedCallback(){this.closeClickOverlay&&(this.closeClickOverlay(),delete this.closeClickOverlay),this.closeHoverOverlay&&(this.closeHoverOverlay(),delete this.closeClickOverlay),super.disconnectedCallback()}}bo.openOverlay=async(t,e,r,o)=>await mo(t,e,r,o),e([tt({reflect:!0})],bo.prototype,"placement",void 0),e([tt()],bo.prototype,"type",void 0),e([tt({type:Number,reflect:!0})],bo.prototype,"offset",void 0),e([tt({reflect:!0})],bo.prototype,"open",void 0),e([tt({type:Boolean,reflect:!0})],bo.prototype,"disabled",void 0);const vo={s:"spectrum-UIIcon-ChevronDown75",m:"spectrum-UIIcon-ChevronDown100",l:"spectrum-UIIcon-ChevronDown200",xl:"spectrum-UIIcon-ChevronDown300"};class go extends(bt(Ct)){constructor(){super(),this.disabled=!1,this.focused=!1,this.iconsOnly=!1,this.invalid=!1,this.open=!1,this.readonly=!1,this.menuItems=[],this.placement="bottom-start",this.quiet=!1,this.value="",this.listRole="listbox",this.itemRole="option",this.onKeydown=t=>{"ArrowDown"!==t.code&&"ArrowUp"!==t.code||(t.preventDefault(),this.toggle(!0))},this.menuStatePromise=Promise.resolve(),this.onKeydown=this.onKeydown.bind(this),this.addEventListener("sp-menu-item-query-role",(t=>{t.stopPropagation(),t.detail.role=this.itemRole})),this.addEventListener("sp-menu-query-role",(t=>{t.stopPropagation(),t.detail.role=this.listRole}))}get target(){return this.button}get focusElement(){return this.open?this.optionsMenu:this.button}forceFocusVisible(){this.focused=!0}onButtonBlur(){this.focused=!1,this.target.removeEventListener("keydown",this.onKeydown)}onButtonClick(){this.toggle()}onButtonFocus(){this.target.addEventListener("keydown",this.onKeydown)}onClick(t){const e=t.target;e&&!e.disabled?e.value&&this.setValueFromItem(e):e&&this.focus()}async setValueFromItem(t){const e=this.selectedItem,r=this.value;this.selectedItem=t,this.value=t.value,this.open=!1,await this.updateComplete;if(!this.dispatchEvent(new Event("change",{cancelable:!0})))return this.selectedItem=e,this.value=r,void(this.open=!0);e&&(e.selected=!1),t.selected=!0}toggle(t){this.readonly||(this.open=void 0!==t?t:!this.open)}close(){this.readonly||(this.open=!1)}onOverlayClosed(){this.close(),this.restoreChildren&&(this.restoreChildren(),this.restoreChildren=void 0),this.menuStateResolver()}async openMenu(){let t=[];const e=this.querySelector("sp-menu");if(t=e?Array.from(e.children):Array.from(this.children).filter((t=>!t.hasAttribute("slot"))),0===t.length)return void this.menuStateResolver();this.restoreChildren=Ot(t,this.optionsMenu,(()=>t=>{void 0!==t.focused&&(t.focused=!1)})),this.optionsMenu.selectable=!0,this.sizePopover(this.popover);const{popover:r}=this;this.closeOverlay=await fo.openOverlay(this,"inline",r,{placement:this.placement,receivesFocus:"auto"}),this.manageSelection(),this.menuStateResolver()}sizePopover(t){const e=!this.quiet&&`${this.offsetWidth}px`;e&&t.style.setProperty("min-width",e)}closeMenu(){this.closeOverlay&&(this.closeOverlay(),delete this.closeOverlay)}get selectedItemContent(){return!this._selectedItemContent&&this.selectedItem&&(this._selectedItemContent=this.selectedItem.itemChildren),this._selectedItemContent||{icon:[],content:[]}}renderLabelContent(t){return this.value&&this.selectedItem?t:D`
            <slot name="label">${this.label}</slot>
        `}get buttonContent(){const t={"visually-hidden":this.iconsOnly&&!!this.value,placeholder:!this.value};return[D`
                <span id="icon">${this.selectedItemContent.icon}</span>
                <span id="label" class=${xt(t)}>
                ...
                ${this.invalid?D`
                      ...
                      `:x}
                <sp-icon-chevron100
                    class="picker ${vo[this.size]}"
                ></sp-icon-chevron100>
            `]}get renderButton(){return D`
            <button
                aria-haspopup="true"
        ...
        `}update(t){t.has("selectedItem")&&(this._selectedItemContent=void 0),super.update(t)}render(){return D`
            ${this.renderButton} ${this.renderPopover}
        `}get renderPopover(){return D`
            <sp-popover
                open
                id="popover"
                @click=${this.onClick}
        ...
        `}updateMenuItems(){this.menuItems=[...this.querySelectorAll("sp-menu-item")]}firstUpdated(t){super.firstUpdated(t),this.optionsMenu=this.shadowRoot.querySelector("sp-menu"),this.updateMenuItems();this.querySelector("sp-menu")&&console.warn(`Deprecation Notice: You no longer need to provide an sp-menu child to ${this.tagName.toLowerCase()}. Any styling or attributes on the sp-menu will be ignored.`)}updated(t){super.updated(t),t.has("value")&&!t.has("selectedItem")&&this.manageSelection(),t.has("disabled")&&this.disabled&&(this.open=!1),t.has("open")&&(this.open||void 0!==t.get("open"))&&(this.menuStatePromise=new Promise((t=>this.menuStateResolver=t)),this.open?this.openMenu():this.closeMenu())}manageSelection(){if(this.open||this.updateMenuItems(),this.menuItems.length>0){let t;return this.menuItems.forEach((e=>{this.value!==e.value||e.disabled?e.selected=!1:t=e})),t?(t.selected=!0,this.selectedItem=t):(this.value="",this.selectedItem=void 0),void(this.open&&this.optionsMenu.updateSelectedItemIndex())}}async _getUpdateComplete(){await super._getUpdateComplete(),await this.menuStatePromise}connectedCallback(){this.open||this.updateMenuItems(),super.connectedCallback()}disconnectedCallback(){this.open=!1,super.disconnectedCallback()}}go.openOverlay=async(t,e,r,o)=>await mo(t,e,r,o),e([et("#button")],go.prototype,"button",void 0),e([tt({type:Boolean,reflect:!0})],go.prototype,"disabled",void 0),e([tt({type:Boolean,reflect:!0})],go.prototype,"focused",void 0),e([tt({type:Boolean,reflect:!0,attribute:"icons-only"})],go.prototype,"iconsOnly",void 0),e([tt({type:Boolean,reflect:!0})],go.prototype,"invalid",void 0),e([tt()],go.prototype,"label",void 0),e([tt({type:Boolean,reflect:!0})],go.prototype,"open",void 0),e([tt({type:Boolean,reflect:!0})],go.prototype,"readonly",void 0),e([tt()],go.prototype,"placement",void 0),e([tt({type:Boolean,reflect:!0})],go.prototype,"quiet",void 0),e([tt({type:String})],go.prototype,"value",void 0),e([tt({attribute:!1})],go.prototype,"selectedItem",void 0),e([et("sp-popover")],go.prototype,"popover",void 0);class fo extends go{constructor(){super(...arguments),this.onKeydown=t=>{const{code:e}=t;if(!e.startsWith("Arrow")||this.readonly)return;if(t.preventDefault(),"ArrowUp"===e||"ArrowDown"===e)return void this.toggle(!0);const r=this.selectedItem?this.menuItems.indexOf(this.selectedItem):-1,o=this.value&&"ArrowRight"!==e?-1:1;let i=r+o;for(;this.menuItems[i]&&this.menuItems[i].disabled;)i+=o;this.menuItems[i]&&!this.menuItems[i].disabled&&(this.value&&i===r||this.setValueFromItem(this.menuItems[i]))}}static get styles(){return[ne,ce]}}customElements.define("sp-icon-more",class extends jt{render(){return de(D),(({width:t=24,height:e=24,hidden:r=!1,title:o="More"}={})=>ue`<svg
    xmlns="http://www.w3.org/2000/svg"
    width="${t}"
    height="${e}"
    viewBox="0 0 36 36"
  ...
  </svg>`)({hidden:!this.label,title:this.label})}});const yo=ut`
:host{display:inline-flex}:host([quiet]){min-width:0}::slotted([slot=icon]){flex-shrink:0}.icon{flex-shrink:0}#popover{width:auto;max-width:none;display:none}:host([dir=ltr]) .icon,:host([dir=ltr]) ::slotted([slot=icon]){margin-left:calc(-1*(var(--spectrum-actionbutton-textonly-padding-left-adjusted) - var(--spectrum-actionbutton-padding-left-adjusted)))}:host([dir=rtl]) .icon,:host([dir=rtl]) ::slotted([slot=icon]){margin-right:calc(-1*(var(--spectrum-actionbutton-textonly-padding-left-adjusted) - var(--spectrum-actionbutton-padding-left-adjusted)))}:host([dir]) slot[icon-only] .icon,:host([dir]) slot[icon-only]::slotted([slot=icon]){margin-left:calc(-1*(var(--spectrum-actionbutton-textonly-padding-left-adjusted) - var(--spectrum-actionbutton-icononly-padding-left-adjusted)));margin-right:calc(-1*(var(--spectrum-actionbutton-textonly-padding-right-adjusted) - var(--spectrum-actionbutton-icononly-padding-right-adjusted)))}
`;class xo extends(_t(go,"label")){constructor(){super(...arguments),this.listRole="menu",this.itemRole="menuitem"}static get styles(){return[yo]}get hasLabel(){return this.slotHasContent}get buttonContent(){return[D`
            ...
            <sp-action-button
                ...
                aria-expanded=${this.open?"true":"false"}
                aria-label=${gt(this.label||void 0)}
                id="button"
                class="button"
                size=${this.size}
                @blur=${this.onButtonBlur}
        ...
        `}updated(t){super.updated(t),t.has("invalid")&&(this.invalid=!1),this.quiet=!0}}customElements.define("sp-action-menu",xo),customElements.define("sp-button",Nt),customElements.define("sp-clear-button",Jt);const ko=ut`
...
`;class wo extends ht{constructor(){super(...arguments),this.vertical=!1}static get styles(){return[ko]}render(){return D`
            <slot></slot>
        `}}e([tt({type:Boolean,reflect:!0})],wo.prototype,"vertical",void 0),customElements.define("sp-button-group",wo);class zo extends Ct{constructor(){super(...arguments),this.checked=!1,this.readonly=!1}get focusElement(){return this.inputElement}handleChange(t){if(this.readonly)return void(this.inputElement.checked=this.checked);this.checked=this.inputElement.checked;const e=new CustomEvent("change",{detail:{sourceEvent:t},bubbles:t.bubbles,cancelable:t.cancelable});this.dispatchEvent(e)}render(){return D`
            <input
                id="input"
            ...
            />
        `}}e([tt({type:Boolean,reflect:!0})],zo.prototype,"checked",void 0),e([tt({type:Boolean,reflect:!0})],zo.prototype,"readonly",void 0),e([et("#input")],zo.prototype,"inputElement",void 0);customElements.define("sp-icon-checkmark75",class extends jt{render(){return Xt(D),Wt`<svg
    xmlns="http://www.w3.org/2000/svg"
    viewBox="0 0 10 10"
    aria-hidden="true"
    fill="currentColor"
  >
    ...
    />
  </svg>`}});customElements.define("sp-icon-checkmark100",class extends jt{render(){return Xt(D),Wt`<svg
    xmlns="http://www.w3.org/2000/svg"
    viewBox="0 0 10 10"
    aria-hidden="true"
    fill="currentColor"
  >
    ...
    />
  </svg>`}});customElements.define("sp-icon-checkmark200",class extends jt{render(){return Xt(D),Wt`<svg
    xmlns="http://www.w3.org/2000/svg"
    viewBox="0 0 12 12"
    aria-hidden="true"
    fill="currentColor"
  >
    ...
    />
  </svg>`}});customElements.define("sp-icon-checkmark300",class extends jt{render(){return Xt(D),Wt`<svg
    xmlns="http://www.w3.org/2000/svg"
    viewBox="0 0 14 14"
    aria-hidden="true"
    fill="currentColor"
  >
    ...
    />
  </svg>`}});customElements.define("sp-icon-dash75",class extends jt{render(){return Xt(D),Wt`<svg
    xmlns="http://www.w3.org/2000/svg"
    viewBox="0 0 8 8"
    aria-hidden="true"
    fill="currentColor"
  ...
  </svg>`}});customElements.define("sp-icon-dash100",class extends jt{render(){return Xt(D),Wt`<svg
    xmlns="http://www.w3.org/2000/svg"
    viewBox="0 0 10 10"
    aria-hidden="true"
    fill="currentColor"
  ...
  </svg>`}});customElements.define("sp-icon-dash200",class extends jt{render(){return Xt(D),Wt`<svg
    xmlns="http://www.w3.org/2000/svg"
    viewBox="0 0 12 12"
    aria-hidden="true"
    fill="currentColor"
  ...
  </svg>`}});customElements.define("sp-icon-dash300",class extends jt{render(){return Xt(D),Wt`<svg
    xmlns="http://www.w3.org/2000/svg"
    viewBox="0 0 12 12"
    aria-hidden="true"
    fill="currentColor"
...
`,Ao={s:D`
    ...
    `,xl:D`
        ...
        ></sp-icon-dash300>
    `};class So extends(bt(zo)){constructor(){super(...arguments),this.indeterminate=!1,this.invalid=!1,this.emphasized=!1}static get styles(){return[$o,Mo,qo]}render(){return D`
            ${super.render()}
            <span id="box">
                ${Ao[this.size]}
                ${Co[this.size]}
        ...
        `}updated(t){super.updated(t),t.has("invalid")&&(this.invalid?this.inputElement.setAttribute("aria-invalid","true"):this.inputElement.removeAttribute("aria-invalid")),t.has("indeterminate")&&(this.indeterminate?this.inputElement.setAttribute("aria-checked","mixed"):this.inputElement.removeAttribute("aria-checked"))}}e([tt({type:Boolean,reflect:!0})],So.prototype,"indeterminate",void 0),e([tt({type:Boolean,reflect:!0})],So.prototype,"invalid",void 0),e([tt({type:Boolean,reflect:!0})],So.prototype,"emphasized",void 0),customElements.define("sp-checkbox",So);const Eo=ut`
...
`;class Bo extends(bt(ht,{validSizes:["s","m","l"]})){constructor(){super(...arguments),this.vertical=!1}render(){return D``}firstUpdated(t){super.firstUpdated(t),this.setAttribute("role","separator")}updated(t){super.updated(t),t.has("vertical")&&(this.vertical?this.setAttribute("aria-orientation","vertical"):this.removeAttribute("aria-orientation"))}}Bo.styles=[Eo],e([tt({type:Boolean,reflect:!0})],Bo.prototype,"vertical",void 0),customElements.define("sp-divider",Bo);customElements.define("sp-icon-cross500",class extends jt{render(){return Xt(D),Wt`<svg
    xmlns="http://www.w3.org/2000/svg"
    viewBox="0 0 14 14"
    aria-hidden="true"
    fill="currentColor"
...
`;class Po extends(At(Tt(ht,['[slot="hero"]','[slot="footer"]','[slot="button"]']))){constructor(){super(...arguments),this.error=!1,this.dismissable=!1,this.noDivider=!1,this.shouldManageTabOrderForScrolling=()=>{const{offsetHeight:t,scrollHeight:e}=this.contentElement;t<e?this.contentElement.tabIndex=0:this.contentElement.removeAttribute("tabindex")}}static get styles(){return[To,Yt]}get hasFooter(){return this.getSlotContentPresence('[slot="footer"]')}get hasButtons(){return this.getSlotContentPresence('[slot="button"]')}get hasHero(){return this.getSlotContentPresence('[slot="hero"]')}focus(){if(this.shadowRoot){const t=this.shadowRoot.querySelector('button, [href], input, select, textarea, [tabindex]:not([tabindex="-1"]), [focusable]');t&&(t.updateComplete?t.updateComplete.then((()=>t.focus())):t.focus(),this.removeAttribute("tabindex"))}else super.focus()}close(){this.dispatchEvent(new Event("close",{bubbles:!0}))}render(){return D`
            <div class="grid">
                ...
                ${this.hasButtons?D`
                          <sp-button-group
                              class="buttonGroup ${this.hasFooter?"":"buttonGroup--noFooter"}"
                          >
        ...
        `}shouldUpdate(t){return t.has("mode")&&this.mode&&(this.dismissable=!1),t.has("dismissable")&&this.dismissable&&(this.dismissable=!this.mode),super.shouldUpdate(t)}onContentSlotChange(){this.shouldManageTabOrderForScrolling()}connectedCallback(){super.connectedCallback(),window.addEventListener("resize",this.shouldManageTabOrderForScrolling)}disconnectedCallback(){window.removeEventListener("resize",this.shouldManageTabOrderForScrolling),super.disconnectedCallback()}}e([et(".content")],Po.prototype,"contentElement",void 0),e([tt({type:Boolean,reflect:!0})],Po.prototype,"error",void 0),e([tt({type:Boolean,reflect:!0})],Po.prototype,"dismissable",void 0),e([tt({type:Boolean,reflect:!0,attribute:"no-divider"})],Po.prototype,"noDivider",void 0),e([tt({type:String,reflect:!0})],Po.prototype,"mode",void 0),e([tt({type:String,reflect:!0})],Po.prototype,"size",void 0),customElements.define("sp-dialog",Po);const Io=ut`
...
`;class Lo extends ht{constructor(){super(...arguments),this.open=!1}static get styles(){return[Io]}render(){return D``}}e([tt({type:Boolean})],Lo.prototype,"open",void 0),customElements.define("sp-underlay",Lo);const _o=ut`
...
`;class Oo extends(At(ht)){constructor(){super(...arguments),this.error=!1,this.cancelLabel="",this.confirmLabel="",this.dismissable=!1,this.footer="",this.hero="",this.heroLabel="",this.noDivider=!1,this.open=!1,this.secondaryLabel="",this.headline="",this.responsive=!1,this.underlay=!1}static get styles(){return[_o]}focus(){if(this.shadowRoot){const t=this.shadowRoot.querySelector('button, [href], input, select, textarea, [tabindex]:not([tabindex="-1"]), [focusable]');t?(t.updateComplete?t.updateComplete.then((()=>t.focus())):t.focus(),this.removeAttribute("tabindex")):this.dialog.focus()}else super.focus()}dismiss(){this.dismissable&&this.close()}clickSecondary(){this.dispatchEvent(new Event("secondary",{bubbles:!0}))}clickCancel(){this.dispatchEvent(new Event("cancel",{bubbles:!0}))}clickConfirm(){this.dispatchEvent(new Event("confirm",{bubbles:!0}))}close(){this.open=!1,this.dispatchEvent(new Event("close",{bubbles:!0}))}render(){return D`
            ${this.underlay?D`
                      <sp-underlay
                          ?open=${this.open}
                          @click=${this.dismiss}
            ...
            <div class="modal ${this.mode}">
                <sp-dialog
                    ...
                    ?error=${this.error}
                    mode=${gt(this.mode?this.mode:void 0)}
                    size=${gt(this.size?this.size:void 0)}
                    @close=${this.close}
                >
                    ${this.hero?D`
                              <img
                                  src="${this.hero}"
                                  slot="hero"
                                  aria-hidden=${gt(this.heroLabel?void 0:"true")}
                                  alt=${gt(this.heroLabel?this.heroLabel:void 0)}
                              />
                          `:D``}
                    ${this.headline?D`
        ...
        `}updated(t){t.has("open")&&this.open&&this.dialog.updateComplete.then((()=>{this.dialog.shouldManageTabOrderForScrolling()}))}}e([tt({type:Boolean,reflect:!0})],Oo.prototype,"error",void 0),e([tt({attribute:"cancel-label"})],Oo.prototype,"cancelLabel",void 0),e([tt({attribute:"confirm-label"})],Oo.prototype,"confirmLabel",void 0),e([tt({type:Boolean,reflect:!0})],Oo.prototype,"dismissable",void 0),e([tt()],Oo.prototype,"footer",void 0),e([tt()],Oo.prototype,"hero",void 0),e([tt({attribute:"hero-label"})],Oo.prototype,"heroLabel",void 0),e([tt({type:Boolean,reflect:!0,attribute:"no-divider"})],Oo.prototype,"noDivider",void 0),e([tt({type:Boolean,reflect:!0})],Oo.prototype,"open",void 0),e([tt({type:String,reflect:!0})],Oo.prototype,"mode",void 0),e([tt({type:String,reflect:!0})],Oo.prototype,"size",void 0),e([tt({attribute:"secondary-label"})],Oo.prototype,"secondaryLabel",void 0),e([tt()],Oo.prototype,"headline",void 0),e([tt({type:Boolean})],Oo.prototype,"responsive",void 0),e([tt({type:Boolean})],Oo.prototype,"underlay",void 0),e([et("sp-dialog")],Oo.prototype,"dialog",void 0),customElements.define("sp-dialog-wrapper",Oo);const Ho=ut`
...
`;class Ro extends ht{constructor(){super(...arguments),this.horizontal=!1,this.vertical=!1}static get styles(){return[Ho]}render(){return D`
            <slot></slot>
        `}}e([tt({type:Boolean,reflect:!0})],Ro.prototype,"horizontal",void 0),e([tt({type:Boolean,reflect:!0})],Ro.prototype,"vertical",void 0),customElements.define("sp-field-group",Ro);customElements.define("sp-icon-asterisk100",class extends jt{render(){return Xt(D),Wt`<svg
    xmlns="http://www.w3.org/2000/svg"
    viewBox="0 0 8 8"
    aria-hidden="true"
    fill="currentColor"
...
`;class No extends(bt(ht)){constructor(){super(...arguments),this.disabled=!1,this.id="",this.for="",this.required=!1}static get styles(){return[Do,Fo]}handleClick(){if(!this.target||this.disabled)return;this.target.focus();const t=this.getRootNode(),e=this.target,r=e.getRootNode(),o=r.host;r===t&&e.forceFocusVisible?e.forceFocusVisible():o&&o.forceFocusVisible&&o.forceFocusVisible()}async manageFor(){if(!this.for)return;const t=this.getRootNode(),e=t.querySelector(`#${this.for}`);if(e){if(void 0!==e.updateComplete&&await e.updateComplete,this.target=e.focusElement||e,this.target){this.target.getRootNode()===t?this.target.setAttribute("aria-labelledby",this.id):this.target.setAttribute("aria-label",(this.textContent||"").trim())}return Promise.resolve()}}render(){return D`
        ...
        `}firstUpdated(t){super.firstUpdated(t),this.hasAttribute("id")||this.setAttribute("id",`${this.tagName.toLowerCase()}-${No.instanceCount++}`),this.addEventListener("click",this.handleClick)}updated(t){super.updated(t),(t.has("for")||t.has("id"))&&this.manageFor()}}No.instanceCount=0,e([tt({type:Boolean,reflect:!0})],No.prototype,"disabled",void 0),e([tt({type:String})],No.prototype,"id",void 0),e([tt({type:String})],No.prototype,"for",void 0),e([tt({type:Boolean,reflect:!0})],No.prototype,"required",void 0),e([tt({type:String,reflect:!0,attribute:"side-aligned"})],No.prototype,"sideAligned",void 0),customElements.define("sp-field-label",No),customElements.define("sp-icon",Kt);class Uo extends pt{constructor(){super(...arguments),this.registered=!1,this.handleRemoved=({detail:t})=>{t.name===this.name&&(this.registered=!1,this.addIconset())}}firstUpdated(){this.style.display="none"}set name(t){this.registered&&(this._name&&Gt.getInstance().removeIconset(this._name),t&&Gt.getInstance().addIconset(t,this)),this._name=t}get name(){return this._name}connectedCallback(){super.connectedCallback(),this.addIconset(),window.addEventListener("sp-iconset-removed",this.handleRemoved)}disconnectedCallback(){super.disconnectedCallback(),window.removeEventListener("sp-iconset-removed",this.handleRemoved),this.removeIconset()}addIconset(){this.name&&!this.registered&&(Gt.getInstance().addIconset(this.name,this),this.registered=!0)}removeIconset(){this.name&&(Gt.getInstance().removeIconset(this.name),this.registered=!1)}}e([tt()],Uo.prototype,"name",null);class Vo extends Uo{constructor(){super(...arguments),this.iconMap=new Map}updated(t){if(!this.slotContainer)return;const e=this.getSVGNodes(this.slotContainer);this.updateSVG(e),super.updated(t)}async applyIconToElement(t,e,r,o){await this.updateComplete;const i=this.iconMap.get(e);if(!i)throw new Error(`Unable to find icon ${e}`);const s=this.prepareSvgClone(i);s.setAttribute("role","img"),o?s.setAttribute("aria-label",o):s.setAttribute("aria-hidden","true"),t.shadowRoot?t.shadowRoot.appendChild(s):t.appendChild(s)}getIconList(){return[...this.iconMap.keys()]}prepareSvgClone(t){const e=t.cloneNode(!0),r=document.createElementNS("http://www.w3.org/2000/svg","svg"),o=e.getAttribute("viewBox")||"";for(r.style.cssText="pointer-events: none; display: block; width: 100%; height: 100%;",r.setAttribute("viewBox",o),r.setAttribute("preserveAspectRatio","xMidYMid meet"),r.setAttribute("focusable","false");e.childNodes.length>0;)r.appendChild(e.childNodes[0]);return r}getSVGIconName(t){return t}getSanitizedIconName(t){return t}renderDefaultContent(){return D``}render(){return D`
            <slot @slotchange=${this.onSlotChange}>
                ${this.renderDefaultContent()}
            </slot>
        `}updateSVG(t){t.reduce(((t,e)=>{const r=e.querySelectorAll("symbol");return t.push(...r),t}),[]).forEach((t=>{this.iconMap.set(this.getSanitizedIconName(t.id),t)}))}getSVGNodes(t){return t.assignedNodes({flatten:!0}).filter((t=>"svg"===t.nodeName))}onSlotChange(t){const e=t.target,r=this.getSVGNodes(e);this.updateSVG(r)}}e([et("slot")],Vo.prototype,"slotContainer",void 0);var jo=((t,...e)=>new M(t,e,"svg",F)
/**
     * @license
     * Copyright (c) 2017 The Polymer Project Authors. All rights reserved.
     * This code may only be used under the BSD style license found at
...
`;class Xo extends ht{constructor(){super(),this.instanceCount=Xo.instances,Xo.instances+=1}static get styles(){return[Wo]}render(){const t=`menu-heading-category-${this.instanceCount}`;return D`
            <span class="header" id=${t} aria-hidden="true">
                <slot name="header"></slot>
            </span>
            <sp-menu role="presentation">
                <slot></slot>
            </sp-menu>
        `}firstUpdated(){this.setAttribute("role","none")}}Xo.instances=0,customElements.define("sp-menu-group",Xo);const Yo=ut`
...
`;class Jo extends oe{constructor(){super(...arguments),this.focused=!1,this.noWrap=!1}static get styles(){return[Yo,Mo]}get itemChildren(){const t=this.shadowRoot.querySelector('slot[name="icon"]'),e=t?t.assignedElements().map((t=>{const e=t.cloneNode(!0);return e.removeAttribute("slot"),e.classList.toggle("icon"),e})):[],r=this.shadowRoot.querySelector("slot:not([name])");return{icon:e,content:r?r.assignedNodes().map((t=>t.cloneNode(!0))):[]}}get buttonContent(){const t=super.buttonContent;return t.push(D`
                <slot name="value"></slot>
            `),this.selected&&t.push(D`
                <sp-icon-checkmark100
                    id="selected"
                    class="spectrum-UIIcon-Checkmark100 icon"
                ></sp-icon-checkmark100>
            `),t}renderButton(){return D`
            ${this.buttonContent}
        `}firstUpdated(t){this.setAttribute("tabindex","-1"),super.firstUpdated(t),this.hasAttribute("id")||(this.id="sp-menu-item-"+Jo.instanceCount++)}updated(t){super.updated(t),"option"===this.getAttribute("role")&&t.has("selected")&&this.setAttribute("aria-selected",this.selected?"true":"false")}connectedCallback(){if(super.connectedCallback(),!this.hasAttribute("role")){const t=new CustomEvent("sp-menu-item-query-role",{bubbles:!0,composed:!0,detail:{role:""}});this.dispatchEvent(t),this.setAttribute("role",t.detail.role||"menuitem")}}}Jo.instanceCount=0,e([tt({type:Boolean,reflect:!0})],Jo.prototype,"focused",void 0),e([tt({type:Boolean,reflect:!0,attribute:"no-wrap",hasChanged:()=>!1})],Jo.prototype,"noWrap",void 0),customElements.define("sp-menu-item",Jo);const Qo=new WeakMap,ti=new WeakMap,ei=(t,e,r)=>{Array.isArray(e)?e.map((e=>{t.addEventListener(e,r)})):t.addEventListener(e,r)},ri=(t,e,r)=>{Array.isArray(e)?e.map((e=>{t.removeEventListener(e,r)})):t.removeEventListener(e,r)},oi=(t,e,r,o)=>{const{element:i,eventContext:s}=t,a=ti.get(t);let n=!1;const c=t=>{n||(n=!0,r.fn.call(s||i,t),requestAnimationFrame((()=>{n=!1})))},l=a=>{ei(i,e.type,u),ri(i,r.type,c),ri(i,o.type,l),ti.set(t,!1),o.fn.call(s||i,a)},u=a=>{e.fn.call(s||i,a),a.defaultPrevented||(ri(i,e.type,u),ei(i,r.type,c),ei(i,o.type,l),ti.set(t,!0))};return a?(ei(i,r.type,c),ei(i,o.type,l)):ei(i,e.type,u),()=>{ri(i,e.type,u),ri(i,r.type,c),ri(i,o.type,l)}},ii=g(((t,e,r)=>o=>{if(o instanceof L){if(Qo.has(o)){const i=Qo.get(o);if(t.type===i.start.type&&e.type===i.stream.type&&r.type===i.end.type&&t.fn===i.start.fn&&e.fn===i.stream.fn&&r.fn===i.end.fn)return;i.removeEventListeners()}else ti.set(o,!1);Qo.set(o,{start:t,stream:e,end:r,removeEventListeners:oi(o,t,e,r)})}}));function si(){return(si=Object.assign||function(t){for(var e=1;e<arguments.length;e++){var r=arguments[e];for(var o in r)Object.prototype.hasOwnProperty.call(r,o)&&(t[o]=r[o])}return t}).apply(this,arguments)}let ai=new Map,ni=!1;try{ni="exceptZero"===new Intl.NumberFormat("de-DE",{signDisplay:"exceptZero"}).resolvedOptions().signDisplay}catch(t){}let ci=!1;try{ci="unit"===new Intl.NumberFormat("de-DE",{style:"unit",unit:"degree"}).resolvedOptions().style}catch(t){}const li={degree:{narrow:{default:"°","ja-JP":" 度","zh-TW":"度","sl-SI":" °"}}};class ui{constructor(t,e){void 0===e&&(e={}),this.numberFormatter=void 0,this.options=void 0,this.numberFormatter=function(t,e){void 0===e&&(e={});let{numberingSystem:r}=e;r&&-1===t.indexOf("-u-nu-")&&(t=t+"-u-nu-"+r);if("unit"===e.style&&!ci){var o;let{unit:t,unitDisplay:r="short"}=e;if(!t)throw new Error('unit option must be provided with style: "unit"');if(null==(o=li[t])||!o[r])throw new Error("Unsupported unit "+t+" with unitDisplay = "+r);e=si({},e,{style:"decimal"})}let i=t+(e?Object.entries(e).sort(((t,e)=>t[0]<e[0]?-1:1)).join():"");if(ai.has(i))return ai.get(i);let s=new Intl.NumberFormat(t,e);return ai.set(i,s),s}(t,e),this.options=e}format(t){let e="";if(e=ni||null==this.options.signDisplay?this.numberFormatter.format(t):function(t,e,r){if("auto"===e)return t.format(r);if("never"===e)return t.format(Math.abs(r));{let o=!1;if("always"===e?o=r>0||Object.is(r,0):"exceptZero"===e&&(Object.is(r,-0)||Object.is(r,0)?r=Math.abs(r):o=r>0),o){let e=t.format(-r),o=t.format(r),i=e.replace(o,"").replace(/\u200e|\u061C/,"");return 1!==[...i].length&&console.warn("@react-aria/i18n polyfill for NumberFormat signDisplay: Unsupported case"),e.replace(o,"!!!").replace(i,"+").replace("!!!",o)}return t.format(r)}}(this.numberFormatter,this.options.signDisplay,t),"unit"===this.options.style&&!ci){var r;let{unit:t,unitDisplay:o="short",locale:i}=this.resolvedOptions(),s=null==(r=li[t])?void 0:r[o];e+=s[i]||s.default}return e}formatToParts(t){return this.numberFormatter.formatToParts(t)}resolvedOptions(){let t=this.numberFormatter.resolvedOptions();return ni||null==this.options.signDisplay||(t=si({},t,{signDisplay:this.options.signDisplay})),ci||"unit"!==this.options.style||(t=si({},t,{style:"unit",unit:this.options.unit,unitDisplay:this.options.unitDisplay})),t}}const di=new RegExp("^.*\\(.*\\).*$"),pi=["latn","arab","hanidec"];class mi{constructor(t,e){void 0===e&&(e={}),this.locale=void 0,this.options=void 0,this.locale=t,this.options=e}parse(t){return bi(this.locale,this.options,t).parse(t)}isValidPartialNumber(t,e,r){return bi(this.locale,this.options,t).isValidPartialNumber(t,e,r)}getNumberingSystem(t){return bi(this.locale,this.options,t).options.numberingSystem}}const hi=new Map;function bi(t,e,r){let o=vi(t,e);if(!t.includes("-u-nu-")&&!o.isValidPartialNumber(r))for(let i of pi)if(i!==o.options.numberingSystem){let o=vi(t+"-u-nu-"+i,e);if(o.isValidPartialNumber(r))return o}return o}function vi(t,e){let r=t+(e?Object.entries(e).sort(((t,e)=>t[0]<e[0]?-1:1)).join():""),o=hi.get(r);return o||(o=new gi(t,e),hi.set(r,o)),o}class gi{constructor(t,e){void 0===e&&(e={}),this.formatter=void 0,this.options=void 0,this.symbols=void 0,this.formatter=new Intl.NumberFormat(t,e),this.options=this.formatter.resolvedOptions(),this.symbols=function(t,e,r){var o,i,s,a,n;let c=t.formatToParts(-10000.1),l=t.formatToParts(10000.1),u=t.formatToParts(1),d=null!=(o=null==(i=c.find((t=>"minusSign"===t.type)))?void 0:i.value)?o:"-",p=null==(s=l.find((t=>"plusSign"===t.type)))?void 0:s.value;p||"exceptZero"!==(null==r?void 0:r.signDisplay)&&"always"!==(null==r?void 0:r.signDisplay)||(p="+");let m=null==(a=c.find((t=>"decimal"===t.type)))?void 0:a.value,h=null==(n=c.find((t=>"group"===t.type)))?void 0:n.value,b=c.filter((t=>!fi.has(t.type))).map((t=>xi(t.value))),v=u.filter((t=>!fi.has(t.type))).map((t=>xi(t.value))),g=[...new Set([...v,...b])].sort(((t,e)=>e.length-t.length)),f=new RegExp(g.join("|")+"|[\\p{White_Space}]","gu"),y=[...new Intl.NumberFormat(e.locale,{useGrouping:!1}).format(9876543210)].reverse(),x=new Map(y.map(((t,e)=>[t,e]))),k=new RegExp("["+y.join("")+"]","g");return{minusSign:d,plusSign:p,decimal:m,group:h,literals:f,numeral:k,index:t=>String(x.get(t))}}(this.formatter,this.options,e)}parse(t){let e=this.sanitize(t);e=yi(e,this.symbols.group,"").replace(this.symbols.decimal,".").replace(this.symbols.minusSign,"-").replace(this.symbols.numeral,this.symbols.index);let r=e?+e:NaN;if(isNaN(r))return NaN;var o;("accounting"===this.options.currencySign&&di.test(t)&&(r*=-1),"percent"===this.options.style)&&(r/=100,r=+r.toFixed((null!=(o=this.options.maximumFractionDigits)?o:0)+2));return r}sanitize(t){return t=(t=t.replace(this.symbols.literals,"")).replace("-",this.symbols.minusSign),"arab"===this.options.numberingSystem&&(t=yi(t=(t=t.replace(",",this.symbols.decimal)).replace(String.fromCharCode(1548),this.symbols.decimal),".",this.symbols.group)),"fr-FR"===this.options.locale&&(t=yi(t,".",String.fromCharCode(8239))),t}isValidPartialNumber(t,e,r){return void 0===e&&(e=-1/0),void 0===r&&(r=1/0),(t=this.sanitize(t)).startsWith(this.symbols.minusSign)&&e<0?t=t.slice(this.symbols.minusSign.length):this.symbols.plusSign&&t.startsWith(this.symbols.plusSign)&&r>0&&(t=t.slice(this.symbols.plusSign.length)),!t.startsWith(this.symbols.group)&&0===(t=yi(t,this.symbols.group,"").replace(this.symbols.numeral,"").replace(this.symbols.decimal,"")).length}}const fi=new Set(["decimal","fraction","integer","minusSign","plusSign","group"]);function yi(t,e,r){return t.replaceAll?t.replaceAll(e,r):t.split(e).join(r)}function xi(t){return t.replace(/[-/\\^$*+?.()|[\]{}]/g,"\\$&")}customElements.define("sp-icon-chevron75",class extends jt{render(){return Xt(D),Wt`<svg
    xmlns="http://www.w3.org/2000/svg"
    viewBox="0 0 10 10"
    aria-hidden="true"
    fill="currentColor"
...
`;class wi extends Ct{constructor(){super(...arguments),this.allowedKeys="",this.focused=!1,this.invalid=!1,this.label="",this.placeholder="",this.grows=!1,this.maxlength=-1,this.minlength=-1,this.multiline=!1,this.readonly=!1,this.valid=!1,this._value="",this.quiet=!1,this.required=!1}static get styles(){return[ki,Mo]}set value(t){if(t===this.value)return;const e=this._value;this._value=t,this.requestUpdate("value",e)}get value(){return this._value}get focusElement(){return this.inputElement}onInput(){if(this.allowedKeys&&this.inputElement.value){if(!new RegExp(`^[${this.allowedKeys}]*$`,"u").test(this.inputElement.value)){const t=this.inputElement.selectionStart-1;return this.inputElement.value=this.value.toString(),void this.inputElement.setSelectionRange(t,t)}}this.value=this.inputElement.value;const t=this.inputElement.selectionStart;this.updateComplete.then((()=>{this.inputElement.setSelectionRange(t,t)}))}onChange(){this.dispatchEvent(new Event("change",{bubbles:!0,composed:!0}))}onFocus(){this.focused=!0}onBlur(){this.focused=!1}renderStateIcons(){return this.invalid?D`
            ...
            `:this.valid?D`
                ...
                ></sp-icon-checkmark100>
            `:x}get displayValue(){return this.value.toString()}select(){this.inputElement.select()}get renderMultiline(){return D`
            ${this.grows&&!this.quiet?D`
                      <div id="sizer">${this.value}</div>
                  `:x}
            <!-- @ts-ignore -->
            <textarea
                aria-label=${this.label||this.placeholder}
                aria-invalid=${gt(this.invalid||void 0)}
                class="input"
                maxlength=${gt(this.maxlength>-1?this.maxlength:void 0)}
                minlength=${gt(this.minlength>-1?this.minlength:void 0)}
        ...
        `}updated(t){(t.has("value")||t.has("required")&&this.required)&&this.checkValidity()}checkValidity(){let t=this.inputElement.checkValidity();if(this.required||this.value&&this.pattern){if((this.disabled||this.multiline)&&this.pattern){t=new RegExp(`^${this.pattern}$`,"u").test(this.value.toString())}void 0!==this.minlength&&(t=t&&this.value.toString().length>this.minlength),this.valid=t,this.invalid=!t}return t}}e([tt({attribute:"allowed-keys"})],wi.prototype,"allowedKeys",void 0),e([tt({type:Boolean,reflect:!0})],wi.prototype,"focused",void 0),e([et(".input")],wi.prototype,"inputElement",void 0),e([tt({type:Boolean,reflect:!0})],wi.prototype,"invalid",void 0),e([tt()],wi.prototype,"label",void 0),e([tt()],wi.prototype,"placeholder",void 0),e([tt()],wi.prototype,"pattern",void 0),e([tt({type:Boolean,reflect:!0})],wi.prototype,"grows",void 0),e([tt({type:Number})],wi.prototype,"maxlength",void 0),e([tt({type:Number})],wi.prototype,"minlength",void 0),e([tt({type:Boolean,reflect:!0})],wi.prototype,"multiline",void 0),e([tt({type:Boolean,reflect:!0})],wi.prototype,"readonly",void 0),e([tt({type:Boolean,reflect:!0})],wi.prototype,"valid",void 0),e([tt({type:String})],wi.prototype,"value",null),e([tt({type:Boolean,reflect:!0})],wi.prototype,"quiet",void 0),e([tt({type:Boolean,reflect:!0})],wi.prototype,"required",void 0),e([tt({type:String,reflect:!0})],wi.prototype,"autocomplete",void 0);class zi extends wi{constructor(){super(...arguments),this._value=""}set value(t){if(t===this.value)return;const e=this._value;this._value=t,this.requestUpdate("value",e)}get value(){return this._value}}e([tt({type:String})],zi.prototype,"value",null);const $i=ut`
:host{--spectrum-stepper-width:var(--spectrum-global-dimension-size-900);--spectrum-stepper-border-size:var(--spectrum-alias-border-size-thin,var(--spectrum-global-dimension-static-size-10));--spectrum-stepper-button-height:calc(var(--spectrum-alias-single-line-height,
var(--spectrum-global-dimension-size-400))/2);--spectrum-stepper-button-width:calc(var(--spectrum-global-dimension-size-300) - var(--spectrum-stepper-border-size));--spectrum-stepper-button-padding:calc(var(--spectrum-global-dimension-size-150)/2);--spectrum-stepper-border-radius-reset:0;--spectrum-stepper-border-size-reset:0;--spectrum-stepper-icon-nudge-top:var(--spectrum-global-dimension-size-10);--spectrum-stepper-icon-nudge:var(--spectrum-global-dimension-size-25);--spectrum-stepper-quiet-width:var(--spectrum-global-dimension-size-600);--spectrum-stepper-button-offset:calc(var(--spectrum-stepper-button-width)/2 - var(--spectrum-icon-chevron-down-small-width,
var(--spectrum-global-dimension-size-100))/2);--spectrum-stepper-quiet-button-width:calc(var(--spectrum-stepper-button-width) - var(--spectrum-stepper-button-offset));display:inline-flex;flex-direction:row;flex-wrap:nowrap;width:var(--spectrum-stepper-width);line-height:0;border-radius:var(--spectrum-alias-border-radius-regular,var(--spectrum-global-dimension-size-50));transition:border-color var(--spectrum-global-animation-duration-100,.13s) ease-in-out,box-shadow var(--spectrum-global-animation-duration-100,.13s) ease-in-out}:host:before{content:""}:host([dir=ltr]) .buttons{border-top-left-radius:0}:host([dir=rtl]) .buttons{border-top-right-radius:0}:host([dir=ltr]) .buttons{border-top-right-radius:var(--spectrum-alias-border-radius-regular,var(--spectrum-global-dimension-size-50))}:host([dir=rtl]) .buttons{border-top-left-radius:var(--spectrum-alias-border-radius-regular,var(--spectrum-global-dimension-size-50))}:host([dir=ltr]) .buttons{border-bottom-right-radius:var(--spectrum-alias-border-radius-regular,var(--spectrum-global-dimension-size-50))}:host([dir=rtl]) .buttons{border-bottom-left-radius:var(--spectrum-alias-border-radius-regular,var(--spectrum-global-dimension-size-50))}:host([dir=ltr]) .buttons{border-bottom-left-radius:0}:host([dir=rtl]) .buttons{border-bottom-right-radius:0}.buttons{display:block;transition:box-shadow var(--spectrum-global-animation-duration-100,.13s) ease-in-out}:host([dir=ltr]) .stepDown,:host([dir=ltr]) .stepUp{padding-left:var(--spectrum-stepper-button-padding)}:host([dir=rtl]) .stepDown,:host([dir=rtl]) .stepUp{padding-right:var(--spectrum-stepper-button-padding)}:host([dir=ltr]) .stepDown,:host([dir=ltr]) .stepUp{padding-right:var(--spectrum-stepper-button-padding)}:host([dir=rtl]) .stepDown,:host([dir=rtl]) .stepUp{padding-left:var(--spectrum-stepper-button-padding)}:host([dir=ltr]) .stepDown,:host([dir=ltr]) .stepUp{border-left-width:var(--spectrum-stepper-border-size-reset)}:host([dir=rtl]) .stepDown,:host([dir=rtl]) .stepUp{border-right-width:var(--spectrum-stepper-border-size-reset)}:host([dir=ltr]) .stepDown,:host([dir=ltr]) .stepUp{border-top-left-radius:var(--spectrum-stepper-border-radius-reset)}:host([dir=rtl]) .stepDown,:host([dir=rtl]) .stepUp{border-top-right-radius:var(--spectrum-stepper-border-radius-reset)}:host([dir=ltr]) .stepDown,:host([dir=ltr]) .stepUp{border-bottom-left-radius:var(--spectrum-stepper-border-radius-reset)}:host([dir=rtl]) .stepDown,:host([dir=rtl]) .stepUp{border-bottom-right-radius:var(--spectrum-stepper-border-radius-reset)}.stepDown,.stepUp{position:relative;display:flex;box-sizing:border-box;height:var(--spectrum-stepper-button-height);width:var(--spectrum-stepper-button-width);min-width:0;margin:0!important;border-width:var(--spectrum-stepper-border-size)}.stepDown .icon,.stepUp .icon{margin:0!important;opacity:1}:host([dir=ltr]) .stepUp{border-bottom-right-radius:var(--spectrum-stepper-border-radius-reset)}:host([dir=rtl]) .stepUp{border-bottom-left-radius:var(--spectrum-stepper-border-radius-reset)}.stepUp{border-bottom:none;padding-top:var(--spectrum-stepper-icon-nudge-top)}:host([dir=ltr]) .stepDown{border-top-right-radius:var(--spectrum-stepper-border-radius-reset)}:host([dir=rtl]) .stepDown{border-top-left-radius:var(--spectrum-stepper-border-radius-reset)}.stepDown{padding-bottom:var(--spectrum-stepper-icon-nudge)}.textfield{flex:1;width:auto}:host([dir=ltr]) .input{border-top-right-radius:var(--spectrum-stepper-border-radius-reset)}:host([dir=rtl]) .input{border-top-left-radius:var(--spectrum-stepper-border-radius-reset)}:host([dir=ltr]) .input{border-bottom-right-radius:var(--spectrum-stepper-border-radius-reset)}:host([dir=rtl]) .input{border-bottom-left-radius:var(--spectrum-stepper-border-radius-reset)}.input,.textfield{min-width:0}:host([quiet]){width:var(--spectrum-stepper-quiet-width)}:host([quiet]),:host([quiet]) .buttons{border-radius:var(--spectrum-stepper-border-radius-reset)}:host([dir=ltr][quiet]) .stepDown,:host([dir=ltr][quiet]) .stepUp{border-right-width:var(--spectrum-stepper-border-size-reset)}:host([dir=rtl][quiet]) .stepDown,:host([dir=rtl][quiet]) .stepUp{border-left-width:var(--spectrum-stepper-border-size-reset)}:host([dir=ltr][quiet]) .stepDown,:host([dir=ltr][quiet]) .stepUp{border-left:none}:host([dir=rtl][quiet]) .stepDown,:host([dir=rtl][quiet]) .stepUp{border-right:none}:host([dir=ltr][quiet]) .stepDown,:host([dir=ltr][quiet]) .stepUp{padding-right:0}:host([dir=rtl][quiet]) .stepDown,:host([dir=rtl][quiet]) .stepUp{padding-left:0}:host([quiet]) .stepDown,:host([quiet]) .stepUp{width:var(--spectrum-stepper-quiet-button-width);min-width:0;border-top:none;border-radius:var(--spectrum-stepper-border-radius-reset);justify-content:flex-end}:host([dir=ltr][quiet]) .stepDown:after,:host([dir=ltr][quiet]) .stepUp:after{right:calc(var(--spectrum-stepper-button-offset)*-1)}:host([dir=rtl][quiet]) .stepDown:after,:host([dir=rtl][quiet]) .stepUp:after{left:calc(var(--spectrum-stepper-button-offset)*-1)}:host([quiet]) .stepDown:after,:host([quiet]) .stepUp:after{content:"";position:absolute;height:100%;width:var(--spectrum-stepper-button-offset)}:host(:hover:not([disabled]):not([invalid]):not([focused]):not([keyboard-focused])) .input,:host(:hover:not([disabled]):not([invalid]):not([focused]):not([keyboard-focused])) .stepDown,:host(:hover:not([disabled]):not([invalid]):not([focused]):not([keyboard-focused])) .stepUp{border-color:var(--spectrum-textfield-m-border-color-hover,var(--spectrum-alias-border-color-hover))}:host([focused]),:host([focused]) .input,:host([focused]) .stepDown,:host([focused]) .stepUp{border-color:var(--spectrum-textfield-m-border-color-mouse-focus,var(--spectrum-alias-border-color-mouse-focus))}:host([focused]) .input{box-shadow:none}:host([focused][invalid]),:host([focused][invalid]) .input,:host([focused][invalid]) .stepDown,:host([focused][invalid]) .stepUp{border-color:var(--spectrum-textfield-m-border-color-error-mouse-focus,var(--spectrum-semantic-negative-color-state-hover))}:host([keyboard-focused]),:host([keyboard-focused]) .buttons,:host([keyboard-focused]) .input{box-shadow:0 0 0 1px var(--spectrum-textfield-m-border-color-key-focus,var(--spectrum-alias-border-color-focus))}:host([keyboard-focused]) .input,:host([keyboard-focused]) .stepDown,:host([keyboard-focused]) .stepUp{border-color:var(--spectrum-textfield-m-border-color-key-focus,var(--spectrum-alias-border-color-focus))}:host([keyboard-focused][invalid]){box-shadow:0 0 0 1px var(--spectrum-textfield-m-border-color-error-key-focus,var(--spectrum-alias-border-color-focus))}:host([keyboard-focused][invalid]) .stepDown,:host([keyboard-focused][invalid]) .stepUp{border-color:var(--spectrum-textfield-m-border-color-error-key-focus,var(--spectrum-alias-border-color-focus))}:host([keyboard-focused][invalid]) .buttons{box-shadow:0 0 0 1px var(--spectrum-textfield-m-border-color-error-key-focus,var(--spectrum-alias-border-color-focus))}:host([invalid]) .input,:host([invalid]) .stepDown,:host([invalid]) .stepUp{border-color:var(--spectrum-textfield-m-border-color-error,var(--spectrum-semantic-negative-color-default))}:host([invalid][keyboard-focused]) .input{border-color:var(--spectrum-textfield-m-border-color-error-key-focus,var(--spectrum-alias-border-color-focus))}:host([invalid][keyboard-focused]) .buttons,:host([invalid][keyboard-focused]) .input{box-shadow:0 0 0 1px var(--spectrum-textfield-m-border-color-error-key-focus,var(--spectrum-alias-border-color-focus))}:host([disabled]) .stepDown,:host([disabled]) .stepUp{border-color:var(--spectrum-textfield-m-border-color-disabled,var(--spectrum-alias-border-color-transparent))}.stepDown,.stepUp{border-color:var(--spectrum-textfield-m-border-color,var(--spectrum-alias-border-color))}.stepDown:disabled,.stepUp:disabled{border-color:var(--spectrum-textfield-m-border-color-disabled,var(--spectrum-alias-border-color-transparent))}:host([quiet][disabled]) .stepDown,:host([quiet][disabled]) .stepUp{border-color:var(--spectrum-textfield-quiet-m-border-color-disabled,var(--spectrum-alias-border-color-mid))}:host([quiet]) .stepDown,:host([quiet]) .stepUp{border-color:var(--spectrum-textfield-quiet-m-border-color,var(--spectrum-alias-border-color))}:host([quiet]) .stepDown:disabled,:host([quiet]) .stepUp:disabled{border-color:var(--spectrum-textfield-quiet-m-border-color-disabled,var(--spectrum-alias-border-color-mid))}:host([quiet]) .input{box-shadow:none}:host([quiet][invalid]) .input,:host([quiet][invalid]) .stepDown{border-color:var(--spectrum-textfield-m-border-color-error,var(--spectrum-semantic-negative-color-default))}:host([quiet][focused]),:host([quiet][keyboard-focused]){box-shadow:none}:host([quiet][focused]) .buttons,:host([quiet][focused]) .input,:host([quiet][keyboard-focused]) .buttons,:host([quiet][keyboard-focused]) .input{box-shadow:0 1px 0 0 var(--spectrum-textfield-m-border-color-key-focus,var(--spectrum-alias-border-color-focus))}:host([quiet][focused]) .stepDown,:host([quiet][keyboard-focused]) .stepDown{border-color:var(--spectrum-textfield-m-border-color-key-focus,var(--spectrum-alias-border-color-focus))}:host([quiet][focused][invalid]),:host([quiet][keyboard-focused][invalid]){box-shadow:none}:host([quiet][focused][invalid]) .buttons,:host([quiet][focused][invalid]) .input,:host([quiet][keyboard-focused][invalid]) .buttons,:host([quiet][keyboard-focused][invalid]) .input{box-shadow:0 1px 0 0 var(--spectrum-textfield-m-border-color-error,var(--spectrum-semantic-negative-color-default))}:host([quiet][focused][invalid]) .input,:host([quiet][focused][invalid]) .stepDown,:host([quiet][keyboard-focused][invalid]) .input,:host([quiet][keyboard-focused][invalid]) .stepDown{border-color:var(--spectrum-textfield-m-border-color-error,var(--spectrum-semantic-negative-color-default))}sp-field-button{--spectrum-dropdown-height:100%;--spectrum-dropdown-padding-x:0}.input{font-feature-settings:"tnum";font-variant-numeric:tabular-nums}:host([hide-stepper]) .input{border-radius:var(--spectrum-alias-border-radius-regular,var(--spectrum-global-dimension-size-50))}:host([dir=ltr][invalid]:not([hide-stepper])) .icon{right:calc(var(--spectrum-stepper-button-width) + var(--spectrum-textfield-error-icon-margin-left))}:host([dir=rtl][invalid]:not([hide-stepper])) .icon{left:calc(var(--spectrum-stepper-button-width) + var(--spectrum-textfield-error-icon-margin-left))}:host([dir=ltr][valid]:not([hide-stepper])) .icon{right:calc(var(--spectrum-stepper-button-width) + var(--spectrum-textfield-error-icon-margin-left))}:host([dir=rtl][valid]:not([hide-stepper])) .icon{left:calc(var(--spectrum-stepper-button-width) + var(--spectrum-textfield-error-icon-margin-left))}:host([dir=ltr][quiet][invalid]:not([hide-stepper])) .icon{right:var(--spectrum-stepper-button-width)}:host([dir=rtl][quiet][invalid]:not([hide-stepper])) .icon{left:var(--spectrum-stepper-button-width)}:host([dir=ltr][quiet][valid]:not([hide-stepper])) .icon{right:var(--spectrum-stepper-button-width)}:host([dir=rtl][quiet][valid]:not([hide-stepper])) .icon{left:var(--spectrum-stepper-button-width)}:host([dir=ltr]:not([hide-stepper])) .icon-workflow{left:calc(var(--spectrum-stepper-button-width) + var(--spectrum-textfield-error-icon-margin-left))}:host([dir=rtl]:not([hide-stepper])) .icon-workflow{right:calc(var(--spectrum-stepper-button-width) + var(--spectrum-textfield-error-icon-margin-left))}:host([dir=ltr][quiet]:not([hide-stepper])) .icon-workflow{left:var(--spectrum-stepper-button-width)}:host([dir=rtl][quiet]:not([hide-stepper])) .icon-workflow{right:var(--spectrum-stepper-button-width)}
`;function Mi(){return t=/^iPhone/,"undefined"!=typeof window&&null!=window.navigator&&t.test(window.navigator.platform);var t}function qi(){return t=/Android/,"undefined"!=typeof window&&null!=window.navigator&&t.test(window.navigator.userAgent);var t}class Ai extends wi{constructor(){super(...arguments),this.focused=!1,this.formatOptions={},this.hideStepper=!1,this.keyboardFocused=!1,this.resolvedLanguage=document.documentElement.lang||navigator.language,this.stepModifier=10,this._value=NaN,this.changeCount=0}static get styles(){return[...super.styles,$i,ce]}set value(t){if(t===this.value)return;const e=this._value;this._value=t,this.requestUpdate("value",e)}get value(){return this._value}get valueAsString(){return this._value.toString()}set valueAsString(t){this.value=this.numberParser.parse(t)}get formattedValue(){return isNaN(this.value)?"":this.numberFormatter.format(this.value)}convertValueToNumber(t){return this.numberParser.parse(t)}get _step(){var t;return void 0!==this.step?this.step:"percent"===(null===(t=this.formatOptions)||void 0===t?void 0:t.style)?.01:1}handlePointerdown(t){if(0!==t.button)return void t.preventDefault();this.buttons.setPointerCapture(t.pointerId);const e=this.buttons.children[0].getBoundingClientRect(),r=this.buttons.children[1].getBoundingClientRect();this.findChange=t=>{t.clientX>=e.x&&t.clientY>=e.y&&t.clientX<=e.x+e.width&&t.clientY<=e.y+e.height?this.change=t=>this.increment(t.shiftKey?this.stepModifier:1):t.clientX>=r.x&&t.clientY>=r.y&&t.clientX<=r.x+r.width&&t.clientY<=r.y+r.height&&(this.change=t=>this.decrement(t.shiftKey?this.stepModifier:1))},this.findChange(t),this.startChange(t)}startChange(t){this.changeCount=0,this.doChange(t),this.safty=setTimeout((()=>{this.doNextChange(t)}),400)}doChange(t){this.change(t)}handlePointermove(t){this.findChange(t)}handlePointerup(t){this.buttons.releasePointerCapture(t.pointerId),cancelAnimationFrame(this.nextChange),clearTimeout(this.safty),this.dispatchEvent(new Event("change",{bubbles:!0,composed:!0}))}doNextChange(t){return this.changeCount+=1,this.changeCount%5==0&&this.doChange(t),requestAnimationFrame((()=>{this.nextChange=this.doNextChange(t)}))}stepBy(t){const e=void 0!==this.min?this.min:0;let r=this.value;r+=t*this._step,isNaN(this.value)?this.value=e:this.value=r,this.dispatchEvent(new Event("input",{bubbles:!0,composed:!0})),this.focus()}increment(t=1){this.stepBy(1*t)}decrement(t=1){this.stepBy(-1*t)}handleKeydown(t){switch(t.code){case"ArrowUp":t.preventDefault(),this.increment(t.shiftKey?this.stepModifier:1),this.dispatchEvent(new Event("change",{bubbles:!0,composed:!0}));break;case"ArrowDown":t.preventDefault(),this.decrement(t.shiftKey?this.stepModifier:1),this.dispatchEvent(new Event("change",{bubbles:!0,composed:!0}))}}onScroll(t){t.preventDefault();const e=t.shiftKey?t.deltaX/Math.abs(t.deltaX):t.deltaY/Math.abs(t.deltaY);0===e||isNaN(e)||this.stepBy(e*(t.shiftKey?this.stepModifier:1))}onFocus(){super.onFocus(),this.keyboardFocused=!0,this.addEventListener("wheel",this.onScroll)}onBlur(){super.onBlur(),this.keyboardFocused=!1,this.removeEventListener("wheel",this.onScroll)}handleFocusin(){this.focused=!0,this.keyboardFocused=!0}handleFocusout(){this.focused=!1,this.keyboardFocused=!1}onChange(){const t=this.convertValueToNumber(this.inputElement.value);this.value=t,super.onChange()}onInput(){const t=this.convertValueToNumber(this.inputElement.value);this._value=this.validateInput(t)}validateInput(t){if(void 0!==this.min&&(t=Math.max(this.min,t)),void 0!==this.step){const e=(t-(void 0!==this.min?this.min:0))%this.step;if(!(0===e)){1===Math.round(e/this.step)?t+=this.step-e:t-=e}if(void 0!==this.max)for(;t>this.max;)t-=this.step}return void 0!==this.max&&(t=Math.min(this.max,t)),t}get displayValue(){return this.formattedValue}clearNumberFormatterCache(){this._numberFormatter=void 0,this._numberParser=void 0}get numberFormatter(){return this._numberFormatter||(this._numberFormatter=new ui(this.resolvedLanguage,this.formatOptions)),this._numberFormatter}get numberParser(){return this._numberParser||(this._numberParser=new mi(this.resolvedLanguage,this.formatOptions)),this._numberParser}render(){return this.autocomplete="off",D`
            ${super.render()}
            ${this.hideStepper?D``:D`
                      <span
                          ...
                          @manage=${ii({type:"pointerdown",fn:this.handlePointerdown},{type:["pointermove","pointerenter","pointerleave","pointerover","pointerout"],fn:this.handlePointermove},{type:["pointerup","pointercancel"],fn:this.handlePointerup})}
                      >
                          <sp-action-button
                              class="stepUp"
                              label="Increment"
                  ...
                  `}
        `}update(t){(t.has("formatOptions")||t.has("resolvedLanguage"))&&this.clearNumberFormatterCache(),super.update(t)}firstUpdated(t){super.firstUpdated(t),this.multiline=!1,this.addEventListener("keydown",this.handleKeydown)}updated(t){if(t.has("value")||t.has("max")||t.has("min")||t.has("min")){const t=this.numberParser.parse(this.inputElement.value);this.value=this.validateInput(t)}if(t.has("min")||t.has("formatOptions")){let t="numeric";const e=void 0!==this.min&&this.min<0,{maximumFractionDigits:r}=this.formatOptions,o=r&&r>0;Mi()?e?t="text":o&&(t="decimal"):qi()&&(e?t="numeric":o&&(t="decimal")),this.inputElement.inputMode=t}}connectedCallback(){super.connectedCallback(),this.resolveLanguage()}disconnectedCallback(){this.resolveLanguage(),super.disconnectedCallback()}resolveLanguage(){const t=new CustomEvent("sp-language-context",{bubbles:!0,composed:!0,detail:{callback:t=>{this.resolvedLanguage=t}},cancelable:!0});this.dispatchEvent(t)}}e([et(".buttons")],Ai.prototype,"buttons",void 0),e([tt({type:Boolean,reflect:!0})],Ai.prototype,"focused",void 0),e([tt({type:Object,attribute:"format-options"})],Ai.prototype,"formatOptions",void 0),e([tt({type:Boolean,reflect:!0,attribute:"hide-stepper"})],Ai.prototype,"hideStepper",void 0),e([tt({type:Boolean,reflect:!0,attribute:"keyboard-focused"})],Ai.prototype,"keyboardFocused",void 0),e([tt({type:Number})],Ai.prototype,"max",void 0),e([tt({type:Number})],Ai.prototype,"min",void 0),e([tt({attribute:!1})],Ai.prototype,"resolvedLanguage",void 0),e([tt({type:Number})],Ai.prototype,"step",void 0),e([tt({type:Number,reflect:!0,attribute:"step-modifier"})],Ai.prototype,"stepModifier",void 0),e([tt({type:Number})],Ai.prototype,"value",null),customElements.define("sp-number-field",Ai),customElements.define("overlay-trigger",bo),customElements.define("sp-picker",fo);const Ci=ut`
...
`;class Si extends ht{constructor(){super(...arguments),this.opened=!1,this.textOnly=!1}static get styles(){return[Ci]}render(){return D`
            <slot></slot>
        `}}e([tt({type:Boolean,reflect:!0})],Si.prototype,"opened",void 0),e([tt({type:Boolean,attribute:"text-only",hasChanged:()=>!1})],Si.prototype,"textOnly",void 0),customElements.define("sp-quick-actions",Si);const Ei=ut`
...
`;class Bi extends(At(ht)){constructor(){super(...arguments),this.autofocus=!1,this.value="",this.checked=!1,this.disabled=!1,this.emphasized=!1,this.invalid=!1,this.readonly=!1}static get styles(){return[Ei]}click(){this.disabled||this.activate()}manageAutoFocus(){this.autofocus&&(this.dispatchEvent(new KeyboardEvent("keydown",{code:"Tab"})),this.focus())}handleChange(t){t.stopPropagation(),this.readonly?this.inputElement.checked=this.checked:(this.checked=this.inputElement.checked,this.dispatchEvent(new Event("change",{bubbles:!0,composed:!0})))}handleClick(t){t.composedPath()[0]!==this||this.checked||this.activate()}activate(){this.checked=!0,this.dispatchEvent(new Event("change",{bubbles:!0,composed:!0}))}render(){return D`
            <input
                id="input"
                type="radio"
                value=${this.value}
        ...
        `}firstUpdated(t){super.firstUpdated(t),this.setAttribute("role","radio"),this.hasAttribute("tabindex")||(this.tabIndex=0),this.manageAutoFocus(),this.addEventListener("click",this.handleClick)}updated(t){super.updated(t),t.has("invalid")&&(this.invalid?this.setAttribute("aria-invalid","true"):this.removeAttribute("aria-invalid")),t.has("checked")&&(this.checked?this.setAttribute("aria-checked","true"):this.setAttribute("aria-checked","false"))}}e([tt({type:Boolean})],Bi.prototype,"autofocus",void 0),e([tt({type:String,reflect:!0})],Bi.prototype,"value",void 0),e([tt({type:Boolean,reflect:!0})],Bi.prototype,"checked",void 0),e([tt({type:Boolean,reflect:!0})],Bi.prototype,"disabled",void 0),e([tt({type:Boolean,reflect:!0})],Bi.prototype,"emphasized",void 0),e([tt({type:Boolean,reflect:!0})],Bi.prototype,"invalid",void 0),e([tt({type:Boolean,reflect:!0})],Bi.prototype,"readonly",void 0),e([et("#input")],Bi.prototype,"inputElement",void 0),customElements.define("sp-radio",Bi);class Ti extends(At(Ro)){constructor(){super(),this.name="",this.label="",this.handleFocusin=()=>{this.addEventListener("focusout",this.handleFocusout),this.addEventListener("keydown",this.handleKeydown),requestAnimationFrame((()=>{const t=this.buttons.find((t=>0===t.tabIndex));t&&(t.tabIndex=-1)}))},this.handleKeydown=t=>{const{code:e}=t,r=this.getRootNode().activeElement;if(!r)return;let o=this.buttons.indexOf(r);if(-1===o)return;const i=(t,e)=>t[(t.length+e)%t.length],s=t=>{for(o+=t;i(this.buttons,o).disabled;)o+=t};switch(e){case"ArrowUp":s(-1);break;case"ArrowLeft":s(this.isLTR?-1:1);break;case"ArrowRight":s(this.isLTR?1:-1);break;case"ArrowDown":s(1);break;case"End":o=this.buttons.length,s(-1);break;case"Home":o=-1,s(1);break;case"PageUp":case"PageDown":const r=[...this.getRootNode().querySelectorAll("sp-radio-group")];if(r.length<2)return;t.preventDefault();const a="PageUp"===e?-1:1;let n=r.indexOf(this)+a,c=i(r,n);for(;!c.buttons.length;)n+=a,c=i(r,n);return void c.focus();default:return}t.preventDefault();const a=i(this.buttons,o);this._setSelected(a.value),a.focus()},this.handleFocusout=t=>{const e=t.relatedTarget;if(e&&this.contains(e))return;const r=this.buttons.find((t=>this.selected?t.checked:!t.disabled));r&&(r.tabIndex=0),this.removeEventListener("keydown",this.handleKeydown),this.removeEventListener("focusout",this.handleFocusout)},this.selected="",this.addEventListener("focusin",this.handleFocusin)}get buttons(){return this.defaultNodes.filter((t=>t instanceof Bi))}focus(){if(!this.buttons.length)return;const t=this.buttons.find((t=>this.selected?t.checked:!t.disabled));t&&t.focus()}_setSelected(t){if(t===this.selected)return;const e=this.selected,r=t?this.querySelector(`sp-radio[value="${t}"]`):void 0;this.selected=r?t:"";this.dispatchEvent(new Event("change",{cancelable:!0,bubbles:!0,composed:!0}))?this.validateRadios():this.selected=e}render(){return D`
            <slot></slot>
        `}firstUpdated(t){super.firstUpdated(t),this.setAttribute("role","radiogroup");const e=this.querySelector("sp-radio[checked]"),r=e?e.value:"";if(this.selected=r||this.selected,this.selected&&this.selected!==r){const t=this.querySelector(`sp-radio[value="${this.selected}"]`);t?t.checked=!0:this.selected=""}this.addEventListener("change",(t=>{if(t.target===this)return;t.stopPropagation();const e=t.target;this._setSelected(e.value)})),this.buttons.map(((t,e)=>{const r=this.selected?t.disabled||t.value!==this.selected?"-1":"0":t.disabled||0!==e?"-1":"0";t.setAttribute("tabindex",r)}))}updated(t){super.updated(t),t.has("selected")&&this.validateRadios(),t.has("label")&&(this.label?this.setAttribute("aria-label",this.label):this.removeAttribute("aria-label"))}validateRadios(){let t=!1;this.buttons.map((e=>{e.checked=this.selected===e.value,t=t||e.checked})),t||(this.selected="")}}e([tt({type:String})],Ti.prototype,"name",void 0),e([at("")],Ti.prototype,"defaultNodes",void 0),e([tt()],Ti.prototype,"label",void 0),e([tt({reflect:!0})],Ti.prototype,"selected",void 0),customElements.define("sp-radio-group",Ti);const Pi=ut`
...
`,Ii=["filled","ramp","range","tick"];class Li extends(_t(Ct,"")){constructor(){super(...arguments),this.type="",this.value=10,this._variant="",this.getAriaValueText=t=>`${t}`,this.label="",this.max=100,this.min=0,this.step=1,this.tickStep=0,this.tickLabels=!1,this.disabled=!1,this.dragging=!1,this.handleHighlight=!1}static get styles(){return[Pi]}set variant(t){const e=this.variant;t!==this.variant&&(Ii.includes(t)?(this.setAttribute("variant",t),this._variant=t):(this.removeAttribute("variant"),this._variant=""),this.requestUpdate("variant",e))}get variant(){return this._variant}get ariaValueText(){return this.getAriaValueText?this.getAriaValueText(this.value):`${this.value}`}get focusElement(){return this.input}render(){return D`
            ${this.renderLabel()} ${this.renderTrack()}
        `}updated(t){t.has("value")&&(this.value===this.input.valueAsNumber?this.dispatchInputEvent():this.value=this.input.valueAsNumber)}renderLabel(){return D`
        ...
        `}renderTrackLeft(){return"ramp"===this.variant?D``:D`
            <div
                class="track"
                id="track-left"
                style=${wt(this.trackStartStyles)}
                role="presentation"
            ></div>
        `}renderTrackRight(){return"ramp"===this.variant?D``:D`
            <div
                class="track"
                id="track-right"
                style=${wt(this.trackEndStyles)}
                role="presentation"
            ></div>
        `}renderRamp(){return"ramp"!==this.variant?D``:D`
            <div id="ramp">
                <svg
                    viewBox="0 0 240 16"
        ...
        `}renderTicks(){if("tick"!==this.variant)return D``;const t=this.tickStep||this.step,e=(this.max-this.min)/t,r=e%1!=0,o=new Array(Math.floor(e+1));return o.fill(0,0,e+1),D`
            <div
                class="${r?"not-exact ":""}ticks"
                style=${gt(r?`--sp-slider-tick-offset: calc(100% / ${this.max} * ${this.tickStep}`:void 0)}
            >
                ${o.map(((e,r)=>D`
                        <div class="tick">
                            ${this.tickLabels?D`
        ...
        `}renderHandle(){return D`
            <div
                id="handle"
                style=${this.handleStyle}
                @manage=${ii({type:"pointerdown",fn:this.handlePointerdown},{type:"pointermove",fn:this.handlePointermove},{type:["pointerup","pointercancel"],fn:this.handlePointerup})}
                role="presentation"
            >
                <input
                    type="range"
                    ...
                    aria-disabled=${gt(this.disabled?"true":void 0)}
        ...
        `}handlePointerdown(t){this.disabled||0!==t.button?t.preventDefault():(this.boundingClientRect=this.getBoundingClientRect(),this.labelEl.click(),this.dragging=!0,this.handle.setPointerCapture(t.pointerId))}handlePointerup(t){this.labelEl.click(),this.handleHighlight=!1,this.dragging=!1,this.handle.releasePointerCapture(t.pointerId),this.dispatchChangeEvent()}handlePointermove(t){this.dragging&&(this.value=this.calculateHandlePosition(t))}handleTrackPointerdown(t){if(t.target===this.handle)return;t.stopPropagation(),t.preventDefault();this.handle.dispatchEvent(new PointerEvent("pointerdown",t))&&this.handlePointermove(t)}onInputChange(){const t=parseFloat(this.input.value);this.value=t,this.dispatchChangeEvent()}onInputFocus(){let t;try{t=this.input.matches(":focus-visible")||this.matches(".focus-visible")}catch(e){t=this.matches(".focus-visible")}this.handleHighlight=t}onInputBlur(){this.handleHighlight=!1}calculateHandlePosition(t){if(!this.boundingClientRect)return this.value;const e=this.boundingClientRect,r=e.left,o=(t.clientX-r)/e.width,i=this.min+(this.max-this.min)*o;return this.isLTR?i:this.max-i}dispatchInputEvent(){if(!this.dragging)return;const t=new Event("input",{bubbles:!0,composed:!0});this.dispatchEvent(t)}dispatchChangeEvent(){this.input.value=this.value.toString();const t=new Event("change",{bubbles:!0,composed:!0});this.dispatchEvent(t)}get trackProgress(){const t=this.max-this.min;return(this.value-this.min)/t}get trackStartStyles(){return{width:100*this.trackProgress+"%","--spectrum-slider-track-background-size":`calc(100% / ${this.trackProgress})`}}get trackEndStyles(){return{width:100-100*this.trackProgress+"%","--spectrum-slider-track-background-size":`calc(100% / ${1-this.trackProgress})`}}get handleStyle(){return`${this.isLTR?"left":"right"}: ${100*this.trackProgress}%`}}e([tt()],Li.prototype,"type",void 0),e([tt({type:Number,reflect:!0})],Li.prototype,"value",void 0),e([tt({type:String})],Li.prototype,"variant",null),e([tt({attribute:!1})],Li.prototype,"getAriaValueText",void 0),e([tt({attribute:!1})],Li.prototype,"ariaValueText",null),e([tt()],Li.prototype,"label",void 0),e([tt({reflect:!0,attribute:"aria-label"})],Li.prototype,"ariaLabel",void 0),e([tt({type:Number})],Li.prototype,"max",void 0),e([tt({type:Number})],Li.prototype,"min",void 0),e([tt({type:Number})],Li.prototype,"step",void 0),e([tt({type:Number,attribute:"tick-step"})],Li.prototype,"tickStep",void 0),e([tt({type:Boolean,attribute:"tick-labels"})],Li.prototype,"tickLabels",void 0),e([tt({type:Boolean,reflect:!0})],Li.prototype,"disabled",void 0),e([tt({type:Boolean,reflect:!0})],Li.prototype,"dragging",void 0),e([tt({type:Boolean,reflect:!0,attribute:"handle-highlight"})],Li.prototype,"handleHighlight",void 0),e([et("#handle")],Li.prototype,"handle",void 0),e([et("#input")],Li.prototype,"input",void 0),e([et("#label")],Li.prototype,"labelEl",void 0),customElements.define("sp-slider",Li);const _i=ut`
:host{--spectrum-splitbutton-trigger-border-left:0;--spectrum-splitbutton-trigger-min-width:0;--spectrum-spltibutton-margin-left:0;--spectrum-splitbutton-icon-gap:var(--spectrum-global-dimension-size-150);--spectrum-splitbutton-border-radius-edge:var(--spectrum-alias-border-radius-small,var(--spectrum-global-dimension-size-25))}.trigger{--spectrum-splitbutton-trigger-round-edge-padding:var(--spectrum-global-dimension-size-125);--spectrum-splitbutton-trigger-flat-edge-padding:var(--spectrum-global-dimension-size-100);--spectrum-splitbutton-cta-trigger-flat-edge-padding:calc(var(--spectrum-splitbutton-trigger-flat-edge-padding) - var(--spectrum-button-primary-m-border-size,
var(--spectrum-alias-border-size-thick)))}#button{--spectrum-splitbutton-flat-edge-padding:calc(var(--spectrum-button-primary-m-padding-left,
var(--spectrum-alias-item-rounded-workflow-padding-left-m)) - var(--spectrum-button-primary-m-border-size,
var(--spectrum-alias-border-size-thick))*2);--spectrum-splitbutton-round-edge-padding:var(--spectrum-button-primary-m-padding-right,var(--spectrum-alias-item-rounded-padding-m));--spectrum-splitbutton-cta-flat-edge-padding:calc(var(--spectrum-button-primary-m-padding-left,
var(--spectrum-alias-item-rounded-workflow-padding-left-m)) - var(--spectrum-button-primary-m-border-size,
var(--spectrum-alias-border-size-thick))*3)}:host{position:relative;display:inline-flex;flex-direction:row;vertical-align:top}:host([dir=ltr]) #button{margin-left:0}:host([dir=rtl]) #button{margin-right:0}:host([dir=ltr]) #button{border-top-left-radius:var(--spectrum-button-primary-m-border-radius,var(--spectrum-alias-item-rounded-border-radius-m))}:host([dir=rtl]) #button{border-top-right-radius:var(--spectrum-button-primary-m-border-radius,var(--spectrum-alias-item-rounded-border-radius-m))}:host([dir=ltr]) #button{border-top-right-radius:0}:host([dir=rtl]) #button{border-top-left-radius:0}:host([dir=ltr]) #button{border-bottom-right-radius:0}:host([dir=rtl]) #button{border-bottom-left-radius:0}:host([dir=ltr]) #button{border-bottom-left-radius:var(--spectrum-button-primary-m-border-radius,var(--spectrum-alias-item-rounded-border-radius-m))}:host([dir=rtl]) #button{border-bottom-right-radius:var(--spectrum-button-primary-m-border-radius,var(--spectrum-alias-item-rounded-border-radius-m))}:host([dir=ltr]) #button{padding-right:var(--spectrum-splitbutton-flat-edge-padding)}:host([dir=rtl]) #button{padding-left:var(--spectrum-splitbutton-flat-edge-padding)}:host([dir=ltr]) #button{padding-left:var(--spectrum-splitbutton-round-edge-padding)}:host([dir=rtl]) #button{padding-right:var(--spectrum-splitbutton-round-edge-padding)}:host([dir=ltr][variant=cta]) #button{padding-right:var(--spectrum-splitbutton-cta-flat-edge-padding)}:host([dir=rtl][variant=cta]) #button{padding-left:var(--spectrum-splitbutton-cta-flat-edge-padding)}:host([dir=ltr][variant=cta]) #button{margin-right:var(--spectrum-button-primary-m-border-size,var(--spectrum-alias-border-size-thick))}:host([dir=rtl][variant=cta]) #button{margin-left:var(--spectrum-button-primary-m-border-size,var(--spectrum-alias-border-size-thick))}:host([dir=ltr]) #button:after{border-top-right-radius:var(--spectrum-splitbutton-border-radius-edge)}:host([dir=rtl]) #button:after{border-top-left-radius:var(--spectrum-splitbutton-border-radius-edge)}:host([dir=ltr]) #button:after{border-bottom-right-radius:var(--spectrum-splitbutton-border-radius-edge)}:host([dir=rtl]) #button:after{border-bottom-left-radius:var(--spectrum-splitbutton-border-radius-edge)}:host([dir=ltr]) .trigger{margin-left:0}:host([dir=rtl]) .trigger{margin-right:0}:host([dir=ltr]) .trigger{border-top-left-radius:0}:host([dir=rtl]) .trigger{border-top-right-radius:0}:host([dir=ltr]) .trigger{border-top-right-radius:var(--spectrum-button-primary-m-border-radius,var(--spectrum-alias-item-rounded-border-radius-m))}:host([dir=rtl]) .trigger{border-top-left-radius:var(--spectrum-button-primary-m-border-radius,var(--spectrum-alias-item-rounded-border-radius-m))}:host([dir=ltr]) .trigger{border-bottom-right-radius:var(--spectrum-button-primary-m-border-radius,var(--spectrum-alias-item-rounded-border-radius-m))}:host([dir=rtl]) .trigger{border-bottom-left-radius:var(--spectrum-button-primary-m-border-radius,var(--spectrum-alias-item-rounded-border-radius-m))}:host([dir=ltr]) .trigger{border-bottom-left-radius:0}:host([dir=rtl]) .trigger{border-bottom-right-radius:0}:host([dir=ltr]) .trigger{border-left-width:var(--spectrum-splitbutton-trigger-border-left)}:host([dir=rtl]) .trigger{border-right-width:var(--spectrum-splitbutton-trigger-border-left)}:host([dir=ltr]) .trigger{padding-left:var(--spectrum-splitbutton-trigger-flat-edge-padding)}:host([dir=rtl]) .trigger{padding-right:var(--spectrum-splitbutton-trigger-flat-edge-padding)}:host([dir=ltr]) .trigger{padding-right:var(--spectrum-splitbutton-trigger-round-edge-padding)}:host([dir=rtl]) .trigger{padding-left:var(--spectrum-splitbutton-trigger-round-edge-padding)}.trigger{min-width:var(--spectrum-splitbutton-trigger-min-width)}:host([dir=ltr][variant=cta]) .trigger{padding-left:var(--spectrum-splitbutton-cta-trigger-flat-edge-padding)}:host([dir=rtl][variant=cta]) .trigger{padding-right:var(--spectrum-splitbutton-cta-trigger-flat-edge-padding)}:host([dir=ltr][variant=cta]) .trigger{border-left-width:var(--spectrum-button-primary-m-border-size,var(--spectrum-alias-border-size-thick))}:host([dir=rtl][variant=cta]) .trigger{border-right-width:var(--spectrum-button-primary-m-border-size,var(--spectrum-alias-border-size-thick))}.trigger.focus-visible,.trigger.focus-visible{box-shadow:none}.trigger.focus-visible,.trigger:focus-visible{box-shadow:none}:host([dir=ltr]) .trigger:after{border-top-left-radius:var(--spectrum-splitbutton-border-radius-edge)}:host([dir=rtl]) .trigger:after{border-top-right-radius:var(--spectrum-splitbutton-border-radius-edge)}:host([dir=ltr]) .trigger:after{border-bottom-left-radius:var(--spectrum-splitbutton-border-radius-edge)}:host([dir=rtl]) .trigger:after{border-bottom-right-radius:var(--spectrum-splitbutton-border-radius-edge)}.icon{display:block;margin-top:1px}#button,.trigger{position:relative}#button:focus,.trigger:focus{z-index:1}:host([dir=ltr]) #button .label+.spectrum-Icon{margin-left:var(--spectrum-splitbutton-icon-gap)}:host([dir=rtl]) #button .label+.spectrum-Icon{margin-right:var(--spectrum-splitbutton-icon-gap)}:host([dir=ltr][left]) #button{border-top-left-radius:0}:host([dir=rtl][left]) #button{border-top-right-radius:0}:host([dir=ltr][left]) #button{border-top-right-radius:var(--spectrum-button-primary-m-border-radius,var(--spectrum-alias-item-rounded-border-radius-m))}:host([dir=rtl][left]) #button{border-top-left-radius:var(--spectrum-button-primary-m-border-radius,var(--spectrum-alias-item-rounded-border-radius-m))}:host([dir=ltr][left]) #button{border-bottom-right-radius:var(--spectrum-button-primary-m-border-radius,var(--spectrum-alias-item-rounded-border-radius-m))}:host([dir=rtl][left]) #button{border-bottom-left-radius:var(--spectrum-button-primary-m-border-radius,var(--spectrum-alias-item-rounded-border-radius-m))}:host([dir=ltr][left]) #button{border-bottom-left-radius:0}:host([dir=rtl][left]) #button{border-bottom-right-radius:0}:host([dir=ltr][left]) #button{margin-right:0}:host([dir=rtl][left]) #button{margin-left:0}:host([dir=ltr][left]) #button{margin-left:var(--spectrum-spltibutton-margin-left)}:host([dir=rtl][left]) #button{margin-right:var(--spectrum-spltibutton-margin-left)}:host([dir=ltr][left]) #button{padding-left:var(--spectrum-splitbutton-flat-edge-padding)}:host([dir=rtl][left]) #button{padding-right:var(--spectrum-splitbutton-flat-edge-padding)}:host([dir=ltr][left]) #button{padding-right:var(--spectrum-splitbutton-round-edge-padding)}:host([dir=rtl][left]) #button{padding-left:var(--spectrum-splitbutton-round-edge-padding)}:host([dir=ltr][left][variant=cta]) #button{padding-left:var(--spectrum-splitbutton-cta-flat-edge-padding)}:host([dir=rtl][left][variant=cta]) #button{padding-right:var(--spectrum-splitbutton-cta-flat-edge-padding)}:host([dir=ltr][left][variant=cta]) #button{margin-left:var(--spectrum-button-primary-m-border-size,var(--spectrum-alias-border-size-thick))}:host([dir=rtl][left][variant=cta]) #button{margin-right:var(--spectrum-button-primary-m-border-size,var(--spectrum-alias-border-size-thick))}:host([dir=ltr][left]) #button:after{border-top-left-radius:var(--spectrum-splitbutton-border-radius-edge)}:host([dir=rtl][left]) #button:after{border-top-right-radius:var(--spectrum-splitbutton-border-radius-edge)}:host([dir=ltr][left]) #button:after{border-top-right-radius:var(--spectrum-button-primary-m-border-radius,var(--spectrum-alias-item-rounded-border-radius-m))}:host([dir=rtl][left]) #button:after{border-top-left-radius:var(--spectrum-button-primary-m-border-radius,var(--spectrum-alias-item-rounded-border-radius-m))}:host([dir=ltr][left]) #button:after{border-bottom-right-radius:var(--spectrum-button-primary-m-border-radius,var(--spectrum-alias-item-rounded-border-radius-m))}:host([dir=rtl][left]) #button:after{border-bottom-left-radius:var(--spectrum-button-primary-m-border-radius,var(--spectrum-alias-item-rounded-border-radius-m))}:host([dir=ltr][left]) #button:after{border-bottom-left-radius:var(--spectrum-splitbutton-border-radius-edge)}:host([dir=rtl][left]) #button:after{border-bottom-right-radius:var(--spectrum-splitbutton-border-radius-edge)}:host([dir=ltr][left]) .trigger{margin-right:0}:host([dir=rtl][left]) .trigger{margin-left:0}:host([dir=ltr][left]) .trigger{border-top-left-radius:var(--spectrum-button-primary-m-border-radius,var(--spectrum-alias-item-rounded-border-radius-m))}:host([dir=rtl][left]) .trigger{border-top-right-radius:var(--spectrum-button-primary-m-border-radius,var(--spectrum-alias-item-rounded-border-radius-m))}:host([dir=ltr][left]) .trigger{border-top-right-radius:0}:host([dir=rtl][left]) .trigger{border-top-left-radius:0}:host([dir=ltr][left]) .trigger{border-bottom-right-radius:0}:host([dir=rtl][left]) .trigger{border-bottom-left-radius:0}:host([dir=ltr][left]) .trigger{border-bottom-left-radius:var(--spectrum-button-primary-m-border-radius,var(--spectrum-alias-item-rounded-border-radius-m))}:host([dir=rtl][left]) .trigger{border-bottom-right-radius:var(--spectrum-button-primary-m-border-radius,var(--spectrum-alias-item-rounded-border-radius-m))}:host([dir=ltr][left]) .trigger{border-left-width:var(--spectrum-button-primary-m-border-size,var(--spectrum-alias-border-size-thick))}:host([dir=rtl][left]) .trigger{border-right-width:var(--spectrum-button-primary-m-border-size,var(--spectrum-alias-border-size-thick))}:host([dir=ltr][left]) .trigger{border-right-width:var(--spectrum-splitbutton-trigger-border-left)}:host([dir=rtl][left]) .trigger{border-left-width:var(--spectrum-splitbutton-trigger-border-left)}:host([dir=ltr][left]) .trigger{padding-right:var(--spectrum-splitbutton-trigger-flat-edge-padding)}:host([dir=rtl][left]) .trigger{padding-left:var(--spectrum-splitbutton-trigger-flat-edge-padding)}:host([dir=ltr][left]) .trigger{padding-left:var(--spectrum-splitbutton-trigger-round-edge-padding)}:host([dir=rtl][left]) .trigger{padding-right:var(--spectrum-splitbutton-trigger-round-edge-padding)}:host([dir=ltr][left][variant=cta]) .trigger{padding-right:var(--spectrum-splitbutton-cta-trigger-flat-edge-padding)}:host([dir=rtl][left][variant=cta]) .trigger{padding-left:var(--spectrum-splitbutton-cta-trigger-flat-edge-padding)}:host([dir=ltr][left][variant=cta]) .trigger{border-right-width:var(--spectrum-button-primary-m-border-size,var(--spectrum-alias-border-size-thick))}:host([dir=rtl][left][variant=cta]) .trigger{border-left-width:var(--spectrum-button-primary-m-border-size,var(--spectrum-alias-border-size-thick))}:host([dir=ltr][left]) .trigger:after{border-top-left-radius:var(--spectrum-button-primary-m-border-radius,var(--spectrum-alias-item-rounded-border-radius-m))}:host([dir=rtl][left]) .trigger:after{border-top-right-radius:var(--spectrum-button-primary-m-border-radius,var(--spectrum-alias-item-rounded-border-radius-m))}:host([dir=ltr][left]) .trigger:after{border-top-right-radius:var(--spectrum-splitbutton-border-radius-edge)}:host([dir=rtl][left]) .trigger:after{border-top-left-radius:var(--spectrum-splitbutton-border-radius-edge)}:host([dir=ltr][left]) .trigger:after{border-bottom-right-radius:var(--spectrum-splitbutton-border-radius-edge)}:host([dir=rtl][left]) .trigger:after{border-bottom-left-radius:var(--spectrum-splitbutton-border-radius-edge)}:host([dir=ltr][left]) .trigger:after{border-bottom-left-radius:var(--spectrum-button-primary-m-border-radius,var(--spectrum-alias-item-rounded-border-radius-m))}:host([dir=rtl][left]) .trigger:after{border-bottom-right-radius:var(--spectrum-button-primary-m-border-radius,var(--spectrum-alias-item-rounded-border-radius-m))}sp-button{--spectrum-button-primary-m-border-radius:calc(var(--spectrum-button-padding-y) + var(--spectrum-icon-tshirt-size-height)/2 + var(--spectrum-alias-border-size-thick))}::slotted(sp-menu),sp-popover{display:none}.more-medium{width:18px;height:18px;margin:1px -4px 0}
`,Oi={s:"spectrum-UIIcon-ChevronDown75",m:"spectrum-UIIcon-ChevronDown100",l:"spectrum-UIIcon-ChevronDown200",xl:"spectrum-UIIcon-ChevronDown300"};class Hi extends(bt(go)){constructor(){super(...arguments),this.left=!1,this.variant="cta",this.type="field",this.listRole="menu",this.itemRole="menuitem"}static get styles(){return[_i,ce]}get target(){return this}focus(){this.disabled||(this.left?this.trigger.focus():super.focus())}sizePopover(t){t.style.setProperty("min-width",`${this.offsetWidth}px`)}passClick(){const t="more"===this.type?this.menuItems[0]:this.menuItems.find((t=>t.selected))||this.menuItems[0];t&&t.click()}get buttonContent(){var t;return[D`
                <div
                    id="label"
                    role="presentation"
                    class=${gt(this.value?void 0:"placeholder")}
                >
                    ${(null===(t=this.selectedItem)||void 0===t?void 0:t.itemText)||""}
                </div>
            `]}render(){const t=[D`
                <sp-button
                    aria-haspopup="true"
            ...
            `,D`
                ...
                >
                    ${"field"===this.type?D`
                              <sp-icon-chevron100
                                  class="icon ${Oi[this.size]}"
                              ></sp-icon-chevron100>
                          `:D`
                              <sp-icon-more class="icon"></sp-icon-more>
                          `}
                </sp-button>
            `];return this.left&&t.reverse(),D`
            ${t} ${this.renderPopover}
        `}updated(t){super.updated(t),t.has("value")&&this.manageSplitButtonItems()}manageSelection(){super.manageSelection(),this.manageSplitButtonItems()}async manageSplitButtonItems(){this.menuItems.length?"more"===this.type?(this.menuItems[0].hidden=!0,this.menuItems.forEach((t=>t.selected=!1)),this.menuItems[0].selected=!0,this.selectedItem=this.menuItems[0]):(this.selectedItem=this.selectedItem||this.menuItems[0],this.selectedItem.selected=!0):(await this.updateComplete,this.menuItems.length&&this.manageSplitButtonItems())}}e([tt({type:Boolean,reflect:!0})],Hi.prototype,"left",void 0),e([tt({reflect:!0})],Hi.prototype,"variant",void 0),e([tt({type:String})],Hi.prototype,"type",void 0),e([et(".trigger")],Hi.prototype,"trigger",void 0),customElements.define("sp-split-button",Hi);const Ri=ut`
...
`,Fi=3840;class Di extends ht{constructor(){super(),this.vertical=!1,this.resizable=!1,this.collapsible=!1,this.primaryMin=0,this.primaryMax=Fi,this.secondaryMin=0,this.secondaryMax=Fi,this.firstPaneSize="auto",this.enoughChildren=!1,this.viewSize=0,this.offset=0,this.minPos=0,this.maxPos=Fi;const t=window.ResizeObserver;t&&(this.observer=new t((()=>{this.rect=void 0,this.updateMinMax()})))}static get styles(){return[Ri]}connectedCallback(){var t;super.connectedCallback(),null===(t=this.observer)||void 0===t||t.observe(this)}disconnectedCallback(){var t;null===(t=this.observer)||void 0===t||t.unobserve(this),super.disconnectedCallback()}get splitterSize(){return this._splitterSize||(this._splitterSize=this.splitter&&Math.round(parseFloat(window.getComputedStyle(this.splitter).getPropertyValue(this.vertical?"height":"width")))||2),this._splitterSize}render(){const t={"is-resized-start":this.splitterPos===this.minPos,"is-resized-end":this.splitterPos&&this.splitterPos>this.splitterSize&&this.splitterPos===this.maxPos,"is-collapsed-start":0===this.splitterPos,"is-collapsed-end":this.splitterPos&&this.splitterPos>=Math.max(this.splitterSize,this.viewSize-this.splitterSize)};return D`
            <slot
                @slotchange=${this.onContentSlotChange}
                style="--spectrum-split-view-first-pane-size: ${this.firstPaneSize}"
            ></slot>
            ${this.enoughChildren?D`
                      <div
                          id="splitter"
                          class=${xt(t)}
                          role="separator"
                          aria-label=${gt(this.label||void 0)}
                          tabindex=${gt(this.resizable?"0":void 0)}
...
`;Zi.registerThemeFragment("light","color",Wi);const Xi=ut`
...
`;Zi.registerThemeFragment("dark","color",Xi);const Yi=ut`
...
`;Zi.registerThemeFragment("medium","scale",Yi);const Ji=ut`
...
`;class Qi extends(bt(ht,{validSizes:["s","m","l","xl","xxl"],noDefaultSize:!0})){static get styles(){return[Ji]}render(){return D`
            ${this.background?D`
                      <div
                          class="background"
